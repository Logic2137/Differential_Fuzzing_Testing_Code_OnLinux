...
public class SpreadNullArg {
    ...
    public static void main(String[] args) {
        ...
        int result = 42;
        try {
            mh_spread_target = MethodHandles.lookup().findStatic(SpreadNullArg.class, "target_spread_arg", mt_ref_arg);
        ...
        if (result != 42) {
            throw new Error("result [" + result + "] != 42 : Expected IllegalArgumentException was not thrown?");
        }
    }
