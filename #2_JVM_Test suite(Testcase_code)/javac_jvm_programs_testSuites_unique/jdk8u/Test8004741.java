...
for (int newIndex = 0; newIndex < 20; ++newIndex)
            ...
            if (progressState > state) {
                System.out.println("unexpected test state change, expected " + state + " but saw " + progressState);
                fail();
            }
        }
    }
...
for (int newIndex = 0; newIndex < 20; ++newIndex)
        ...
        if (passed > N / 2) {
            ...
            System.out.println("Too few ThreadDeath hits; expected at least " + N / 2 + " but saw only " + passed);
            fail();
        }
    }
