...
public class ByteClassLoader extends URLClassLoader {
    ...
    final static boolean verbose = Boolean.getBoolean("byteclassloader.verbose");
    ...
    public ByteClassLoader(String jar_name, boolean read, boolean write) throws FileNotFoundException, IOException {
        super(read ? new URL[] { new URL("file:" + jar_name + ".jar") } : new URL[0]);
        this.read = read;
        this.jar_name = jar_name;
        this.jos = write ? new JarOutputStream(new BufferedOutputStream(new FileOutputStream(jar_name + ".jar"))) : null;
        if (read && write) {
