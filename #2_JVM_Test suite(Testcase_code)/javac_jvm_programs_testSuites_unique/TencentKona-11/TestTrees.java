...
public class TestTrees extends AbstractProcessor {
    ...
    void run() throws IOException {
        ...
        try (StandardJavaFileManager fm = tool.getStandardFileManager(dl, null, null)) {
            ...
            Iterable<String> opts = Arrays.asList("--add-exports", "jdk.compiler/com.sun.tools.javac.tree=ALL-UNNAMED", "-d", ".", "-XDcompilePolicy=simple");
            ...
            opts = Arrays.asList("--add-exports", "jdk.compiler/com.sun.tools.javac.tree=ALL-UNNAMED", "-XDaccessInternalAPI", "-d", ".", "-processorpath", testClassDir, "-processor", self, "-XDcompilePolicy=simple");
            System.err.println();
    ...
    public boolean process(Set<? extends TypeElement> annos, RoundEnvironment rEnv) {
        ...
        for (TypeElement anno : annos) {
            ...
            if (elts != null) {
                for (Element e : rEnv.getElementsAnnotatedWith(anno)) testElement(trees, e);
            }
        }
        return true;
    }
...
@Target({ ElementType.TYPE, ElementType.METHOD, ElementType.CONSTRUCTOR, ElementType.TYPE_PARAMETER, ElementType.FIELD, ElementType.LOCAL_VARIABLE })
@interface Anno {
}
