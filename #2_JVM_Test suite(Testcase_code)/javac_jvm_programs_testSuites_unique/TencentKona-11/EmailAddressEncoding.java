...
public class EmailAddressEncoding {
    ...
    public static void main(String[] args) throws Exception {
        X500Principal p = new X500Principal("c=us, emailaddress=foo@bar, cn=foobar");
            ...
            for (int j = 0; j < ava.length; j++) {
                ...
                if (oid.equals(PKCS9Attribute.EMAIL_ADDRESS_OID)) {
                    ...
                    if (value.getTag() == DerValue.tag_IA5String) {
                        ...
                        throw new SecurityException("Test failed, expected EMAIL_ADDRESS tag '" + DerValue.tag_IA5String + "', got '" + value.getTag() + "'");
                    }
                }
            }
            if (passed) {
