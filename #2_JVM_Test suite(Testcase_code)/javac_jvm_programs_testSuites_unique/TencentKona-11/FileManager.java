...
public class FileManager extends WrappingJavaFileManager<StandardJavaFileManager> implements StandardJavaFileManager {
    ...
    protected Iterable<JavaFileObject> wrap2(Iterable<? extends JavaFileObject> fileObjects) {
        ...
        for (JavaFileObject fileObject : fileObjects) mapped.add(wrap(fileObject));
