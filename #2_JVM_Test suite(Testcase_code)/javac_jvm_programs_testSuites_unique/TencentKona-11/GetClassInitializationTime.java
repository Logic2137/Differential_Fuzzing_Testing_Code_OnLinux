...
public class GetClassInitializationTime {
    ...
    private static HotspotClassLoadingMBean mbean = (HotspotClassLoadingMBean) ManagementFactoryHelper.getHotspotClassLoadingMBean();
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (time < MIN_TIME_FOR_PASS || time > MAX_TIME_FOR_PASS) {
            throw new RuntimeException("Class initialization time " + "illegal value: " + time + " ms " + "(MIN = " + MIN_TIME_FOR_PASS + "; " + "MAX = " + MAX_TIME_FOR_PASS + ")");
        }
        ...
        if (time2 <= time) {
            throw new RuntimeException("Class initialization time " + "did not increase when class loaded " + "(time = " + time + "; " + "time2 = " + time2 + ")");
        }
