...
public class TestSuppression {
    ...
    String[] cases = { "class X { C c; }", "class X { C foo() { return null; } }", "class X { void foo(C c) { } }", "class X extends C { }", "class X<T extends C> { }", "class X implements I { }", "interface X extends I { }", "class X { void m() throws E { } }", "class X extends C { int i = m(); }", "class X extends C { int i = f; }" };
    ...
    static class DiagListener implements DiagnosticListener<JavaFileObject> {
        ...
        public void report(Diagnostic<? extends JavaFileObject> diagnostic) {
            System.err.println((++total) + ": " + "resolveError:" + isResolveError(unwrap(diagnostic)) + "\n" + diagnostic);
