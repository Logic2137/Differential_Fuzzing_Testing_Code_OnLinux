...
public class FollowRefObjects {
    ...
    public void createObjects() {
        ...
        _strArr[0] = "CTAKAH OT CAXAPA HE TPECHET"; tag(_strArr[0], "_strArr[0]"); 
        _strArr[1] = "?????? ?? ??????? ???????!";  tag(_strArr[1], "_strArr[1]"); 
        _strArr[2] = getClass().getCanonicalName(); tag(_strArr[2], "_strArr[2]"); 
