...
public final class Bits24ToFromFloatArray {
    ...
    private static final byte[] SIGNED_BIG = { (byte) ((MIN_S >> 16) & 0xff), (byte) ((MIN_S >> 8) & 0xff), (byte) ((MIN_S >> 0) & 0xff), 0, 0, 0, (byte) ((MAX_S >> 16) & 0xff), (byte) ((MAX_S >> 8) & 0xff), (byte) ((MAX_S >> 0) & 0xff) };

    private static final byte[] UNSIGNED_BIG = { 0, 0, 0, (byte) ((MID_U >> 16) & 0xff), (byte) ((MID_U >> 8) & 0xff), (byte) ((MID_U >> 0) & 0xff), (byte) ((MAX_U >> 16) & 0xff), (byte) ((MAX_U >> 8) & 0xff), (byte) ((MAX_U >> 0) & 0xff) };

    private static final byte[] SIGNED_LITTLE = { (byte) ((MIN_S >> 0) & 0xff), (byte) ((MIN_S >> 8) & 0xff), (byte) ((MIN_S >> 16) & 0xff), 0, 0, 0, (byte) ((MAX_S >> 0) & 0xff), (byte) ((MAX_S >> 8) & 0xff), (byte) ((MAX_S >> 16) & 0xff) };

    private static final byte[] UNSIGNED_LITTLE = { 0, 0, 0, (byte) ((MID_U >> 0) & 0xff), (byte) ((MID_U >> 8) & 0xff), (byte) ((MID_U >> 16) & 0xff), (byte) ((MAX_U >> 0) & 0xff), (byte) ((MAX_U >> 8) & 0xff), (byte) ((MAX_U >> 16) & 0xff) };
    ...
    private static void test(final Encoding enc, final byte[] expected, boolean end) {
        System.err.println(enc);
        AudioFormat af = new AudioFormat(enc, 44100, SIZE, 1, SIZE / 8, 44100, end);
