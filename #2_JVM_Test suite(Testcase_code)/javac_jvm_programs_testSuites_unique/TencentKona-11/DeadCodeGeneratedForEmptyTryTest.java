...
public class DeadCodeGeneratedForEmptyTryTest {
    ...
    void run() throws Exception {
        checkClassFile(Paths.get(System.getProperty("test.classes"), this.getClass().getName() + "$Test.class"));
    }
    ...
    void checkClassFile(final Path path) throws Exception {
        ...
        Assert.check(numberOfRefToStr == 1, "There should only be one reference to a CONSTANT_String_info structure in the generated code");
    }
