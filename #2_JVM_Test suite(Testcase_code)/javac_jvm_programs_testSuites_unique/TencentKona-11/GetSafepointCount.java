...
public class GetSafepointCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (value < MIN_VALUE_FOR_PASS || value > MAX_VALUE_FOR_PASS) {
            throw new RuntimeException("Safepoint count " + "illegal value: " + value + " " + "(MIN = " + MIN_VALUE_FOR_PASS + "; " + "MAX = " + MAX_VALUE_FOR_PASS + ")");
        }
        for (int i = 0; i < NUM_THREAD_DUMPS; i++) {
            Thread.getAllStackTraces();
        }
        ...
        if (value2 <= value) {
            throw new RuntimeException("Safepoint count " + "did not increase " + "(value = " + value + "; " + "value2 = " + value2 + ")");
        }
