...
public class TestFtpClientNameListWithNull {
    ...
    public static void main(String[] args) throws Exception {
        try (FtpServer server = new FtpServer();
            ...
            if (commandHasArgs) {
                throw new RuntimeException("Test failed. NLST shouldn't have " + "args if nameList parameter is null");
            }
        }
    }
    ...
    private static class FtpServer implements AutoCloseable, Runnable {
        ...
        public void handleClient(Socket client) throws IOException {
            ...
            while (!done) {
                ...
                String args = (cmd.equals(str)) ? "" : str.substring(str.indexOf(" "));
                switch(cmd) {
                    case "QUIT":
                    ...
                    case "EPSV":
                        ...
                        out.println("229 Entering Extended Passive Mode " + "(|||" + getPort() + "|)");
                        break;
                    case "NLST":
