...
public class ClassLiteralWastesByteTest {
    ...
    private static final String assertionErrorMsg = "Instead of ldc_w, ldc instruction should have been generated";
    ...
    void run() {
        check("-c", Paths.get(System.getProperty("test.classes"), "test.class").toString());
    }
