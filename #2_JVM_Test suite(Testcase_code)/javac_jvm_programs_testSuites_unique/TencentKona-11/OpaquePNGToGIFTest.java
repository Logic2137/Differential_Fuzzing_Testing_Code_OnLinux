...
public final class OpaquePNGToGIFTest extends Frame {
    ...
    public OpaquePNGToGIFTest() throws Exception {
        SwingUtilities.invokeAndWait(() -> {
            try {
                ...
                Logger.getLogger(OpaquePNGToGIFTest.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
        ...
        try {
            ...
            if (!testPassed && testGeneratedInterrupt) {
                throw new RuntimeException("Test failed or didnt run" + " properly");
            }
        }
    ...
    public void startTest() throws Exception {
        ...
        String instructions = "<html>    INSTRUCTIONS:<br><br>" + "After clicking on Start Test button you will see Red<br> " + " circle drawn with light blue background, if the circle<br>" + " color changes from Red to Green then press button Fail,<br>" + " if it stays Red then press button Pass.<br><br></html>";
        ...
        startTestButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    outputFile = File.createTempFile("output", ".gif", directory);
                    createAnimatedImage(bi, imgData, writer, outputFile);
                    writer.dispose();
                    iis.close();
                    if (outputFile == null) {
                        throw new RuntimeException("Unable to create output GIF" + " file");
                    }
    ...
    public void createAnimatedImage(BufferedImage bi, IIOMetadata metadata, ImageWriter writer, File outputFile) {
        try {
            ...
            IIOMetadata imgData = writer.convertImageMetadata((IIOMetadata) metadata, specify, param);
