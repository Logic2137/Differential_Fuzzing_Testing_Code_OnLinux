...
public class IncludePackagesTest {
    ...
    final String[] sources = new String[] { "p1/p1T.java", "package p1;\n" + "\n" + "public class p1T {\n" + "}\n", "p1/sp1/p1sp1T.java", "package p1.sp1;\n" + "\n" + "public class p1sp1T {\n" + "}\n", "p1/sp1/sp2/p1sp1sp2T.java", "package p1.sp1.sp2;\n" + "\n" + "public class p1sp1sp2T {\n" + "}\n", "p2/p2T.java", "package p2;\n" + "\n" + "public class p2T {\n" + "}\n", "Default.java", "\n" + "public class Default {\n" + "}\n" };
    ...
    void run() throws Exception {
        ...
        try {
            ...
            test(Arrays.asList(rawDiags, "-Xdoclint"), Main.Result.ERROR, EnumSet.of(Message.p1T, Message.p1sp1T, Message.p1sp1sp2T, Message.p2T, Message.Default));
            test(Arrays.asList(rawDiags, "-Xdoclint", "-Xdoclint/package:p1"), Main.Result.ERROR, EnumSet.of(Message.p1T));
            test(Arrays.asList(rawDiags, "-Xdoclint", "-Xdoclint/package:p1.*"), Main.Result.ERROR, EnumSet.of(Message.p1sp1T, Message.p1sp1sp2T));
            test(Arrays.asList(rawDiags, "-Xdoclint", "-Xdoclint/package:p1.*,-p1.sp1"), Main.Result.ERROR, EnumSet.of(Message.p1sp1sp2T));
            test(Arrays.asList(rawDiags, "-Xdoclint", "-Xdoclint/package:-p1.sp1"), Main.Result.ERROR, EnumSet.of(Message.p1T, Message.p1sp1sp2T, Message.p2T, Message.Default));
            test(Arrays.asList(rawDiags, "-Xdoclint", "-Xdoclint/package:wrong+package"), Main.Result.CMDERR, EnumSet.of(Message.INVALID_PACKAGE_ERROR));
            if (errors > 0)
