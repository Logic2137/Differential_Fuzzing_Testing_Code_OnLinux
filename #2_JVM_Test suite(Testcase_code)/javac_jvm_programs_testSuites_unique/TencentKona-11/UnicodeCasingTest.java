...
public class UnicodeCasingTest {
    ...
    private void test() {
        ...
        try {
            File file = new File(System.getProperty("test.src", "."), "UnicodeData.txt");
    ...
    private void testUpperCase(int orig, int expected) {
        ...
        if (expected != got) {
            err = true;
            System.err.println("toUpperCase(" + ") failed.\n\tOriginal: " + toString(orig) + "\n\tGot:      " + toString(got) + "\n\tExpected: " + toString(expected));
        }
    }
    ...
    private void testLowerCase(int orig, int expected) {
        ...
        if (expected != got) {
            err = true;
            System.err.println("toLowerCase(" + ") failed.\n\tOriginal: " + toString(orig) + "\n\tGot:      " + toString(got) + "\n\tExpected: " + toString(expected));
        }
    }
    ...
    private void testTitleCase(int orig, int expected) {
        ...
        if (expected != got) {
            err = true;
            System.err.println("toTitleCase(" + ") failed.\n\tOriginal: " + toString(orig) + "\n\tGot:      " + toString(got) + "\n\tExpected: " + toString(expected));
        }
    }
