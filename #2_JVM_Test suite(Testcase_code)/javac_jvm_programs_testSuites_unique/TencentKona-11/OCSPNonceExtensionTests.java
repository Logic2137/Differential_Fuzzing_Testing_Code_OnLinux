...
public class OCSPNonceExtensionTests {
    ...
    public static final byte[] OCSP_NONCE_DER = { 48, 66, 6, 9, 43, 6, 1, 5, 5, 7, 48, 1, 2, 1, 1, -1, 4, 50, 4, 48, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17 };

    public static final byte[] DEADBEEF_16 = { -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17 };

    public static final byte[] OCSP_NONCE_DB16 = { 48, 31, 6, 9, 43, 6, 1, 5, 5, 7, 48, 1, 2, 4, 18, 4, 16, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17, -34, -83, -66, -17 };

    public static void main(String[] args) throws Exception {
        Map<String, TestCase> testList = new LinkedHashMap<String, TestCase>() {

            {
                ...
                put("CTOR Test (provide extension DER encoding)", testCtorSuperByDerValue);
        ...
        for (String testName : testList.keySet()) {
            ...
            System.out.println(" " + (result.getValue() != null ? result.getValue() : ""));
            System.out.println("-------------------------------------------");
            if (!result.getKey()) {
                numberFailed++;
            }
        }
        System.out.println("End Results: " + (testList.size() - numberFailed) + " Passed" + ", " + numberFailed + " Failed.");
        if (numberFailed > 0) {
            throw new RuntimeException("One or more tests failed, see test output for details");
        }
    }
    ...
    public static void verifyExtStructure(byte[] derData) throws IOException {
        ...
        debuglog("Found sequence containing " + sequenceItems.length + " elements");
        if (sequenceItems.length != 2 && sequenceItems.length != 3) {
            throw new RuntimeException("Incorrect number of items found in " + "the SEQUENCE (Got " + sequenceItems.length + ", expected 2 or 3 items)");
        }
        int seqIndex = 0;
        ...
        if (!extOid.equals((Object) PKIXExtensions.OCSPNonce_Id)) {
            throw new RuntimeException("Incorrect OID (Got " + extOid.toString() + ", expected " + PKIXExtensions.OCSPNonce_Id.toString() + ")");
        }
        if (sequenceItems.length == 3) {
            boolean isCrit = sequenceItems[seqIndex++].getBoolean();
            debuglog("Found BOOLEAN (critical): " + isCrit);
        }
        DerValue extnValue = new DerValue(sequenceItems[seqIndex++].getOctetString());
        ...
        public Map.Entry<Boolean, String> runTest() {
            ...
            try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
                try {
                    ...
                    throw new RuntimeException("Accepted a negative length nonce");
                ...
                if (crit) {
                    ...
                    message = "Incorrect OID (Got " + oid + ", Expected " + OCSP_NONCE_OID + ")";
                } else if (nonceData.getTag() != DerValue.tag_OctetString) {
                    message = "Incorrect nonce data tag type (Got " + String.format("0x%02X", nonceData.getTag()) + ", Expected 0x04)";
                } else if (nonceData.getOctetString().length != 32) {
                    message = "Incorrect nonce byte length (Got " + nonceData.getOctetString().length + ", Expected 32)";
                } else {
                    pass = Boolean.TRUE;
                }
            } catch (Exception e) {
    ...
    public static final TestCase testCtorByValue = new TestCase() {
        ...
        public Map.Entry<Boolean, String> runTest() {
            ...
            try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
                ...
                try {
                    Extension zeroLenNonce = new OCSPNonceExtension(new byte[0]);
                    throw new RuntimeException("Accepted a zero length nonce");
                } catch (IllegalArgumentException iae) {
                }
                OCSPNonceExtension nonceByValue = new OCSPNonceExtension(DEADBEEF_16);
    ...
    public static final TestCase testCtorCritForms = new TestCase() {
        ...
        public Map.Entry<Boolean, String> runTest() {
            ...
            try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
                ...
                Extension nonceByValue = new OCSPNonceExtension(true, DEADBEEF_16);
                pass = nonceByLength.isCritical() && nonceByValue.isCritical();
                if (!pass) {
                    message = "nonceByLength or nonceByValue was not marked " + "critical as expected";
                }
            } catch (Exception e) {
                e.printStackTrace(System.out);
                message = e.getClass().getName();
    ...
    public static final TestCase testCtorSuperByDerValue = new TestCase() {
        ...
        public Map.Entry<Boolean, String> runTest() {
            ...
            String message = null;
            try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
                Extension nonceByDer = new sun.security.x509.Extension(new DerValue(OCSP_NONCE_DER));
                ...
                if (!crit) {
                    ...
                    message = "Incorrect nonce byte length (Got " + nonceData.getOctetString().length + ", Expected 48)";
                } else {
                    pass = Boolean.TRUE;
                }
            } catch (Exception e) {
