...
public class AudioFileFormatToString {
    ...
    public static int run(String[] argv, java.io.PrintStream out) {
        ...
        AudioFormat testAudioFormat = new 
        AudioFormat(AudioFormat.Encoding.PCM_SIGNED, (float) 44100.0, (int) 8, (int) 2, (int) 2, (float) 110.0, true);
        ...
        try {
            testedAudioFileFormat = new 
            AudioFileFormat(nullAudioFileFormatType, testAudioFormat, (int) 1024);
        ...
        try {
            testedAudioFileFormat = new 
            AudioFileFormat(testAudioFileFormatType, nullAudioFormat, (int) 1024);
            out.println(">  No any Exception was thrown!");
        ...
        try {
            testedAudioFileFormat = new 
            TestAudioFileFormat(nullAudioFileFormatType, (int) 1024, testAudioFormat, (int) 1024);
            out.println(">  No any Exception was thrown!");
            out.println(">  testedAudioFileFormat.getType():");
            try {
                AudioFileFormat.Type producedType = testedAudioFileFormat.getType();
        ...
        try {
            testedAudioFileFormat = new 
            TestAudioFileFormat(testAudioFileFormatType, (int) 1024, nullAudioFormat, (int) 1024);
            out.println(">  No any Exception was thrown!");
            out.println(">  testedAudioFileFormat.getFormat():");
            try {
                AudioFormat producedFormat = testedAudioFileFormat.getFormat();
