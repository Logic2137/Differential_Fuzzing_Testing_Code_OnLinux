...
public class EmptyFinallyTest {
    ...
    private static final String assertionErrorMsg = "No \"Exception table\" should be generated in this case";
    ...
    void run() {
        check("-c", Paths.get(System.getProperty("test.classes"), "EmptyFinally.class").toString());
    }
