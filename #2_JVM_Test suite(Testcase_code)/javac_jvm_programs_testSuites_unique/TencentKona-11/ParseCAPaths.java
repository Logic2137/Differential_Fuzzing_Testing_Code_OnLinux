...
public class ParseCAPaths {
    ...
    public static void main(String[] args) throws Exception {
        ...
        check("AA.EXAMPLE.COM", "BB.EXAMPLE.COM", "AA.EXAMPLE.COM", "EXAMPLE.COM");
        check("SITE1.SALES.EXAMPLE.COM", "EVERYWHERE.EXAMPLE.COM", "SITE1.SALES.EXAMPLE.COM", "SALES.EXAMPLE.COM", "EXAMPLE.COM");
        check("DEVEL.EXAMPLE.COM", "PROD.EXAMPLE.ORG", "DEVEL.EXAMPLE.COM", "EXAMPLE.COM", "COM", "ORG", "EXAMPLE.ORG");
        check("A.EXAMPLE.COM", "B.EXAMPLE.COM", "A.EXAMPLE.COM");
        check("A.EXAMPLE.COM", "C.EXAMPLE.COM", "A.EXAMPLE.COM", "B.EXAMPLE.COM");
        check("A.EXAMPLE.COM", "D.EXAMPLE.COM", "A.EXAMPLE.COM", "B.EXAMPLE.COM", "C.EXAMPLE.COM");
        check("TIVOLI.COM", "IBM.COM", "TIVOLI.COM", "LDAPCENTRAL.NET", "IBM_LDAPCENTRAL.COM", "MOONLITE.ORG");
        check("N1.N.COM", "N2.N.COM", "N1.N.COM", "N.COM");
        check("N1.N.COM", "N2.N3.COM", "N1.N.COM", "N.COM", "COM", "N3.COM");
    ...
    static void check2(String from, String to, String... paths) throws Exception {
