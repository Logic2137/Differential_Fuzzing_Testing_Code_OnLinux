...
public class CheckMyTrustedKeystore {
    ...
    void doServerSide() throws Exception {
        ...
        kmf.init(ks, cpasswd);
        com.sun.net.ssl.TrustManager[] tms = new com.sun.net.ssl.TrustManager[] { new MyComX509TrustManager() };
    ...
    void doClientSide() throws Exception {
        ...
        com.sun.net.ssl.KeyManagerFactory kmf1 = com.sun.net.ssl.KeyManagerFactory.getInstance("SunX509");
        kmf1.init(uks, cpasswd);
        com.sun.net.ssl.TrustManager[] tms1 = new com.sun.net.ssl.TrustManager[] { new MyComX509TrustManager() };
        ctx1.init(kmf1.getKeyManagers(), tms1, null);
    ...
    final static String keyFilename = System.getProperty("test.src", "./") + "/" + pathToStores + "/" + keyStoreFile;

    final static String unknownFilename = System.getProperty("test.src", "./") + "/" + pathToStores + "/" + unknownStoreFile;
