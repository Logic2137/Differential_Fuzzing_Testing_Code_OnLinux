...
public class SpecTests {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] actions = { "read", "read", "", null, "junk", "read,write,execute,delete,rename" };
        ...
        for (int i = 0; i < names.length; i++) {
            try {
                ...
                if (exps[i] == null) {
                    ...
                    throw new Exception("Expecting: " + exps[i] + " for name:" + names[i] + " actions:" + actions[i]);
                } else {
                    System.out.println(names[i] + ", [" + actions[i] + "] " + "resulted in " + exps[i] + " as Expected");
                }
            }
            if (exps[i] == null) {
