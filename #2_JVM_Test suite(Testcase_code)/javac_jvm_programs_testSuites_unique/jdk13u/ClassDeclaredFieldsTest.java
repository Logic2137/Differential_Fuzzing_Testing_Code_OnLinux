...
public class ClassDeclaredFieldsTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args == null || args.length == 0) {
            ...
            throw new IllegalArgumentException("Only one arg expected: " + Arrays.asList(args));
        }
    ...
    static void test(TestCase test) {
        ...
        try {
            ...
            throw new RuntimeException("Expected NoSuchFieldException for" + " 'classLoader' field not raised");
