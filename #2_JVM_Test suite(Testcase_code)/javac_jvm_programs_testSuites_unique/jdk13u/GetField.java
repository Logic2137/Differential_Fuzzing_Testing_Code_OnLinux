...
public class GetField implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (cl.getField("str") == null)
            throw new RuntimeException("ObjectStreamClass.getField() failed for object type");
        if (cl.getField("i") == null)
            throw new RuntimeException("ObjectStreamClass.getField() failed for primitive type");
    }
}
