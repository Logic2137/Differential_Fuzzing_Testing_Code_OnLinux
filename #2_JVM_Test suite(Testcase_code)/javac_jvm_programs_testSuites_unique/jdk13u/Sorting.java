...
public class Sorting {
    ...
    private static final int[] LONG_RUN_LENGTHS = { 1, 2, 3, 5, 8, 13, 21, 34, 55, 100, 1000, 10000, 100000, 1000000 };
    ...
    private static void testEmptyAndNullIntArray() {
        ...
        try {
            ...
            failed("Arrays.sort(int[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testEmptyAndNullLongArray() {
        ...
        try {
            ...
            failed("Arrays.sort(long[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testEmptyAndNullShortArray() {
        ...
        try {
            ...
            failed("Arrays.sort(short[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testEmptyAndNullCharArray() {
        ...
        try {
            ...
            failed("Arrays.sort(char[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testEmptyAndNullByteArray() {
        ...
        try {
            ...
            failed("Arrays.sort(byte[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testEmptyAndNullFloatArray() {
        ...
        try {
            ...
            failed("Arrays.sort(float[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testEmptyAndNullDoubleArray() {
        ...
        try {
            ...
            failed("Arrays.sort(double[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void checkRange(Integer[] a, int m) {
        try {
            Arrays.sort(a, m + 1, m);
            failed("Sort does not throw IllegalArgumentException " + " as expected: fromIndex = " + (m + 1) + " toIndex = " + m);
        } catch (IllegalArgumentException iae) {
            try {
                Arrays.sort(a, -m, a.length);
                failed("Sort does not throw ArrayIndexOutOfBoundsException " + " as expected: fromIndex = " + (-m));
            } catch (ArrayIndexOutOfBoundsException aoe) {
                try {
                    Arrays.sort(a, 0, a.length + m);
                    failed("Sort does not throw ArrayIndexOutOfBoundsException " + " as expected: toIndex = " + (a.length + m));
