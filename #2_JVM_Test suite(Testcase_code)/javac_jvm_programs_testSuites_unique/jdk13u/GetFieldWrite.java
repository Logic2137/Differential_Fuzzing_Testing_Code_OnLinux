...
class TestClass implements Serializable {
    ...
    private static final ObjectStreamField[] serialPersistentFields = { new ObjectStreamField("objectI", Integer.class) };
...
public class GetFieldWrite {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        ...
        out.writeObject(new TestClass(new Foo(100, 200), new Integer(100), 200));
        out.close();
    }
}
