...
public class numeric007 {
    ...
    public static int run(String[] args, PrintStream out) {
        ...
        if (args.length != argsShift + 2) {
            ...
            complain("    java numeric007 [-verbose] [-performance] [-CPU:number] " + "matrixSize iterations");
            return 2;
        }
        ...
        for (int line = 0; line < size; line++) for (int column = 0; column < size; column++) if (A1[line][column] != Ai[line][column]) {
            println("");
