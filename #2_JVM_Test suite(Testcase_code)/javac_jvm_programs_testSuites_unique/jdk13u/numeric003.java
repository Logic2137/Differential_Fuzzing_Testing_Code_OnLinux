...
public class numeric003 {
    ...
    public static int run(String[] args, PrintStream out) {
        ...
        if ((args.length < argsShift + 1) || (args.length > argsShift + 2)) {
            ...
            complain("    java numeric003 [-verbose] [-performance] [-CPU:number] " + "matrixSize [threads]");
            return 2;
        }
    ...
    private static class SquareMatrix {
        ...
        public SquareMatrix(int size) {
            ...
            for (int line = 0; line < size; line++) for (int column = 0; column < size; column++) value[line][column] = Math.round(Math.random() * size);
        }
