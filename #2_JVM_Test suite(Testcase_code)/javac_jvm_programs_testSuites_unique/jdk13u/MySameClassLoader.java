...
public class MySameClassLoader extends ClassLoader {
    ...
    public Class loadClass(String name) throws ClassNotFoundException {
        if (!name.equals("p1.c1") && !name.equals("p1.c1ReadEdge") && !name.equals("p1.c1Loose") && !name.equals("p2.c2") && !name.equals("p3.c3") && !name.equals("p3.c3ReadEdge") && !name.equals("c4") && !name.equals("c5") && !name.equals("p6.c6")) {
