...
public class NISTWrapKAT {
    ...
    private static final String DATA = "00112233445566778899aabbccddeeff000102030405060708090a0b0c0d0e0f";

    private static String AES128_128 = "1fa68b0a8112b447aef34bd8fb5a7b829d3e862371d2cfe5";

    private static String AES192_128 = "96778b25ae6ca435f92b5b97c050aed2468ab8a17ad84e5d";

    private static String AES192_192 = "031d33264e15d33268f24ec260743edce1c6c7ddee725a936ba814915c6762d2";

    private static String AES256_128 = "64e8c3f9ce0f5ba263e9777905818a2a93c8191e7d6e8ae7";

    private static String AES256_192 = "a8f9bc1612c68b3ff6e6f4fbe30e71e4769c8b80a32cb8958cd5d17d6b254da1";

    private static String AES256_256 = "28c9f404c4b810f4cbccb35cfb87f8263f5786e2d80ed326cbc7f0e71a99f43bfb988b9b7a02dd21";

    public static void testKeyWrap(int keyLen, int dataLen, String expected) throws Exception {
        System.out.println("Testing AESWrap Cipher with " + dataLen + "-byte data with " + 8 * keyLen + "-bit key");
        ...
        System.arraycopy(val, 0, keyVal, keyVal.length - val.length, val.length);
        temp = new BigInteger(DATA.substring(0, dataLen * 2), 16);
        val = temp.toByteArray();
        System.arraycopy(val, 0, dataVal, dataVal.length - val.length, val.length);
