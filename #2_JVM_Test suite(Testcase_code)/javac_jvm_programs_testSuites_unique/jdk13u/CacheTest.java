...
public class CacheTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (ttl <= 0 || ttl > 15) {
            System.err.println("Security property " + ttlProp + " needs to " + " in 1-15 second range to execute this test");
            return;
        }
        ...
        try {
            ...
            throw new RuntimeException("Test internal error " + " - luster is being resolved by name service");
