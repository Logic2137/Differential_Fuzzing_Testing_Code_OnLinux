...
public class NativeLibraryTest {
    ...
    public static void main(String... args) throws Exception {
        ...
        for (int count = 1; count <= 5; count++) {
            ...
            if (count != unloadedCount) {
                throw new RuntimeException("Expected unloaded=" + count + " but got=" + unloadedCount);
            }
        }
    }
    ...
    static void runTest() throws Exception {
        ...
        try {
            r1.run();
            throw new RuntimeException("should fail to load the native library" + " by another class loader");
    ...
    static void setup() throws IOException {
        ...
        Files.move(Paths.get(dir).resolve(file), CLASSES.resolve("p").resolve("Test.class"));
    }
}
