...
public class MultiThreadDeadLockTest {
    ...
    public static class UserThread extends Thread {
        ...
        public void run() {
            try {
                client.getMBeanServerConnection().invoke(totoName, "allowReturn", null, null);
            } catch (Exception e) {
                throw new Error(e);
            }
    ...
    public static class Toto extends NotificationBroadcasterSupport implements TotoMBean {
    ...
    public static class RMIClientFactory implements RMIClientSocketFactory, Serializable {
