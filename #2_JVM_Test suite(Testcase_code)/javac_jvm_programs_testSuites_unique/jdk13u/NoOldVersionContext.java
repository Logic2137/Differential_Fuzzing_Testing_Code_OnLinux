...
public class NoOldVersionContext {
    ...
    static enum ContextVersion {
        ...
        TLS_CV_01("SSL", new String[] { "TLSv1", "TLSv1.1", "TLSv1.2" }),
        TLS_CV_02("TLS", new String[] { "TLSv1", "TLSv1.1", "TLSv1.2" }),
        TLS_CV_03("SSLv3", new String[] { "SSLv3", "TLSv1" }),
        TLS_CV_04("TLSv1", new String[] { "SSLv3", "TLSv1" }),
        TLS_CV_05("TLSv1.1", new String[] { "SSLv3", "TLSv1", "TLSv1.1" }),
        TLS_CV_06("TLSv1.2", new String[] { "SSLv3", "TLSv1", "TLSv1.1", "TLSv1.2" }),
        TLS_CV_07("TLSv1.3", new String[] { "SSLv3", "TLSv1", "TLSv1.1", "TLSv1.2", "TLSv1.3" }),
        TLS_CV_08("Default", new String[] { "TLSv1", "TLSv1.1", "TLSv1.2" });
    ...
    private static boolean checkProtocols(String[] target, String[] expected) {
        ...
        if (!protocolEquals(target, expected)) {
            ...
            System.out.println("\tError: The actual protocols " + Arrays.toString(target));
            success = false;
        }
        return success;
    }
