...
public class NameTests {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("compositeName- startsWith(" + rdnStr[0] + "): " + dn.startsWith(new CompositeName(rdnStr[0])));
        ...
        System.out.println("compositeName- endsWith(" + rdnStr[0] + "):    " + dn.endsWith(new CompositeName(rdnStr[0])));
