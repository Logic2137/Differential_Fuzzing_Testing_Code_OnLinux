...
public class LimitDirectMemory {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            throw new IllegalArgumentException("Usage: " + "java LimitDirectMemory" + " <OOME_expected(true|false)>" + " <fill_direct_memory>" + " <size_per_buffer>");
        }
        ...
        if (throwp) {
            try {
                b[i] = ByteBuffer.allocateDirect(incr);
                throw new RuntimeException("OutOfMemoryError not thrown: " + incr);
