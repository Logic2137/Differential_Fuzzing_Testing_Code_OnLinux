...
public class numeric009 {
    ...
    public static int run(String[] args, PrintStream out) {
        ...
        if (args.length != argsShift + 2) {
            ...
            complain("    java numeric009 [-verbose] [-performance] " + "[-tolerance:percents] matrixSize iterations");
            return 2;
        }
        ...
        println("==========================" + ((iterations > 99) ? "==" : (iterations > 9) ? "=" : ""));
        println("");
        double overallTime = 0;
        double firstTime = 0;
        double lastTime = 0;
        for (int i = 1; i <= iterations; i++) {
            double seconds = elapsedTime(i, intA, intAA, longA, longAA, floatA, floatAA, doubleA, doubleAA);
            if (i == 1)
                firstTime = seconds;
            else
                lastTime = seconds;
    ...
    private static double elapsedTime(int i, int[][] intA, int[][] intAA, long[][] longA, long[][] longAA, float[][] floatA, float[][] floatAA, double[][] doubleA, double[][] doubleAA) {
