...
public class ParallelSorting {
    ...
    private static final int[] LONG_RUN_LENGTHS = { 1000, 10000, 100000, 1000000 };

    private static final int[] SHORT_RUN_LENGTHS = { 5000, 9000, 10000, 12000 };
    ...
    private static void testEmptyAndNullIntArray() {
        ...
        try {
            ...
            failed("Arrays.parallelSort(int[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testEmptyAndNullLongArray() {
        ...
        try {
            ...
            failed("Arrays.parallelSort(long[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testEmptyAndNullShortArray() {
        ...
        try {
            ...
            failed("Arrays.parallelSort(short[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testEmptyAndNullCharArray() {
        ...
        try {
            ...
            failed("Arrays.parallelSort(char[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testEmptyAndNullByteArray() {
        ...
        try {
            ...
            failed("Arrays.parallelSort(byte[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testEmptyAndNullFloatArray() {
        ...
        try {
            ...
            failed("Arrays.parallelSort(float[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testEmptyAndNullDoubleArray() {
        ...
        try {
            ...
            failed("Arrays.parallelSort(double[],fromIndex,toIndex) shouldn't " + "catch null array");
        }
    ...
    private static void testAndCheckSubArray(int length) {
        ...
        for (int m = 1; m < length / 2; m *= 2) {
            ...
            for (TypeConverter converter : TypeConverter.values()) {
                out.println("Test 'subarray': " + converter + " length = " + length + ", m = " + m);
    ...
    private static void testAndCheckRange(int length) {
        ...
        for (int m = 1; m < 2 * length; m *= 2) {
            ...
            for (TypeConverter converter : TypeConverter.values()) {
                out.println("Test 'range': " + converter + ", length = " + length + ", m = " + m);
                Object convertedGolden = converter.convert(golden);
    ...
    private static void testStable(int length, MyRandom random) {
        ...
        out.println("Test 'stable': " + "random = " + random.getSeed() + ", length = " + length);
        Arrays.parallelSort(a);
        checkSorted(a);
        checkStable(a);
        out.println();
        a = build(length, random);
        out.println("Test 'stable' comparator: " + "random = " + random.getSeed() + ", length = " + length);
    ...
    private static void checkStable(Pair[] a) {
        for (int i = 0; i < a.length / 4; ) {
            ...
            if (!(key1 == key2 && key2 == key3 && key3 == key4)) {
                failed("On position " + i + " keys are different " + key1 + ", " + key2 + ", " + key3 + ", " + key4);
            }
            if (!(value1 < value2 && value2 < value3 && value3 < value4)) {
                failed("Sorting is not stable at position " + i + ". Second values have been changed: " + value1 + ", " + value2 + ", " + value3 + ", " + value4);
            }
        }
    }
    ...
    private static void testAndCheckWithInsertionSort(int length, MyRandom random) {
        ...
        for (int m = 1; m < 2 * length; m *= 2) {
            for (UnsortedBuilder builder : UnsortedBuilder.values()) {
                ...
                int[] test = golden.clone();
                for (TypeConverter converter : TypeConverter.values()) {
                    out.println("Test 'insertion sort': " + converter + " " + builder + "random = " + random.getSeed() + ", length = " + length + ", m = " + m);
                    Object convertedGolden = converter.convert(golden);
    ...
    private static void testMergeSort(int length) {
        ...
        for (int m = period - 2; m <= period + 2; m++) {
            for (MergeBuilder builder : MergeBuilder.values()) {
                ...
                int[] test = golden.clone();
                for (TypeConverter converter : TypeConverter.values()) {
                    out.println("Test 'merge sort': " + converter + " " + builder + "length = " + length + ", m = " + m);
                    Object convertedGolden = converter.convert(golden);
    ...
    private static void testAndCheckWithCheckSum(int length, MyRandom random) {
        ...
        for (int m = 1; m < 2 * length; m *= 2) {
            for (UnsortedBuilder builder : UnsortedBuilder.values()) {
                ...
                int[] test = golden.clone();
                for (TypeConverter converter : TypeConverter.values()) {
                    out.println("Test 'check sum': " + converter + " " + builder + "random = " + random.getSeed() + ", length = " + length + ", m = " + m);
                    Object convertedGolden = converter.convert(golden);
                    Object convertedTest = converter.convert(test);
                    sort(convertedTest);
    ...
    private static void testAndCheckWithScrambling(int length, MyRandom random) {
        ...
        for (int m = 1; m <= 7; m++) {
            ...
            for (SortedBuilder builder : SortedBuilder.values()) {
                ...
                for (TypeConverter converter : TypeConverter.values()) {
                    out.println("Test 'scrambling': " + converter + " " + builder + "random = " + random.getSeed() + ", length = " + length + ", m = " + m);
                    Object convertedGolden = converter.convert(golden);
                    Object convertedTest = converter.convert(test);
                    sort(convertedTest);
                    ...
                    for (int n = 0; n <= MAX; n++) {
                        for (int p = 0; p <= MAX; p++) {
                            ...
                            for (FloatBuilder builder : FloatBuilder.values()) {
                                out.println("Test 'float': random = " + random.getSeed() + ", length = " + length + ", a = " + a + ", g = " + g + ", z = " + z + ", n = " + n + ", p = " + p);
                    ...
                    for (int n = 0; n <= MAX; n++) {
                        for (int p = 0; p <= MAX; p++) {
                            ...
                            for (DoubleBuilder builder : DoubleBuilder.values()) {
                                out.println("Test 'double': random = " + random.getSeed() + ", length = " + length + ", a = " + a + ", g = " + g + ", z = " + z + ", n = " + n + ", p = " + p);
                                builder.build(golden, a, g, z, n, p, random);
    ...
    private static void failedSort(int index, String value1, String value2) {
        failed("Array is not sorted at " + index + "-th position: " + value1 + " and " + value2);
    }
    ...
    private static void compare(Object test, Object golden) {
        if (test instanceof int[]) {
            ...
            failed("Unknow type of array: " + test + " of class " + test.getClass().getName());
        }
    }
    ...
    private static void checkSorted(Object object) {
        if (object instanceof int[]) {
            ...
            failed("Unknow type of array: " + object + " of class " + object.getClass().getName());
        }
    }
    ...
    private static void checkSubArray(Integer[] a, int fromIndex, int toIndex, int m) {
        for (int i = 0; i < fromIndex; i++) {
            if (a[i].intValue() != 0xDEDA) {
                failed("Range sort changes left element on position " + i + ": " + a[i] + ", must be " + 0xDEDA);
            }
        }
        ...
        for (int i = toIndex; i < a.length; i++) {
            if (a[i].intValue() != 0xBABA) {
                failed("Range sort changes right element on position " + i + ": " + a[i] + ", must be " + 0xBABA);
            }
        }
    }
    ...
    private static void checkRange(Integer[] a, int m) {
        try {
            ...
            failed("ParallelSort does not throw IllegalArgumentException " + " as expected: fromIndex = " + (m + 1) + " toIndex = " + m);
        } catch (IllegalArgumentException iae) {
            try {
                Arrays.parallelSort(a, -m, a.length);
                failed("ParallelSort does not throw ArrayIndexOutOfBoundsException " + " as expected: fromIndex = " + (-m));
            } catch (ArrayIndexOutOfBoundsException aoe) {
                try {
                    Arrays.parallelSort(a, 0, a.length + m);
                    failed("ParallelSort does not throw ArrayIndexOutOfBoundsException " + " as expected: toIndex = " + (a.length + m));
