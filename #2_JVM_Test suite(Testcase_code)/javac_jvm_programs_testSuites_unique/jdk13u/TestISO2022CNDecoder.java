...
public class TestISO2022CNDecoder {
    ...
    private static boolean decodeTest(byte[] encoded, char[] decoded, String label) {
        boolean retval = true;
        int i = 0;
        try {
    ...
    private static boolean decodeResultTest(byte[] encoded, CoderResult expected, String label) {
    ...
    private static byte[] test0_bytes = { (byte) 0x00, (byte) 0x01, (byte) 0x02, (byte) 0x03, (byte) 0x0E, (byte) 0x21, (byte) 0x2f, (byte) 0x0E, (byte) 0xDD, (byte) 0x9f };

    private static char[] test0_chars = { 0x0000, 0x0001, 0x0002, 0x0003, 0x2019, 0xFFFD };

    private static byte[] test1_bytes = { (byte) 0x1b, (byte) 0x24, (byte) 0x29, (byte) 0x41, (byte) 0x21, (byte) 0x2f };

    private static char[] test1_chars = { 0x21, 0x2f };

    private static byte[] test2_bytes = { (byte) 0x0e, (byte) 0x1b, (byte) 0x24, (byte) 0x29, (byte) 0x41, (byte) 0x21, (byte) 0x2f };

    private static char[] test2_chars = { 0x2019 };

    private static byte[] test3_bytes = { (byte) 0x1b, (byte) 0x24, (byte) 0x29, (byte) 0x41, (byte) 0x0e, (byte) 0x21, (byte) 0x2f };

    private static byte[] test3a_bytes = { (byte) 0x1b, (byte) 0x24, (byte) 0x41, (byte) 0x0e, (byte) 0x21, (byte) 0x2f };

    private static char[] test3_chars = { 0x2019 };

    private static byte[] test4_bytes = { (byte) 0x1b, (byte) 0x24, (byte) 0x29, (byte) 0x41, (byte) 0x0f, (byte) 0x21, (byte) 0x2f };

    private static char[] test4_chars = { 0x21, 0x2f };

    private static byte[] test5_bytes = { (byte) 0x1b, (byte) 0x24, (byte) 0x29, (byte) 0x41, (byte) 0x0e, (byte) 0x21, (byte) 0x2e, (byte) 0x0f, (byte) 0x21, (byte) 0x2f };

    private static char[] test5_chars = { 0x2018, 0x21, 0x2f };

    private static byte[] test6_bytes = { (byte) 0x1b, (byte) 0x24, (byte) 0x29, (byte) 0x41, (byte) 0x0e, (byte) 0x21, (byte) 0x2e, (byte) 0x21, (byte) 0x2f };

    private static char[] test6_chars = { 0x2018, 0x2019 };

    private static byte[] test7_bytes = { (byte) 0x1b, (byte) 0x24, (byte) 0x29, (byte) 'G', (byte) 0x0e, (byte) 0x21, (byte) 0x2e, (byte) 0x21, (byte) 0x2f };

    private static char[] test7_chars = { 0xFE50, 0xFE51 };

    private static byte[] test8_bytes = { (byte) 0x1b, (byte) 0x24, (byte) 0x29, (byte) 'G', (byte) 0x0e, (byte) 0x21, (byte) 0x2e, (byte) 0x0f, (byte) 0x21, (byte) 0x2f };

    private static char[] test8_chars = { 0xFE50, 0x21, 0x2f };

    private static byte[] test9_bytes = { (byte) 0x1b, (byte) 0x24, (byte) 0x2a, (byte) 'H', (byte) 0x1b, (byte) 0x4e, (byte) 0x21, (byte) 0x2f };

    private static char[] test9_chars = { 0x4e0e };

    private static byte[] test10_bytes = { (byte) 0x1b, (byte) 0x24, (byte) '+', (byte) 'I', (byte) 0x1b, (byte) 0x4f, (byte) 0x21, (byte) 0x2f };

    private static char[] test10_chars = { 0x51e2 };

    private static byte[] test11_bytes = { (byte) 0x1b, (byte) 0x24, 
    (byte) 0x29, 
    (byte) 0x41, (byte) 0x0e, 
    (byte) 0x21, (byte) 0x2e, (byte) 0x1b, (byte) 0x24, 
    (byte) 0x2a, (byte) 'H', 
    (byte) 0x1b, (byte) 0x4e, 
    (byte) 0x21, (byte) 0x2f, (byte) 0x21, (byte) 0x2f };

    private static char[] test11_chars = { 0x2018, 0x4e0e, 0x2019 };

    private static byte[] test12_bytes = { (byte) 0x1b, (byte) 0x24, 
    (byte) 0x29, 
    (byte) 0x41, (byte) 0x0e, 
    (byte) 0x21, (byte) 0x2e, (byte) 0x1b, (byte) 0x24, 
    (byte) '+', (byte) 'I', 
    ...
    private static char[] test12_chars = { 0x2018, 0x51e2, 0x2019 };

    private static byte[] test13_bytes = { (byte) 0x0f0 };

    private static char[] test13_chars = { 0x00f0 };

    private static byte[] test14_bytes = { (byte) 0x0E, (byte) 0x21, (byte) 0x2f, (byte) 0x0E, (byte) 0xDD, (byte) 0x9f };

    private static CoderResult test14_result = CoderResult.unmappableForLength(2);

    private static byte[] test15_bytes = { 
    (byte) 0x1b, (byte) 0x4f, (byte) 0x20, (byte) 0x2f };
    ...
    public static void main(String[] argv) throws Exception {
        ...
        try {
            ...
            System.out.println("... requires nonstandard encoding name " + encodingName);
            pass &= false;
        }
