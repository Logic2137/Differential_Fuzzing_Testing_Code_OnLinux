...
class TestClass1 implements Serializable {
    ...
    private static ObjectStreamField[] serialPersistentFields = { new ObjectStreamField("field1", Integer.class), new ObjectStreamField("field2", Double.TYPE) };
...
class TestClass2 implements Serializable {
    ...
    public static final ObjectStreamField[] serialPersistentFields = { new ObjectStreamField("field1", Integer.class), new ObjectStreamField("field2", Double.TYPE) };
...
class TestClass4 implements Serializable {
    ...
    private static final ObjectStreamField[] serialPersistentFields = { new ObjectStreamField("field1", Integer.class), new ObjectStreamField("field2", Double.TYPE) };
...
public class CheckModifiers {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        TestClass1 tc1 = new TestClass1(new Integer(100), 25.56, 2000, new String("Test modifiers of serialPersistentFields"));
        TestClass2 tc2 = new TestClass2(new Integer(100), 25.56, 2000, new String("Test modifiers of serialPersistentFields"));
        TestClass3 tc3 = new TestClass3(new Integer(100), 25.56, 2000, new String("Test Type of serialPersistentFields"));
        TestClass4 tc4 = new TestClass4(new Integer(100), 25.56, 2000, new String("Test modifiers of serialPersistentFields"));
