...
public class DefaultEnabledProtocols {
    ...
    enum ContextVersion {
        ...
        TLS_CV_01("SSL", new String[] { "SSLv3", "TLSv1", "TLSv1.1", "TLSv1.2", "TLSv1.3" }),
        TLS_CV_02("TLS", new String[] { "SSLv3", "TLSv1", "TLSv1.1", "TLSv1.2", "TLSv1.3" }),
        ...
        TLS_CV_08("Default", new String[] { "SSLv3", "TLSv1", "TLSv1.1", "TLSv1.2", "TLSv1.3" });
