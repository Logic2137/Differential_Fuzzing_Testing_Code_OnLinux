...
public class Lock {
    ...
    static void testLockProtocol(File file, LockSlaveMirror slave) throws Exception {
        FileLock fl;
    ...
    static class LockSlaveMirror {
        ...
        LockSlaveMirror lock(long position, long size, boolean shared) throws IOException {
