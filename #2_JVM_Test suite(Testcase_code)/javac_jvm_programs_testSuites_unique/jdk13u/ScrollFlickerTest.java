...
public class ScrollFlickerTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SwingUtilities.invokeAndWait(() -> {
            ...
            scroll.setSize(insets.left + insets.right + scroll.getVerticalScrollBar().getPreferredSize().width, 50);
            scroll.revalidate();
        });
        robot.delay(200);
        SwingUtilities.invokeAndWait(() -> scroll.getViewport().addChangeListener((e) -> cnt++));
        robot.delay(1000);
