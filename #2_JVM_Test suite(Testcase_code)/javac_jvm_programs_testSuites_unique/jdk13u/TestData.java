...
public class TestData {
    ...
    0x002e, 
    0x0063, 
    0x006f, 0x006d }, "www.XN--ghbgi278xia.com", new ParseException("StringPrep PROHIBITED_ERROR", -1), false, true, true), new ErrorCase(new char[] { 
    0x0077, 
    0x0077, 
    0x0077, 0x002e, 
    0x002D, 
    ...
    0x002e, 
    0x0063, 
    0x006f, 0x006d }, "www.-abcde.com", new ParseException("StringPrep STD3_ASCII_RULES_ERROR", -1), true, true, false), new ErrorCase(new char[] { 
    0x0077, 
    0x0077, 
    0x0077, 0x002e, 
    0x0041, 
    ...
    0x002e, 
    0x0063, 
    0x006f, 0x006d }, "www.abcde@.com", new ParseException("StringPrep STD3_ASCII_RULES_ERROR", -1), true, true, false) };
