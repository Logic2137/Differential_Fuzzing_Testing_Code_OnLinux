...
public class FillingStation {
    ...
    public static void fill() {
        ...
        Space next = null;
        try {
            for (long available = rt.freeMemory(); available > freeSpaceLimit; available = rt.freeMemory()) {
                ...
                if (debug) {
                    System.err.println("available: " + Long.toString(available) + "  maxRequest: " + Integer.toString(maxRequest) + "  minRequest: " + Integer.toString(minRequest) + "  size: " + Integer.toString(size));
                }
