...
abstract class ProcessTest implements Runnable {
    ...
    public void run() {
        try {
            ...
            while ((line = is.readLine()) != null) System.err.println("ProcessTrap: " + line);
        } catch (IOException e) {
...
public class DestroyTest {
    ...
    public static ProcessTest getTest() throws Exception {
        ...
        if (osName.startsWith("Windows")) {
            ...
            if (osName.startsWith("Linux") || osName.startsWith("Mac OS") || osName.equals("SunOS") || osName.equals("AIX")) {
