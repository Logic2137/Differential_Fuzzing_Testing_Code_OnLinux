...
public class Bug7051769 {
    ...
    private static void testNumericShaping() {
        ...
        attrNS.put(TextAttribute.NUMERIC_SHAPING, NumericShaper.getContextualShaper(NumericShaper.ARABIC));
        attrNS.put(TextAttribute.RUN_DIRECTION, TextAttribute.RUN_DIRECTION_RTL);
