...
public class CreateBadJar {
    ...
    public static void main(String[] arguments) {
        ...
        try {
            ...
            if (u32(good, cenpos) != CENSIG)
                throw new RuntimeException("Where's CENSIG?");
            byte[] bad;
            bad = good.clone();
    ...
    static int findInCEN(byte[] bytes, int cenpos, String entryName) {
        ...
        do {
            ...
            if (u32(bytes, pos) != CENSIG)
                throw new RuntimeException("entry not found in CEN or premature end...");
            ...
            System.out.println("filename = " + filename + "\ncsize = " + csize + " uncomp.size = " + uncompsize + " file offset = " + offset);
