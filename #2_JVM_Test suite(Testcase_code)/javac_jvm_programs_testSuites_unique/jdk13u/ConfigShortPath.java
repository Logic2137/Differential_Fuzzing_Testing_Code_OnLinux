...
public class ConfigShortPath {
    ...
    private static final String[] winConfigNames = { "csp.cfg", "cspSpace.cfg", "cspQuotedPath.cfg" };

    private static final String[] solConfigNames = { "cspPlus.cfg" };
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] configNames = (osInfo.contains("Windows") ? winConfigNames : solConfigNames);
        ...
        for (int i = 0; i < configNames.length; i++) {
            ...
            try {
                ...
                if (cause.getClass().getName().equals("sun.security.pkcs11.ConfigurationException")) {
