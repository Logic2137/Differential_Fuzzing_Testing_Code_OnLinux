...
public class WhiteBoxHelper {
    ...
    public static MethodHandle getMethod(String name, MethodType type) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, InvocationTargetException {
