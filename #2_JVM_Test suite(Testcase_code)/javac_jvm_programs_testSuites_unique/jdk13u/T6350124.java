...
public class T6350124 {
    ...
    public static void main(String[] args) {
        ...
        compile("-cp", classpath, "-d", "aClasses", path(srcDir, "HelloWorldAP.java"));
        compile("-cp", classpath, "-sourcepath", srcDir.getPath(), "-d", "newClasses", "-s", "newSrc", "-processorpath", "aClasses", 
        "-processor", "HelloWorldAP", "-proc:only", path(srcDir, "Marked.java"));
