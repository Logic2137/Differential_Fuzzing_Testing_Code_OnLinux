...
public class Subset {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Subject emptys = new 
        Subject(false, Collections.singleton(new UnixPrincipal("user")), Collections.EMPTY_SET, creds);
        ...
        Subject scontain = new 
        Subject(false, Collections.singleton(new UnixPrincipal("user")), Collections.EMPTY_SET, creds1);
        ...
        creds2.add("ghi");
        Subject sstring = new 
        Subject(false, Collections.singleton(new UnixPrincipal("user")), Collections.EMPTY_SET, creds2);
        ...
        creds4.add("Exists");
        Subject scontain1 = new 
        Subject(false, Collections.singleton(new UnixPrincipal("user")), Collections.EMPTY_SET, creds4);
