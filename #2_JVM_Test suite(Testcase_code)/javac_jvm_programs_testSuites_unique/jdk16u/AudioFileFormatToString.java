    ...
    public static int run(String argv[], java.io.PrintStream out) {
        ...
        try {
         testedAudioFileFormat =
             new AudioFileFormat(nullAudioFileFormatType,  
                                 testAudioFormat, 
                                 (int) 1024 
                                 );
        ...
        try {
         testedAudioFileFormat =
             new AudioFileFormat(testAudioFileFormatType,  
                                 nullAudioFormat, 
                                 (int) 1024 
                                 );
         out.println(">  No any Exception was thrown!");
        ...
        try {
         testedAudioFileFormat =
             new TestAudioFileFormat(nullAudioFileFormatType,  
                                     (int) 1024, 
                                     testAudioFormat, 
                                     (int) 1024 
                                     );
        ...
        try {
         testedAudioFileFormat =
             new TestAudioFileFormat(testAudioFileFormatType,  
                                     (int) 1024, 
                                     nullAudioFormat, 
                                     (int) 1024 
                                     );
