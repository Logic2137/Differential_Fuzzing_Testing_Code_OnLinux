...
public class StringPropertyNames {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        checkProperties(props1,
                        NUM_PROPS1 + NUM_SHARE_PROPS, 
                        NUM_PROPS1 + NUM_SHARE_PROPS, 
                        NUM_PROPS1 + NUM_SHARE_PROPS, 
                        false);
        checkProperties(props2,
                        NUM_PROPS2 + NUM_SHARE_PROPS, 
                        NUM_PROPS1 + NUM_PROPS2 + NUM_SHARE_PROPS, 
                        NUM_PROPS1 + NUM_PROPS2 + NUM_SHARE_PROPS, 
                        false);
        ...
        checkProperties(props2,
                        NUM_PROPS2 + NUM_SHARE_PROPS, 
                        NUM_PROPS1 + NUM_PROPS2 + NUM_SHARE_PROPS, 
                        NUM_PROPS1 + NUM_PROPS2 + NUM_SHARE_PROPS + 1, 
                        false);
        ...
        checkProperties(props1,
                        ...
                        true);
        checkProperties(props2,
                        NUM_PROPS2 + NUM_SHARE_PROPS + 1, 
                        NUM_PROPS1 + NUM_PROPS2 + NUM_SHARE_PROPS, 
                        NUM_PROPS1 + NUM_PROPS2 + NUM_SHARE_PROPS + 2, 
                        true);
