...
public class TestUTF8 {
    ...
    static char[] getUTFChars() {
        char[] cc = new char[0x10000 - 0xe000 + 0xd800 + 
                             (0x110000 - 0x10000) * 2];    
        int pos = 0;
        int i = 0;
        for (i = 0; i < 0xd800; i++)
    ...
    static byte[][] malformed = {
        ...
        {1, (byte)0xA0, (byte)0x80}, 

        
        {1, (byte)0xC0, (byte)0x80}, 
        {1, (byte)0xC1, (byte)0xBF}, 
        {1, (byte)0xC2, (byte)0x00}, 
        {1, (byte)0xC2, (byte)0xC0}, 
        {1, (byte)0xD0, (byte)0x00}, 
        {1, (byte)0xD0, (byte)0xC0}, 
        {1, (byte)0xDF, (byte)0x00}, 
        {1, (byte)0xDF, (byte)0xC0}, 

        
        {1, (byte)0xE0, (byte)0x80, (byte)0x80},  
        {1, (byte)0xE0, (byte)0x80, (byte)0x80 }, 
        {1, (byte)0xE0, (byte)0x81, (byte)0xBF }, 
        {1, (byte)0xE0, (byte)0x9F, (byte)0xBF }, 

        {1, (byte)0xE0, (byte)0xC0, (byte)0xBF }, 
        {2, (byte)0xE0, (byte)0xA0, (byte)0x7F }, 
        {2, (byte)0xE0, (byte)0xA0, (byte)0xC0 }, 
        {2, (byte)0xE1, (byte)0x80, (byte)0x42},  

        {1, (byte)0xFF, (byte)0xFF, (byte)0xFF }, 
        {1, (byte)0xE0, (byte)0xC0, (byte)0x80 }, 
        {1, (byte)0xE0, (byte)0x80, (byte)0xC0 }, 
        {1, (byte)0xE0, (byte)0x41,},             
        {1, (byte)0xE1, (byte)0x40,},             
        {3, (byte)0xED, (byte)0xAE, (byte)0x80 }, 
        {3, (byte)0xED, (byte)0xB0, (byte)0x80 }, 



        
        {1, (byte)0xF0, (byte)0x80, (byte)0x80, (byte)0x80 }, 
        {1, (byte)0xF0, (byte)0x80, (byte)0x81, (byte)0xBF }, 
        {1, (byte)0xF0, (byte)0x80, (byte)0x9F, (byte)0xBF }, 
        {1, (byte)0xF0, (byte)0x8F, (byte)0xBF, (byte)0xBF }, 

        {1, (byte)0xFF, (byte)0xFF, (byte)0xFF, (byte)0xFF }, 
        {1, (byte)0xF0, (byte)0x80, (byte)0x80, (byte)0x80},  
        {1, (byte)0xF0, (byte)0xC0, (byte)0x80, (byte)0x80 }, 
        {1, (byte)0xF0, (byte)41 },                           
                                                              

        {2, (byte)0xF0, (byte)0x90, (byte)0xC0, (byte)0x80 }, 
        {3, (byte)0xF0, (byte)0x90, (byte)0x80, (byte)0xC0 }, 
        {2, (byte)0xF0, (byte)0x90, (byte)0x41 },             
                                                              

        {1, (byte)0xF1, (byte)0xC0, (byte)0x80, (byte)0x80 }, 
        {2, (byte)0xF1, (byte)0x80, (byte)0xC0, (byte)0x80 }, 
        {3, (byte)0xF1, (byte)0x80, (byte)0x80, (byte)0xC0 }, 
        {1, (byte)0xF4, (byte)0x90, (byte)0x80, (byte)0xC0 }, 
        {1, (byte)0xF4, (byte)0xC0, (byte)0x80, (byte)0xC0 }, 
        {1, (byte)0xF5, (byte)0x80, (byte)0x80, (byte)0xC0 }, 

        
        {1, (byte)0xF6, (byte)0x80, (byte)0x80, (byte)0x80 }, 
        {1, (byte)0xF6, (byte)0x80, (byte)0x80,  },
        {1, (byte)0xF6, (byte)0x80, },
        {1, (byte)0xF6, },
        {1, (byte)0xF5, (byte)0x80, (byte)0x80, (byte)0x80 }, 
        {1, (byte)0xF5, (byte)0x80, (byte)0x80,  },
        {1, (byte)0xF5, (byte)0x80,  },
        {1, (byte)0xF5  },

        {1, (byte)0xF4, (byte)0x90, (byte)0x80, (byte)0x80 }, 
        {1, (byte)0xF4, (byte)0x90, (byte)0x80 },
        {1, (byte)0xF4, (byte)0x90 },

        {1, (byte)0xF4, (byte)0x7f, (byte)0x80, (byte)0x80 }, 
        ...
        {1, (byte)0xF8, (byte)0x80, (byte)0x80, (byte)0x80, (byte)0x80},  
        {1, (byte)0xF8, (byte)0x80, (byte)0x80, (byte)0x80, (byte)0x80 }, 
        {1, (byte)0xF8, (byte)0x80, (byte)0x80, (byte)0x81, (byte)0xBF }, 
        {1, (byte)0xF8, (byte)0x80, (byte)0x80, (byte)0x9F, (byte)0xBF }, 
        {1, (byte)0xF8, (byte)0x80, (byte)0x8F, (byte)0xBF, (byte)0xBF }, 
        ...
        {1, (byte)0xFC, (byte)0x80, (byte)0x80, (byte)0x80, (byte)0x80, (byte)0x80 }, 
        {1, (byte)0xFC, (byte)0x80, (byte)0x80, (byte)0x80, (byte)0x81, (byte)0xBF }, 
        {1, (byte)0xFC, (byte)0x80, (byte)0x80, (byte)0x80, (byte)0x9F, (byte)0xBF }, 
        {1, (byte)0xFC, (byte)0x80, (byte)0x80, (byte)0x8F, (byte)0xBF, (byte)0xBF }, 
    ...
    static byte[][] malformed_cesu8 = {
        ...
        {1, (byte)0xF0, (byte)0x90, (byte)0xC0, (byte)0x80 }, 
        {1, (byte)0xF0, (byte)0x90, (byte)0x80, (byte)0xC0 }, 
        {1, (byte)0xF0, (byte)0x90, (byte)0x41 },             
                                                              

        {1, (byte)0xF1, (byte)0xC0, (byte)0x80, (byte)0x80 }, 
        {1, (byte)0xF1, (byte)0x80, (byte)0xC0, (byte)0x80 }, 
        {1, (byte)0xF1, (byte)0x80, (byte)0x80, (byte)0xC0 }, 
        {1, (byte)0xF4, (byte)0x90, (byte)0x80, (byte)0xC0 }, 
        {1, (byte)0xF4, (byte)0xC0, (byte)0x80, (byte)0xC0 }, 
        {1, (byte)0xF5, (byte)0x80, (byte)0x80, (byte)0xC0 }, 
