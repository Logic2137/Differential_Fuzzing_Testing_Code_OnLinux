...
public class JniArgTests {
	...
	void testBlock() {
		...
		retval_boolean = nativeIZrZ(0, backChannel);  
		...
		backChannel[0] = false;
		retval_boolean = nativeIZrZ(1, backChannel);   
		...
		backChannel[0] = false;
		retval_boolean = nativeIZrZ(254, backChannel); 
		if (retval_boolean != test_jboolean[0]) {
		...
		backChannel[0] = false;
		retval_boolean = nativeIZrZ(3840, backChannel); 
		if (retval_boolean != test_jboolean[1]) {
		...
		backChannel[0] = false;
		retval_boolean = nativeIZrZ(4094, backChannel); 
		if (retval_boolean != test_jboolean[0]) {
