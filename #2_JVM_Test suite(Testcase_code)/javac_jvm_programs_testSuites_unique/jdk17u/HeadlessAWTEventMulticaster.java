...
public class HeadlessAWTEventMulticaster {
    ...
    void doTest() {
        ...
        compList.componentResized(new ComponentEvent(component, ComponentEvent.COMPONENT_RESIZED));
        ...
        compListImpl = new ComponentListenerImpl();
        compList = AWTEventMulticaster.add(compListImpl, null);
        compList.componentMoved(new ComponentEvent(component, ComponentEvent.COMPONENT_MOVED));
        ...
        compListImpl = new ComponentListenerImpl();
        compList = AWTEventMulticaster.add(compListImpl, null);
        compList.componentShown(new ComponentEvent(component, ComponentEvent.COMPONENT_SHOWN));
        ...
        compListImpl = new ComponentListenerImpl();
        compList = AWTEventMulticaster.add(compListImpl, null);
        compList.componentHidden(new ComponentEvent(component, ComponentEvent.COMPONENT_HIDDEN));
        ...
        contList.componentAdded(new ContainerEvent(component, ContainerEvent.COMPONENT_ADDED, component));
        ...
        contListImpl = new ContainerListenerImpl();
        contList = AWTEventMulticaster.add(contListImpl, null);
        contList.componentRemoved(new ContainerEvent(component, ContainerEvent.COMPONENT_REMOVED, component));
        if (contListImpl.added) {
        ...
        keyList.keyTyped(new KeyEvent(component, KeyEvent.KEY_TYPED, 0L, 0, 0));
        ...
        keyListImpl = new KeyListenerImpl();
        keyList = AWTEventMulticaster.add(keyListImpl, null);
        keyList.keyPressed(new KeyEvent(component, KeyEvent.KEY_PRESSED, 0L, 0, 0));
        ...
        keyListImpl = new KeyListenerImpl();
        keyList = AWTEventMulticaster.add(keyListImpl, null);
        keyList.keyReleased(new KeyEvent(component, KeyEvent.KEY_RELEASED, 0L, 0, 0));
