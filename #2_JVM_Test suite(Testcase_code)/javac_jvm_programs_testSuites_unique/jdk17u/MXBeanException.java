...
public class MXBeanException {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        try {
            ...
            throw new RuntimeException("TEST FAILED: " + "UnsupportedOperationException not thrown");
        } catch (UnsupportedOperationException e) {
        }
        MBeanServer mbs = ManagementFactory.getPlatformMBeanServer();
        ObjectName on = new ObjectName(MEMORY_POOL_MXBEAN_DOMAIN_TYPE + ",name=" + pool.getName());
        ...
        MemoryPoolMXBean proxy = newPlatformMXBeanProxy(mbs, on.toString(), MemoryPoolMXBean.class);
        try {
            proxy.setUsageThreshold(1000);
            throw new RuntimeException("TEST FAILED: " + "UnsupportedOperationException not thrown via proxy");
        } catch (UnsupportedOperationException e) {
        }
