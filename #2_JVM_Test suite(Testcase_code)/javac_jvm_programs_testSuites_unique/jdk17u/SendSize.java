...
public class SendSize {
    ...
    public static void main(String[] args) throws Exception {
        DatagramSocket serverSocket = new DatagramSocket(new InetSocketAddress(InetAddress.getLocalHost(), 0));
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    switch(len) {
                        case packetLength:
                            ...
                            break;
                        default:
                            throw new RuntimeException("receive length is: " + len + ", send length: " + packetLength + ", buffer length: " + buf.length);
                    }
                }
                return;
            } catch (Exception e) {
    ...
    static class ClientThread extends Thread {
        ...
        public void run() {
            try {
                ...
                DatagramPacket sendPacket = new DatagramPacket(buf, packetLength, host, serverPort);
                for (int i = 0; i < 10; i++) {
