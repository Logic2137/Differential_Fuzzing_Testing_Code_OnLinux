...
public class Recording {
    ...
    private static Sequence createSequence(int lengthInSeconds, int tempoInBPM, int resolution) {
        ...
        if (tempoInBPM == 0) {
            ...
            System.out.print("Creating sequence: " + lengthInSeconds + "sec, " + "resolution=" + resolution + " ticks/beat...");
        } else {
            System.out.print("Creating sequence: " + lengthInSeconds + "sec, " + tempoInBPM + " beats/min, " + "resolution=" + resolution + " ticks/beat...");
        }
