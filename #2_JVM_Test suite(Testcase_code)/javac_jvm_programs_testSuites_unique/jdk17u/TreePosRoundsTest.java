...
public class TreePosRoundsTest extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (Element e : roundEnv.getRootElements()) {
            try {
                ...
                messager.printMessage(Diagnostic.Kind.ERROR, "Cannot get source: " + ex, e);
            }
        }
    ...
    class TestTreeScanner extends TreePathScanner<Void, Void> {
        ...
        void check(TreePath tp) {
            ...
            if (!equal) {
                messager.printMessage(Diagnostic.Kind.ERROR, "unexpected value found: '" + found + "'; expected: '" + expect + "'");
            }
        }
