...
class PongException extends Exception {
    ...
    private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        if (trace.length > 0) {
            throw new RuntimeException("TEST FAILED: exception contained non-empty stack trace: " + Arrays.asList(trace));
        }
    }
}
...
class Impl2 implements Pong {
    ...
    public void pong() throws PongException {
        __BAR__();
    }

    public void __BAR__() throws PongException {
...
public class SuppressStackTraces {
    ...
    private static void __FOO__(Pong stub) throws PongException, RemoteException {
        stub.pong();
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("TEST PASSED (server-side stack trace data suppressed)");
        } finally {
            try {
    ...
    private static void verifySuppression(Pong stub) throws Exception {
        ...
        for (int i = 0; i < remoteTrace.length; i++) {
            ...
            if (e.getMethodName().equals("__FOO__")) {
                ...
                throw new RuntimeException("TEST FAILED: trace contains __BAR__");
            }
        }
        if (fooIndex == -1) {
