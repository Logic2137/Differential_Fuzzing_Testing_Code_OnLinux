...
public class NullDataFlavorTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            clipboard.setContents(new NullSelection("DATA1", new DataFlavor[] { null, null, null }), null);
            clipboard.setContents(new NullSelection("DATA2", new DataFlavor[] { null, DataFlavor.stringFlavor, null }), null);
        ...
        if (failed) {
            throw new RuntimeException("test failed: NullPointerException " + "has been thrown");
        } else {
