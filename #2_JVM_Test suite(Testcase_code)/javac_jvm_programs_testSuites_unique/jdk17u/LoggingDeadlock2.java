...
public class LoggingDeadlock2 {
    ...
    public static void realMain(String[] arg) throws Throwable {
        try {
            ...
            final String trailingOutput = out.indexOf(MARKER) > -1 ? out.substring(out.indexOf(MARKER) + MARKER.length()) : out;
        ...
        public static void main(String[] args) throws Throwable {
            ...
            Thread exiter = new Thread() {
                ...
                public void run() {
                    try {
                        startingGate.await();
                        for (int i = 0; i < iters1; i++) counter.getAndIncrement();
                        System.exit(99);
                    } catch (Throwable t) {
                        t.printStackTrace();
                        System.exit(86);
            ...
            System.out.flush();
            startingGate.await();
            for (int i = 0; i < iters2; i++) counter.getAndIncrement();
    ...
    private static final String javaExe = System.getProperty("java.home") + File.separator + "bin" + File.separator + "java";

    private static final String jstackExe = System.getProperty("java.home") + File.separator + "bin" + File.separator + "jstack";

    private static final String classpath = System.getProperty("java.class.path");

    private static final List<String> javaChildArgs = Arrays.asList(new String[] { javaExe, "-classpath", classpath, "LoggingDeadlock2$JavaChild" });
