...
public class TestDuplicateImport {
    ...
    enum ImportKind {
        ...
        NORMAL("import a.#Q.#N;"), STATIC("import static a.#Q.#N;");
        ...
        String getImportStatement(QualifierKind qk, NameKind nk) {
            return importStr.replaceAll("#Q", qk.qualifierStr).replaceAll("#N", nk.nameStr);
        }
    ...
    class JavaSource extends SimpleJavaFileObject {
        ...
        public JavaSource() {
            ...
            source = bodyTemplate.replaceAll("#I1", ik1.getImportStatement(qk1, nk1)).replaceAll("#I2", ik2.getImportStatement(qk2, nk2));
        }
    ...
    void check() {
        ...
        if ((nk1.isMember() && !ik1.isStatic()) || (nk2.isMember() && !ik2.isStatic())) {
            errorExpected = true;
        }
        if (nk1 == nk2 && nk1 != NameKind.STAR && !qk1.compatible(qk2) && (!ik1.isStatic() || !ik2.isStatic())) {
            errorExpected = true;
        }
        if ((qk1 == QualifierKind.C && !ik1.isStatic() && nk1 != NameKind.STAR) || (qk2 == QualifierKind.C && !ik2.isStatic() && nk2 != NameKind.STAR)) {
            errorExpected = true;
        }
