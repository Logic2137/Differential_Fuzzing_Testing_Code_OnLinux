...
public class ShapingTest {
    ...
    private static void test6842557() {
        ...
        String[][] data = { { "\u0623\u0643\u062a\u0648\u0628\u0631 10", "\u0623\u0643\u062a\u0648\u0628\u0631 \u0661\u0660" }, { "\u0b86\u0ba3\u0bcd\u0b9f\u0bc1 2009", "\u0b86\u0ba3\u0bcd\u0b9f\u0bc1 \u0be8\u0be6\u0be6\u0bef" }, { "\u1200 2009", "\u1200 \u136a00\u1371" } };
    ...
    private static void checkResult(String ranges, NumericShaper ns, String given, String expected) {
