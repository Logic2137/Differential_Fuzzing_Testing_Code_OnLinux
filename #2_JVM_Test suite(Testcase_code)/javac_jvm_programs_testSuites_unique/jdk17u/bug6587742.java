...
public class bug6587742 extends JApplet {
    ...
    private class TestPanel extends JPanel {
        ...
        private TestPanel() {
                ...
                public void itemStateChanged(ItemEvent e) {
                    ...
                    if (theme != null) {
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(TestPanel.this, "Can't change theme: " + e1.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
            ...
            for (int i = 0; i < 12; i++) {
                int filled = i >> 2;
                pnVertical.add(createSlider(false, filled > 1 ? null : Boolean.valueOf(filled == 1), (i & 2) == 0, (i & 1) != 0));
            }
            JPanel pnHorizontal = new JPanel();
            pnHorizontal.setLayout(new BoxLayout(pnHorizontal, BoxLayout.X_AXIS));
            for (int i = 0; i < 12; i++) {
                int filled = i >> 2;
                pnHorizontal.add(createSlider(true, filled > 1 ? null : Boolean.valueOf(filled == 1), (i & 2) == 0, (i & 1) != 0));
            }
