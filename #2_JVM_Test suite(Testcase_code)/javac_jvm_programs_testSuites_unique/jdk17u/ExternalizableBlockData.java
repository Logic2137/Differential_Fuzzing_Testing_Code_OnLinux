...
class Foo implements Externalizable {
    ...
    public boolean equals(Object other) {
        if (other instanceof Foo) {
            Foo f = (Foo) other;
            return ((x == f.x) && (y == f.y) && ((obj != null) ? obj.equals(f.obj) : (f.obj == null)));
        }
        return false;
    }
}
...
public class ExternalizableBlockData {
    ...
    public static void main(String[] args) throws Exception {
        byte[] oldExternalizableBytes = getFileBytes(new File(System.getProperty("test.src", "."), "old.ser"));
        ...
        ObjectInputStream oin = new ObjectInputStream(new ByteArrayInputStream(oldExternalizableBytes));
