...
public class SerializationTests {
    ...
    public static void main(String[] args) throws Exception {
        BigDecimal[] values = { BigDecimal.ZERO, BigDecimal.ONE, BigDecimal.TEN, new BigDecimal(0), new BigDecimal(1), new BigDecimal(10), new BigDecimal(Integer.MAX_VALUE), new BigDecimal(Long.MAX_VALUE - 1), new BigDecimal(BigInteger.valueOf(1), 1), new BigDecimal(BigInteger.valueOf(100), 50) };
