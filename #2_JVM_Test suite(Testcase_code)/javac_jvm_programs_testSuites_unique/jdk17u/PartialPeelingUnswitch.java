    ...
    static class BookKeeper {
        ...
        public void compare() {
            if (iArr == null) {
                ...
                boolean check = PartialPeelingUnswitch.iFld == this.iFld && this.w == PartialPeelingUnswitch.w && this.x == PartialPeelingUnswitch.x && this.y == PartialPeelingUnswitch.y && this.z == PartialPeelingUnswitch.z && this.val == PartialPeelingUnswitch.val;
                for (int i = 0; i < 10; i++) {
        ...
        public void compare(int i) {
            if (i % 2 == 0 && iArr == null) {
                ...
                boolean check = PartialPeelingUnswitch.iFld == this.iFld2 && this.w2 == PartialPeelingUnswitch.w && this.x2 == PartialPeelingUnswitch.x && this.y2 == PartialPeelingUnswitch.y && this.z2 == PartialPeelingUnswitch.z && this.val2 == PartialPeelingUnswitch.val;
                for (int j = 0; j < 10; j++) {
