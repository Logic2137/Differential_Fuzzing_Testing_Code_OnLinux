...
public class InheritedMethodTest {
    ...
    public static MethodType mt(Class<?> ret, Class<?>... params) {
    ...
    static void testMetafactory(MethodHandle implMethod, String expected) throws Throwable {
        CallSite cs = LambdaMetafactory.metafactory(lookup, "get", mt(StringFactory.class, D.class), mt(String.class), implMethod, mt(String.class));
    ...
    static void testAltMetafactory(MethodHandle implMethod, String expected) throws Throwable {
        CallSite cs = LambdaMetafactory.altMetafactory(lookup, "get", mt(StringFactory.class, D.class), mt(String.class), implMethod, mt(String.class), LambdaMetafactory.FLAG_SERIALIZABLE);
        StringFactory factory = (StringFactory) cs.dynamicInvoker().invokeExact(new D());
        String actual = factory.get();
        if (!expected.equals(actual))
            throw new AssertionError("Unexpected result: " + actual);
