...
public class IdenticalMBeanInfoTest {
    ...
    public static class Broadcaster extends Whatsit implements BroadcasterMBean, NotificationBroadcaster {
        ...
        public MBeanNotificationInfo[] getNotificationInfo() {
            return new MBeanNotificationInfo[] { new MBeanNotificationInfo(new String[] { "type" + id }, "something", "a something") };
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        DynamicMBean mbean = new StandardMBean(new Whatsit(), WhatsitMBean.class);
        ...
        if (mbi1 != mbi2) {
            fail("Two MBeans of the same class should have identical " + "MBeanInfo");
        }
        if (mbi2 != mbi3) {
            if (true)
                System.out.println("IGNORING StandardMBean(...) failure");
            else
                fail("Plain Standard MBean should have identical MBeanInfo " + "to StandardMBean(...) with same class as resource");
        }
        if (mbi4 == mbi5 || mbi4.equals(mbi5)) {
            fail("Two MBeans of the same class should NOT have identical " + "MBeanInfo if they are NotificationBroadcasters and " + "do not return the same MBeanNotificationInfo[]");
        }
        if (failure == null) {
