...
public class TestProxyLazyValue {
    ...
    private static void testUserProxyLazyValue() {
        Object obj = new UserProxyLazyValue(UserLazyClass.class.getName()).createValue(null);
        if (!(obj instanceof UserLazyClass)) {
            throw new RuntimeException("Object is not UserLazyClass!");
        }
        obj = new UserProxyLazyValue(UserLazyClass.class.getName(), new Object[] { UserLazyClass.CONSTRUCTOR_ARG }).createValue(null);
        if (!(obj instanceof UserLazyClass)) {
            throw new RuntimeException("Object is not UserLazyClass!");
        }
        ...
        obj = new UserProxyLazyValue(UserLazyClass.class.getName(), "method1").createValue(null);
        if (!UserLazyClass.RESULT_1.equals(obj)) {
            throw new RuntimeException("Result is wrong!");
        }
        obj = new UserProxyLazyValue(UserLazyClass.class.getName(), "method2", new Object[] { UserLazyClass.RESULT_2 }).createValue(null);
    ...
    private static void testProxyLazyValue() {
        Object obj = new UIDefaults.ProxyLazyValue(UserLazyClass.class.getName()).createValue(null);
        if (!(obj instanceof UserLazyClass)) {
            throw new RuntimeException("Object is not UserLazyClass!");
        }
        obj = new UIDefaults.ProxyLazyValue(UserLazyClass.class.getName(), new Object[] { UserLazyClass.CONSTRUCTOR_ARG }).createValue(null);
        if (!(obj instanceof UserLazyClass)) {
            throw new RuntimeException("Object is not UserLazyClass!");
        }
        if (((UserLazyClass) obj).arg != UserLazyClass.CONSTRUCTOR_ARG) {
        ...
        obj = new UIDefaults.ProxyLazyValue(UserLazyClass.class.getName(), "method1").createValue(null);
        if (!UserLazyClass.RESULT_1.equals(obj)) {
            throw new RuntimeException("Result is wrong!");
        }
        obj = new UIDefaults.ProxyLazyValue(UserLazyClass.class.getName(), "method2", new Object[] { UserLazyClass.RESULT_2 }).createValue(null);
        if (!UserLazyClass.RESULT_2.equals(obj)) {
            throw new RuntimeException("Result is wrong!");
        }
    }
    ...
    public static class UserProxyLazyValue extends UIDefaults.ProxyLazyValue {
        ...
        public UserProxyLazyValue(String className, String methodName, Object[] methodArgs) {
