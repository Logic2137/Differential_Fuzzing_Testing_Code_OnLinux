...
public class AcceleratorTest extends JApplet {
    ...
    String[] CMD = { "\u042E, keep me in focus", "Item Cyrl Be", "Item English Period", "Item English N", "\u0436" };

    JFrame jfr;

    public void init() {
        this.setLayout(new BorderLayout());
        String[] instructions = { " Ensure you have Russian keyboard layout as a currently active.", "(1) Press Ctrl+\u0411 (a key with \",<\" on it) ", "(2) Find a . (period) in this layout (perhaps \"/?\" or \"7&\" key).", "Press Ctrl+.", "(3) Press Crtl+ regular English . (period) key (on \".>\" )", "(4) Press Ctrl+ key with English N.", "(5) Press Alt+\u042E (key with \".>\")", "(6) Press Alt+\u0436 (key with \";:\")", "If all expected commands will be fired, look for message", "\"All tests passed\"" };
        ...
        menuItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.getExtendedKeyCodeForChar('\u0431'), InputEvent.CTRL_DOWN_MASK));
        JMenuItem menuItemEnglish = new JMenuItem(CMD[2]);
        menuItemEnglish.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_PERIOD, InputEvent.CTRL_DOWN_MASK));
        ...
        jbu.getActionMap().put("pushAction", new AbstractAction("pushAction") {
