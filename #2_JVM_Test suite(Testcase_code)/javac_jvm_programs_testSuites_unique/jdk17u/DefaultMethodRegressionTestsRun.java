...
public class DefaultMethodRegressionTestsRun {
    ...
    public static void main(String... args) throws Exception {
        ...
        testDir.mkdirs();
        File srcFile = new File(new File(System.getProperty("test.src")), "DefaultMethodRegressionTests.java");
        String[] javacargs = { srcFile.getAbsolutePath(), "-d", testDir.getAbsolutePath() };
