...
public class LongTransferTest {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("LongTransferTest-main: " + "Test to transfer bytes with a size bigger than Integer.MAX_VALUE.");
        System.out.println("LongTransferTest-main: Test at first " + "the private method transferFromFileChannel with files...");
        final String dir = (String) System.getProperty("java.io.tmpdir");
        System.out.println("LongTransferTest-main: using the temp dir (java.io.tmpdir) " + dir);
        ...
        System.out.println("LongTransferTest-main: Test the " + "private method transferFromArbitraryChannel with sockets ...");
