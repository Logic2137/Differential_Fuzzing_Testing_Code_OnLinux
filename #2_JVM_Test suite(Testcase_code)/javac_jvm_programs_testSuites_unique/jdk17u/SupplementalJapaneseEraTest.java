...
public class SupplementalJapaneseEraTest {
    ...
    private static void testProperty() {
        Calendar jcal = new Calendar.Builder().setCalendarType("japanese").setFields(ERA, 6, YEAR, 1, DAY_OF_YEAR, 1).build();
        ...
        got = DateTimeFormatter.ofPattern("GGGG G GGGGG").withLocale(Locale.US).withChronology(JapaneseChronology.INSTANCE).format(jdate);
    ...
    private static void testValidation(String eraName) {
        Calendar jcal = new Calendar.Builder().setCalendarType("japanese").setFields(YEAR, 1, DAY_OF_YEAR, 1).build();
