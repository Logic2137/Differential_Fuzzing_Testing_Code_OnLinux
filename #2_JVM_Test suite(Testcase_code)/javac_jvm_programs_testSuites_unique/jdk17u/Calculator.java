...
public class Calculator extends JComponent {
    ...
    private enum State {
        ...
        INPUT_X, INPUT_X_FINISHED, INPUT_Y, INPUT_Y_FINISHED
    }
    ...
    private void addComp(Component comp, int gridx, int gridy, int gridwidth, int gridheight) {
        add(comp, new GridBagConstraints(gridx, gridy, gridwidth, gridheight, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 4, 4, 4), 0, 0));
    }
