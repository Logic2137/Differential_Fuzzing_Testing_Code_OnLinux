...
public class CipherStreamClose {
    ...
    public static byte[] blockEncrypt(String message, SecretKey key) throws Exception {
        byte[] data;
    ...
    public static Object blockDecrypt(byte[] data, SecretKey key) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SecretKeySpec key = new SecretKeySpec(parseHexBinary("12345678123456781234567812345678"), "AES");
        ...
        if (!Arrays.equals(sd, bd)) {
            ...
            System.err.println("Block : " + printHexBinary(be) + "\t Digest: " + printHexBinary(bd));
