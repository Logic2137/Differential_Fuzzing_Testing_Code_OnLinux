...
public class CLDRDisplayNamesTest {
    ...
    static final String[][] CLDR_DATA = { { "ja-JP", "\u30a2\u30e1\u30ea\u30ab\u592a\u5e73\u6d0b\u6a19\u6e96\u6642", "GMT-08:00", "\u30a2\u30e1\u30ea\u30ab\u592a\u5e73\u6d0b\u590f\u6642\u9593", "GMT-07:00" }, { "zh-CN", "\u5317\u7f8e\u592a\u5e73\u6d0b\u6807\u51c6\u65f6\u95f4", "GMT-08:00", "\u5317\u7f8e\u592a\u5e73\u6d0b\u590f\u4ee4\u65f6\u95f4", "GMT-07:00" }, { "de-DE", "Nordamerikanische Westk\u00fcsten-Normalzeit", "GMT-08:00", "Nordamerikanische Westk\u00fcsten-Sommerzeit", "GMT-07:00" } };
    ...
    public static void main(String[] args) {
        ...
        for (String[] data : CLDR_DATA) {
            ...
            for (int i = 1; i < data.length; i++) {
                ...
                if (!data[i].equals(name)) {
                    System.err.printf("error: got '%s' expected '%s' (style=%d, daylight=%s, locale=%s)%n", name, data[i], style, daylight, locale);
                    errors++;
                }
            }
        }
        ...
        errors += List.of(Locale.ROOT, Locale.CHINA, Locale.GERMANY, Locale.JAPAN, Locale.UK, Locale.US, Locale.forLanguageTag("hi-IN"), Locale.forLanguageTag("es-419")).stream().peek(System.out::println).map(l -> DateFormatSymbols.getInstance(l).getZoneStrings()).flatMap(zoneStrings -> Arrays.stream(zoneStrings)).filter(namesArray -> Arrays.stream(namesArray).anyMatch(aName -> aName.equals(NO_INHERITANCE_MARKER))).peek(marker -> {
