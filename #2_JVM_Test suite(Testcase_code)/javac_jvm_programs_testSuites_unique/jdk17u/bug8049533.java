...
public class bug8049533 {
    ...
    public static void main(String[] args) {
        ...
        frame.add(panel);
        MouseWheelEvent event = new MouseWheelEvent(panel, 0, 0, 0, 0, 0, 0, 0, 0, false, 0, 0, 2, PRECISE_WHEEL_ROTATION);
        MouseWheelEvent convertedEvent = (MouseWheelEvent) SwingUtilities.convertMouseEvent(event.getComponent(), event, null);
