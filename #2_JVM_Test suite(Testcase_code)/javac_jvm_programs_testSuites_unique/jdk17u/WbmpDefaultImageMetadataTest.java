...
public class WbmpDefaultImageMetadataTest {
    ...
    public WbmpDefaultImageMetadataTest(String format) {
        try {
            ...
            if (writer == null) {
                throw new RuntimeException("No writer available for the given format." + " Test failed.");
            }
            ...
            if (imageData == null) {
                ...
                throw new RuntimeException("Default image metadata is null." + " Test failed.");
            }
            int j = 0;
            String[] imageDataNames = null;
            if (imageData != null) {
                System.out.println("Is standard metadata format supported (Image) ? " + imageData.isStandardMetadataFormatSupported());
            ...
            e.printStackTrace();
            throw new RuntimeException("Exception was thrown." + " Test failed.");
        }
    }
    ...
    public static void main(String[] args) {
        WbmpDefaultImageMetadataTest test = new WbmpDefaultImageMetadataTest("wbmp");
    }
}
