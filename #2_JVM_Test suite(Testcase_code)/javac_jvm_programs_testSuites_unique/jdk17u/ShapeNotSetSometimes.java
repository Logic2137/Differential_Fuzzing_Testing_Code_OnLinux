...
public class ShapeNotSetSometimes {
    ...
    private void initializeGUI() {
        ...
        shape = a;
        pointsToCheck = new int[][] { { 106, 86 }, { 96, 38 }, { 76, 107 }, { 180, 25 }, { 24, 105 }, { 196, 77 }, { 165, 50 }, { 14, 113 }, { 89, 132 }, { 167, 117 }, { 165, 196 }, { 191, 163 }, { 146, 185 }, { 61, 170 }, { 148, 171 }, { 82, 172 }, { 186, 11 }, { 199, 141 }, { 13, 173 }, { 187, 3 } };
    ...
    private void doTest() throws Exception {
        ...
        for (int i = COUNT_TARGET; i < COUNT_TARGET * 2; i++) {
            ...
            if (inside && BACKGROUND_COLOR.equals(c) || !inside && !BACKGROUND_COLOR.equals(c)) {
                ...
                System.err.println("Checking for transparency failed: point: " + (window.getX() + x) + ", " + (window.getY() + y) + ", color = " + c + (inside ? " is of un" : " is not of ") + "expected background color " + BACKGROUND_COLOR);
