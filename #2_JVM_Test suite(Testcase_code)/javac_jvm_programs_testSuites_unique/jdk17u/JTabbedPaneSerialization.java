...
public class JTabbedPaneSerialization {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        if (tabbedPane.getTabCount() != readPane.getTabCount()) {
            System.out.println("tabbedPane.tabCount " + tabbedPane.getTabCount());
            System.out.println("readPane.tabCount " + readPane.getTabCount());
            throw new RuntimeException("Number of pages/tab of JTabbedPane is not deserialized");
        }
    }
}
