...
public class BlitRotateClippedArea {
    ...
    public static void main(String[] args) throws Exception {
        ...
        } while (dstVI2VI.contentsLost() || dstBI2VI.contentsLost() || srcVI.contentsLost());
        validate(gold, snapshotVI2VI);
        validate(gold, snapshotBI2VI);
        validate(gold, dstVI2BI);
    }

    private static void validate(BufferedImage gold, BufferedImage img) throws IOException {
