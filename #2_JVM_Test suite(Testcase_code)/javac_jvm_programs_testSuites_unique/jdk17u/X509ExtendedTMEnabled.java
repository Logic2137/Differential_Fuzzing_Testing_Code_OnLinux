...
public class X509ExtendedTMEnabled {
    ...
    void doServerSide() throws Exception {
        SSLServerSocketFactory sslssf = getContext(true).getServerSocketFactory();
        ...
        if (!serverTM.wasServerChecked() && serverTM.wasClientChecked()) {
            ...
            throw new Exception("SERVER TEST FAILED!  " + !serverTM.wasServerChecked() + " " + serverTM.wasClientChecked());
        }
    }
    ...
    void doClientSide() throws Exception {
        ...
        if (clientTM.wasServerChecked() && !clientTM.wasClientChecked()) {
            ...
            throw new Exception("CLIENT TEST FAILED!  " + clientTM.wasServerChecked() + " " + !clientTM.wasClientChecked());
        }
    }
    ...
    static class MyExtendedX509TM extends X509ExtendedTrustManager implements X509TrustManager {
