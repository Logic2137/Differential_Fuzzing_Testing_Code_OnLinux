...
public class BigBinarySearch {
    ...
    static class SparseIntegerList extends AbstractList<Integer> implements RandomAccess {
    ...
    private static void checkBinarySearch(List<Integer> l, int i, Comparator<Integer> comparator) {
        try {
            equal(i, Collections.binarySearch(l, l.get(i), comparator));
        } catch (Throwable t) {
            unexpected(t);
        }
    }
    ...
    private static void realMain(String[] args) throws Throwable {
        ...
        for (int i : ints) big.set(i, -big.get(i));
        for (int i : ints) checkBinarySearch(big, i, reverse);
    }
