...
public class BasicJarBuilder {
    ...
    public static void build(boolean classesInWorkDir, String jarName, String... classNames) throws Exception {
        if (classesInWorkDir) {
    ...
    public static void build(String jarName, String... classNames) throws Exception {
        createSimpleJar(classDir, classDir + File.separator + jarName + ".jar", classNames);
    }

    private static void createSimpleJar(String jarclassDir, String jarName, String[] classNames) throws Exception {
