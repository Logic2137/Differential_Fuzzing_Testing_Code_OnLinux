...
public class SSLCtxAccessToSessCtx {
    ...
    AtomicInteger serverReady = new AtomicInteger(1);
    ...
    void doServerSide(int serverPort) throws Exception {
        ...
        SSLSessionContext sessCache = sslSocket.getSession().getSessionContext();
    ...
    void doClientSide() throws Exception {
        ...
        SSLSocket sslSocket;
        sslSocket = (SSLSocket) sslsf.createSocket("localhost", serverPorts[0]);
        InputStream sslIS = sslSocket.getInputStream();
        OutputStream sslOS = sslSocket.getOutputStream();
        sslOS.write(237);
        sslOS.flush();
    ...
    void startServer(final int port, boolean newThread) throws Exception {
        if (newThread) {
