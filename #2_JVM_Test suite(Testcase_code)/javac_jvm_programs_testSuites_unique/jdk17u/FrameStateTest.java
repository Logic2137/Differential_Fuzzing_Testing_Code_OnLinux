...
class CreateFrame extends Frame implements ActionListener, WindowListener {
    ...
    CreateFrame(int iFrameState, boolean bFrameResizable) {
        ...
        System.out.println("CREATING FRAME - Initially " + ((iconic) ? "ICONIFIED" : "NORMAL (NON-ICONIFIED)") + " and " + ((resizable) ? "RESIZABLE" : "NON-RESIZABLE"));
        Sysout.println("CREATING FRAME - Initially " + ((iconic) ? "ICONIFIED" : "NORMAL (NON-ICONIFIED)") + " and " + ((resizable) ? "RESIZABLE" : "NON-RESIZABLE"));
