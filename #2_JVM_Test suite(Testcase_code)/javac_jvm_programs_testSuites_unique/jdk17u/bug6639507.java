    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                assertEmptyTitle(new Dialog(new Dialog((Window) null), Dialog.ModalityType.APPLICATION_MODAL), "new Dialog((Window) null), Dialog.ModalityType.APPLICATION_MODAL");
                ...
                assertEmptyTitle(new JDialog((Window) null, Dialog.ModalityType.APPLICATION_MODAL), "new JDialog((Window) null, Dialog.ModalityType.APPLICATION_MODAL)");
            }
        });
    }
