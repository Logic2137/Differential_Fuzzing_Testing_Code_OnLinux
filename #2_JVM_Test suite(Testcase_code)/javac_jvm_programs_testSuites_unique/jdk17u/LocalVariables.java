...
class ModifiedVars {
    ...
    void parameterized() {
        ...
        final Parameterized<@A Parameterized<@A String, @B String>, @B String> nestedParameterized = null;
    }
    ...
    void arrays() {
        ...
        @A
        final String @B [] array1Deep = null;
        @A
        final String[][] array2 = null;
        @A
        final String @A [] @B [] array2Deep = null;
