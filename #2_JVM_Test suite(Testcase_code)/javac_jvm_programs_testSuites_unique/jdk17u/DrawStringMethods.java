...
public class DrawStringMethods implements Printable {
    ...
    public static void main(String[] args) {
        String[] instructions = { "Confirm that the methods are printed.", " For Graphics: drawString, drawString, drawChars, drawBytes", " For Graphics2D: drawString, drawString, drawGlyphVector" };
