...
public class LoggerLevelTest {
    ...
    private static void testLevel(Set<Level> untested, Level systemLevel, java.util.logging.Level julLevel) {
        ...
        assertEquals(systemLevel.getName(), systemLevel.name(), "System.Logger.Level." + systemLevel.name() + ".getName()");
        assertEquals(systemLevel.getSeverity(), julLevel.intValue(), "System.Logger.Level." + systemLevel.name() + ".getSeverity");
    }
