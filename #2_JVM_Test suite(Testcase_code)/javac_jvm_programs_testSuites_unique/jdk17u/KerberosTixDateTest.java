...
public class KerberosTixDateTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        flags[8] = true;
        KerberosTicket t = new KerberosTicket(asn1Bytes, client, server, keyBytes, 1, flags, inDate, inDate, inDate, inDate, null);
        inDate.setTime(0);
    ...
    private static void testDateImmutability(KerberosTicket t, long origTime) throws Exception {
    ...
    private static void testS11nCompatibility(KerberosTicket t) throws Exception {
        System.out.println("Testing against KerberosTicket from JDK6...");
        byte[] serializedBytes = Base64.getMimeDecoder().decode(serializedKerberosTix);
