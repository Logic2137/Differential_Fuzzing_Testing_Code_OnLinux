...
public class AIACheck {
    ...
    private final static File baseDir = new File(System.getProperty("test.src", "."));
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<X509Certificate> list = Arrays.asList(new X509Certificate[] { aiaCert });
        CertificateFactory cf = CertificateFactory.getInstance("X.509");
        ...
        try {
            ...
            System.out.println("Extracted the URL of the OCSP responder from " + "the certificate's AuthorityInfoAccess extension.");
        }
    }
}
