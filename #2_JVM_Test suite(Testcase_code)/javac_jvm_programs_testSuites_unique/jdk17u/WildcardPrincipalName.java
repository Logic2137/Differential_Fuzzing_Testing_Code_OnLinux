...
public class WildcardPrincipalName {
    ...
    private static class RunAsPrivilegedUserAction implements PrivilegedAction<Void> {

        private final PrivilegedAction<Void> action;

        private final Principal principal;

        RunAsPrivilegedUserAction(Principal principal, PrivilegedAction<Void> action) {
    ...
    private static class CheckPermissionAction implements PrivilegedAction<Void> {
