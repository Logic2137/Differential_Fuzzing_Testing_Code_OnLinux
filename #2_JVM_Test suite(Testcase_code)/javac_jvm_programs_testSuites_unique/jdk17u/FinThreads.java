public class FinThreads {
    ...
    static class Foo {
        ...
        public static void create(final boolean catchFinalizer) throws InterruptedException {
    ...
    static void alarm(final Thread sleeper, final long delay) throws InterruptedException {
        Thread t = new Thread(new Runnable() {
