...
public class MiscTest {
    ...
    private static final MBeanNotificationInfo[] notifs = new MBeanNotificationInfo[] { new MBeanNotificationInfo(new String[] { AttributeChangeNotification.ATTRIBUTE_CHANGE }, AttributeChangeNotification.class.getName(), "This notification is emitted when the reset() method is called.") };

    private static Class<?>[] testClasses = { Test11.class, Test12.class, Test21.class, Test22.class, Test31.class, Test32.class, Test33.class, Test34.class, Test41.class, Test42.class, Test43.class, Test44.class };

    private static Class<?>[] testIntfs = { Test11MBean.class, Test12MBean.class, Test21MXBean.class, Test22MXBean.class, Test31SMB.class, Test32SMB.class, Test33SMB.class, Test34SMB.class, Test41SMX.class, Test42SMX.class, Test43SMX.class, Test44SMX.class };
    ...
    public static class BaseEmitterTest extends NotificationBroadcasterSupport {
    ...
    public static class Test11 extends BaseTest implements Test11MBean {
    }

    public static class Test12 extends BaseEmitterTest implements Test12MBean {
    }

    public static class Test21 extends BaseTest implements Test21MXBean {
    }

    public static class Test22 extends BaseEmitterTest implements Test22MXBean {
    }

    public static class Test31 extends BaseTest implements Test31SMB {
    }

    public static class Test32 extends BaseEmitterTest implements Test32SMB {
    }

    public static class Test33 extends StandardMBean implements Test33SMB {
    ...
    public static class Test34 extends StandardEmitterMBean implements Test34SMB {

        public Test34() {
            super(Test34SMB.class, false, new NotificationBroadcasterSupport(notifs));
        }
    ...
    public static class Test41 extends BaseTest implements Test41SMX {
    }

    public static class Test42 extends BaseEmitterTest implements Test42SMX {
    }

    public static class Test43 extends StandardMBean implements Test43SMX {
    ...
    public static class Test44 extends StandardEmitterMBean implements Test44SMX {

        public Test44() {
            super(Test44SMX.class, true, new NotificationBroadcasterSupport(notifs));
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < testClasses.length; i++) {
            ...
            echo("\n>>> Create the " + cn + " MBean within the MBeanServer");
            echo("\tObjectName = " + ons);
            ObjectName on = ObjectName.getInstance(ons);
            if (testClasses[i] == Test31.class || testClasses[i] == Test41.class) {
                StandardMBean s = new StandardMBean(testClasses[i].newInstance(), (Class) testIntfs[i], testClasses[i] == Test41.class);
                mbs.registerMBean(s, on);
            } else if (testClasses[i] == Test32.class || testClasses[i] == Test42.class) {
                Object o = testClasses[i].newInstance();
                StandardEmitterMBean s = new StandardEmitterMBean(o, (Class) testIntfs[i], testClasses[i] == Test42.class, (NotificationEmitter) o);
                mbs.registerMBean(s, on);
            } else {
            ...
            if (i % 2 == 0) {
                if (mbni.length != 0) {
                    throw new IllegalArgumentException("Should not be a NotificationEmitter");
                }
            } else {
                if (mbni.length != 1) {
                    throw new IllegalArgumentException("Should not a NotificationEmitter with one notification");
                }
            }
    ...
    private static void manageMBean(MBeanServer mbs, ObjectName on, String cn) throws Exception {
        echo("\n>>> Manage the " + cn + " MBean using its attributes ");
        ...
        if (type.equals(Test11.class.getName())) {
            Test11MBean p = JMX.newMBeanProxy(mbs, on, Test11MBean.class);
            ...
            Test12MBean p = JMX.newMBeanProxy(mbs, on, Test12MBean.class, true);
            echo("\n    Getting attribute values through proxies:");
            echo("\tState       = \"" + p.getState() + "\"");
            echo("\tNbChanges   = " + p.getNbChanges());
            echo("\tMemoryUsage = " + p.getMemoryUsage());
            ...
            Test21MXBean p = JMX.newMXBeanProxy(mbs, on, Test21MXBean.class);
            echo("\n    Getting attribute values through proxies:");
            echo("\tState       = \"" + p.getState() + "\"");
            echo("\tNbChanges   = " + p.getNbChanges());
            echo("\tMemoryUsage = " + p.getMemoryUsage());
            ...
            Test22MXBean p = JMX.newMXBeanProxy(mbs, on, Test22MXBean.class, true);
            echo("\n    Getting attribute values through proxies:");
            echo("\tState       = \"" + p.getState() + "\"");
            echo("\tNbChanges   = " + p.getNbChanges());
            echo("\tMemoryUsage = " + p.getMemoryUsage());
            ...
            Test31SMB p = JMX.newMBeanProxy(mbs, on, Test31SMB.class);
            echo("\n    Getting attribute values through proxies:");
            echo("\tState       = \"" + p.getState() + "\"");
            echo("\tNbChanges   = " + p.getNbChanges());
            echo("\tMemoryUsage = " + p.getMemoryUsage());
            ...
            Test32SMB p = JMX.newMBeanProxy(mbs, on, Test32SMB.class, true);
            echo("\n    Getting attribute values through proxies:");
            echo("\tState       = \"" + p.getState() + "\"");
            echo("\tNbChanges   = " + p.getNbChanges());
            echo("\tMemoryUsage = " + p.getMemoryUsage());
            ...
            Test33SMB p = JMX.newMBeanProxy(mbs, on, Test33SMB.class, true);
            echo("\n    Getting attribute values through proxies:");
            echo("\tState       = \"" + p.getState() + "\"");
            echo("\tNbChanges   = " + p.getNbChanges());
            echo("\tMemoryUsage = " + p.getMemoryUsage());
            ...
            Test34SMB p = JMX.newMBeanProxy(mbs, on, Test34SMB.class, true);
            echo("\n    Getting attribute values through proxies:");
            echo("\tState       = \"" + p.getState() + "\"");
            echo("\tNbChanges   = " + p.getNbChanges());
            echo("\tMemoryUsage = " + p.getMemoryUsage());
            ...
            Test41SMX p = JMX.newMXBeanProxy(mbs, on, Test41SMX.class);
            echo("\n    Getting attribute values through proxies:");
            echo("\tState       = \"" + p.getState() + "\"");
            echo("\tNbChanges   = " + p.getNbChanges());
            echo("\tMemoryUsage = " + p.getMemoryUsage());
            ...
            Test42SMX p = JMX.newMXBeanProxy(mbs, on, Test42SMX.class, true);
            echo("\n    Getting attribute values through proxies:");
            echo("\tState       = \"" + p.getState() + "\"");
            echo("\tNbChanges   = " + p.getNbChanges());
            echo("\tMemoryUsage = " + p.getMemoryUsage());
            ...
            Test43SMX p = JMX.newMXBeanProxy(mbs, on, Test43SMX.class);
            echo("\n    Getting attribute values through proxies:");
            echo("\tState       = \"" + p.getState() + "\"");
            echo("\tNbChanges   = " + p.getNbChanges());
            echo("\tMemoryUsage = " + p.getMemoryUsage());
            ...
            Test44SMX p = JMX.newMXBeanProxy(mbs, on, Test44SMX.class, true);
            echo("\n    Getting attribute values through proxies:");
            echo("\tState       = \"" + p.getState() + "\"");
            echo("\tNbChanges   = " + p.getNbChanges());
            echo("\tMemoryUsage = " + p.getMemoryUsage());
    ...
    private static void printAttributes(MBeanServer mbs, ObjectName on) throws Exception {
    ...
    public static void checkDescriptor(MBeanServer mbs, ObjectName on, String immutable, String intf) throws Exception {
        MBeanInfo mbi = mbs.getMBeanInfo(on);
