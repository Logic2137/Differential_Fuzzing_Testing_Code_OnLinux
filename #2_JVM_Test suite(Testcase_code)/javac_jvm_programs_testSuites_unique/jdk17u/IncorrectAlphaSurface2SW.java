...
public final class IncorrectAlphaSurface2SW {
    ...
    private static final int[] dstTypes = { TYPE_INT_ARGB, TYPE_INT_ARGB_PRE, TYPE_4BYTE_ABGR, TYPE_4BYTE_ABGR_PRE };
    ...
    private static void drawVItoBI(GraphicsConfiguration gc, BufferedImage bi, VolatileImage vi) {
        while (true) {
            vi.validate(gc);
    ...
    private static void validate(BufferedImage bi, BufferedImage gold) throws IOException {
