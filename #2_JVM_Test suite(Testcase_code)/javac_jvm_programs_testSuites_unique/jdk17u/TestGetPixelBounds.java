...
public class TestGetPixelBounds {
    ...
    public static void main(String[] args) {
        ...
        AttributedString as;
        if (graphic) {
            GraphicAttribute sga = new ShapeGraphicAttribute(new Ellipse2D.Float(0, -10, 10, 20), TOP_ALIGNMENT, STROKE);
        ...
        System.out.println("   again frc: " + tl.getPixelBounds(new FontRenderContext(AffineTransform.getScaleInstance(100, 100), true, true), x, y));
        System.out.println("   again int off: " + tl.getPixelBounds(frc, x - 2, y + 2));
