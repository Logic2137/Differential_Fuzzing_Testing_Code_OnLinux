...
public final class RecognizeHugeWaveExtFiles {
    ...
    private static final int[][] waveTypeBits = { { 0xFFFE, 8 } };
    ...
    private static final long[] dataSizes = { 0, 1, 2, 3, Integer.MAX_VALUE - 1, Integer.MAX_VALUE, (long) Integer.MAX_VALUE + 1, MAX_UNSIGNED_INT - 1, MAX_UNSIGNED_INT };
    ...
    private static void testAFF(final int[] type, final int rate, final int channel, final long size) throws Exception {
    ...
    private static void testAIS(final int[] type, final int rate, final int channel, final long size) throws Exception {
        final byte[] header = createHeader(type, rate, channel, size);
        final ByteArrayInputStream fake = new ByteArrayInputStream(header);
    ...
    private static void validateFormat(final int bits, final int rate, final int channel, final AudioFormat format) {
    ...
    private static byte[] createHeader(final int[] type, final int rate, final int channel, final long size) {
