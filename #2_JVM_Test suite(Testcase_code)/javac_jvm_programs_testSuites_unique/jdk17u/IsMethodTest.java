...
public class IsMethodTest {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("Test that Boolean isX() and int isX() both " + "define operations not attributes");
        ...
        if (attrs.length == 0)
            ...
            for (int i = 0; i < attrs.length; i++) {
                System.out.println("  " + attrs[i].getType() + " " + attrs[i].getName());
            }
        }
        ...
        for (int i = 0; i < ops.length; i++) {
            System.out.println("  " + ops[i].getReturnType() + " " + ops[i].getName());
        }
        ...
        for (int i = 0; i < bogusAttrNames.length; i++) {
            ...
            try {
                ...
                ok = false;
                System.out.println("TEST FAILS: getAttribute(\"" + bogusAttrName + "\") should not work");
            } catch (AttributeNotFoundException e) {
                System.out.println("OK: getAttribute(" + bogusAttrName + ") got exception as expected");
            }
        }
        ...
        for (int i = 0; i < opNames.length; i++) {
            ...
            try {
                ...
                ok = false;
                System.out.println("TEST FAILS: invoke(" + opName + ") got exception: " + e);
            }
        }
        if (ok)
