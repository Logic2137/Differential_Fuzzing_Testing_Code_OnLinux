...
public class CurrencyFormat {
    ...
    static void testFormatting() {
        ...
        Locale[] locales = { Locale.US, Locale.JAPAN, Locale.GERMANY, Locale.ITALY, new Locale("it", "IT", "EURO"), Locale.forLanguageTag("de-AT"), Locale.forLanguageTag("fr-CH") };
