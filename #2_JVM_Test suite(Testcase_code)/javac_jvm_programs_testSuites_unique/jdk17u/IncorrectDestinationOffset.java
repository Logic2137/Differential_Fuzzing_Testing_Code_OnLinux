...
public final class IncorrectDestinationOffset {
    ...
    private static void validate(BufferedImage bi, int point2draw, int size2draw) throws IOException {
    ...
    private static boolean isInsideGreenArea(int point2draw, int size2draw, int x, int y) {
        return x >= point2draw && x < point2draw + size2draw && y >= point2draw && y < point2draw + size2draw;
    }
}
