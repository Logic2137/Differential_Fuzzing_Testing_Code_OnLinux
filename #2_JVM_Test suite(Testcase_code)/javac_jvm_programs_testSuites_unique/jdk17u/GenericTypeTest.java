...
public class GenericTypeTest {
    ...
    private static final Class<?>[] illegalMXBeans = { GenTMXBean.class, GenStringMXBean.class, GenMethodMXBean.class, TypeVarMXBean.class };
    ...
    private static final Class<?>[] legalMXBeans = { ConcreteOverrideMXBean.class };
    ...
    private static <T> T makeNullMXBean(Class<T> intf) throws Exception {
        return intf.cast(Proxy.newProxyInstance(intf.getClassLoader(), new Class<?>[] { intf }, nullInvocationHandler));
    }
            ...
            for (Class<?> intf : intfs) {
                ...
                try {
                    ...
                    if (legal)
                        ...
                        failX("Registering " + intfName + " should produce " + "NotCompliantMBeanException", e);
                    }
                }
            }
        }
