...
public class BashCache {
    ...
    private static final Charset[] charsets = new Charset[] { Charset.forName("US-ASCII"), Charset.forName("UTF-8"), Charset.forName("CP1252"), Charset.forName("UTF-16BE") };
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < THREADS; i++) bashers[i].join();
        if (failed)
