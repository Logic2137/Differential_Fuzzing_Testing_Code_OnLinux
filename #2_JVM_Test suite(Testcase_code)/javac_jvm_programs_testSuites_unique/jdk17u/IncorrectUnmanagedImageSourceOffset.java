...
public final class IncorrectUnmanagedImageSourceOffset {
    ...
    private static final int[] TYPES = { TYPE_INT_RGB, TYPE_INT_ARGB, TYPE_INT_ARGB_PRE, TYPE_INT_BGR, TYPE_3BYTE_BGR, TYPE_4BYTE_ABGR, TYPE_4BYTE_ABGR_PRE, TYPE_BYTE_BINARY, TYPE_BYTE_INDEXED, TYPE_CUSTOM };
    ...
    private static BufferedImage makeCustomUnmanagedBI() {
        ...
        WritableRaster raster = Raster.createInterleavedRaster(DataBuffer.TYPE_BYTE, w, h, w * 3 + 2, 3, bOffs, null);
