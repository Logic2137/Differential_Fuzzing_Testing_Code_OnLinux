...
public class ScrollableTabbedPaneTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (UIManager.LookAndFeelInfo lookAndFeelItem : lookAndFeelArray) {
            executeCase(lookAndFeelItem.getClassName(), lookAndFeelItem.getName());
        }
    ...
    private static void executeCase(String lookAndFeelString, String shortLAF) throws Exception {
    ...
    private static void createUI(final String shortLAF) throws Exception {
        SwingUtilities.invokeAndWait(new Runnable() {
    ...
    private static void createLeftUI(final String shortLAF) throws Exception {
        SwingUtilities.invokeAndWait(new Runnable() {
    ...
    private static void createRightUI(final String shortLAF) throws Exception {
        SwingUtilities.invokeAndWait(new Runnable() {
        ...
        SwingUtilities.invokeAndWait(new Runnable() {
            ...
            public void run() {
                ...
                do {
                    ...
                    if (value != tempValue) {
                        String error = "[" + shortLAF + "]: [Error]: TabbedScrollPane fails";
                        errorString += error;
                    }
                    ++i;
                } while (i < 10);
