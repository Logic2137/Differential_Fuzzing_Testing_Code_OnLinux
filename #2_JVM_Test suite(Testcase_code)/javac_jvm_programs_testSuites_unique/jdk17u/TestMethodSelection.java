...
public class TestMethodSelection {
    ...
    static void doInvoke(B_A target, String expected) throws Throwable {
        ...
        check((String) B_A.class.getDeclaredMethod("m", new Class<?>[0]).invoke(target, new Object[0]), expected);
    }
    ...
    static void doInvoke(B_PA target, String expected) throws Throwable {
        ...
        check((String) mh.invoke(target), expected);
        check((String) B_PA.class.getDeclaredMethod("m", new Class<?>[0]).invoke(target, new Object[0]), expected);
    }
    ...
    static void doInvoke(PB_A target, String expected) throws Throwable {
        ...
        check((String) mh.invoke(target), expected);
        check((String) PB_A.class.getDeclaredMethod("m", new Class<?>[0]).invoke(target, new Object[0]), expected);
    }
    ...
    static void doInvoke(PB_PA target, String expected) throws Throwable {
        ...
        check((String) mh.invoke(target), expected);
        check((String) PB_PA.class.getDeclaredMethod("m", new Class<?>[0]).invoke(target, new Object[0]), expected);
    }
