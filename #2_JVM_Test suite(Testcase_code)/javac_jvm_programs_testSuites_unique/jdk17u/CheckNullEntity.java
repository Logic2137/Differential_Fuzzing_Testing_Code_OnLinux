    ...
    CheckNullEntity() throws Exception {
        ...
        try {
            ...
            if (trustManager instanceof X509ExtendedTrustManager) {
                try {
                    ((X509ExtendedTrustManager) trustManager).checkClientTrusted(certChain, (String) null, (Socket) null);
                } catch (IllegalArgumentException iae) {
                    extFailed >>= 1;
                }
                try {
                    ((X509ExtendedTrustManager) trustManager).checkServerTrusted(certChain, (String) null, (Socket) null);
                } catch (IllegalArgumentException iae) {
                    extFailed >>= 1;
                }
                try {
                    ((X509ExtendedTrustManager) trustManager).checkClientTrusted(certChain, "", (Socket) null);
                } catch (IllegalArgumentException iae) {
                    extFailed >>= 1;
                }
                try {
                    ((X509ExtendedTrustManager) trustManager).checkServerTrusted(certChain, "", (Socket) null);
                } catch (IllegalArgumentException iae) {
                    extFailed >>= 1;
                }
                try {
                    ((X509ExtendedTrustManager) trustManager).checkClientTrusted(null, authType, (Socket) null);
                } catch (IllegalArgumentException iae) {
                    extFailed >>= 1;
                }
                try {
                    ((X509ExtendedTrustManager) trustManager).checkServerTrusted(null, authType, (Socket) null);
                } catch (IllegalArgumentException iae) {
                    extFailed >>= 1;
                }
            } else {
