...
public class Bug4965260 {
    ...
    static Locale[] locales2Test = new Locale[] { new Locale("de"), new Locale("es"), new Locale("fr"), new Locale("it"), new Locale("sv") };

    static String[] expectedNames = new String[] { "Niederl\u00e4ndisch", "neerland\u00e9s", "n\u00e9erlandais", "neerlandese", "nederl\u00e4ndska" };
