...
public class SerialCompatTest {
            ...
            try {
                switch(i) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        check(msg, on1.getCanonicalKeyPropertyListString().equals("b=c"));
                        break;
                    case 4:
                        check(msg, on1.getKeyProperty("b").equals("c"));
                        break;
                    case 5:
                        check(msg, on1.getKeyPropertyList().equals(Collections.singletonMap("b", "c")));
                        break;
                    case 6:
    ...
    static void checkName(String testname, ObjectName on) throws Exception {
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
        ObjectOutputStream oos = new ObjectOutputStream(bos);
        oos.writeObject(on);
        oos.close();
            ...
            try {
                switch(i) {
                    case 0:
                        ...
                        break;
                    case 1:
                        check(msg, on1.getCanonicalName().equals(on.getCanonicalName()));
                        break;
                    case 2:
                        check(msg, on1.getKeyPropertyListString().equals(on.getKeyPropertyListString()));
                        break;
                    case 3:
                        check(msg, on1.getCanonicalKeyPropertyListString().equals(on.getCanonicalKeyPropertyListString()));
                        break;
                    case 4:
                        for (Object ko : on1.getKeyPropertyList().keySet()) {
                            final String key = (String) ko;
                            check(msg, on1.getKeyProperty(key).equals(on.getKeyProperty(key)));
                        }
                    ...
                    case 5:
                        check(msg, on1.getKeyPropertyList().equals(on.getKeyPropertyList()));
                        break;
                    case 6:
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        check(msg, on1.isPropertyPattern() == on.isPropertyPattern());
                        break;
                    case 9:
                        check(msg, on1.equals(on));
                        break;
    ...
    private static String[] names6616825 = { "a:b=c", "a:b=c,*", "*:*", ":*", ":b=c", ":b=c,*", "a:*,b=c", ":*", ":*,b=c", "*x?:k=\"x\\*z\"", "*x?:k=\"x\\*z\",*", "*x?:*,k=\"x\\*z\"", "*x?:k=\"x\\*z\",*,b=c" };
    ...
    static void check6616825() throws Exception {
        ...
        for (String n : names6616825) {
            ...
            try {
                ...
                failed = true;
                System.out.println("Unexpected failure for 6616825 [" + n + "]: " + x);
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (osc.getFields().length != 6) {
            throw new Exception("Not using old serial form: fields: " + Arrays.asList(osc.getFields()));
        }
        try {
            check6211220();
        } catch (Exception x) {
