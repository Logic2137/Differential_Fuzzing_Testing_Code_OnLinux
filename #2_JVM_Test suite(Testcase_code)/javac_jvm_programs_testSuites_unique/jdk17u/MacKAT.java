    ...
    static class MacTest extends Test {
        ...
        void run(Provider p) {
            ...
            try {
                ...
                System.out.println("Skip test for " + alg + " due to lack of support");
                return;
            }
