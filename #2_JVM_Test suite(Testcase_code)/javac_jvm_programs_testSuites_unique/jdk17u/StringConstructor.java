...
public class StringConstructor {
    ...
    public static void main(String[] argv) {
        ...
        constructWithoutError("+123456789123456789", 123456789123456789L);
        constructWithoutError("-123456789123456789", -123456789123456789L);
        constructWithoutError(Integer.toString(Integer.MIN_VALUE), (long) Integer.MIN_VALUE);
        constructWithoutError(Integer.toString(Integer.MAX_VALUE), (long) Integer.MAX_VALUE);
