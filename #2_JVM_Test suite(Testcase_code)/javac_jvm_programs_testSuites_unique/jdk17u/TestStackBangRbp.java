...
public class TestStackBangRbp {
    ...
    static Object m1(boolean deopt) {
        ...
        if (deopt) {
            UnloadedClass1 res = new UnloadedClass1();
            return res;
        }
        return null;
    }
    ...
    static void m3(boolean deopt) {
        ...
        try {
            ...
            UnloadedClass2 res = new UnloadedClass2();
        }
        TestStackBangRbp.o1 = o1;
    }
