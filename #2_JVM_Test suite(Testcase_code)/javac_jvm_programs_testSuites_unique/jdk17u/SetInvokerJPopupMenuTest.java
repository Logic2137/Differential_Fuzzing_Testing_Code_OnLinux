...
public class SetInvokerJPopupMenuTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (UIManager.LookAndFeelInfo LF : installedLookAndFeels) {
            ...
            if (isPopupVisible) {
                throw new RuntimeException("PopupMenu is not taken down after" + " single button click");
            }
        }
    }
    ...
    private static class MyPopupMenu extends JPopupMenu {
        ...
        public void setVisible(boolean state) {
            if (!state) {
                ...
                if (traceString.lastIndexOf("windowDeactivated") > 0 || traceString.lastIndexOf("menuSelectionChanged") > 0) {
                    return;
                }
            }
