...
public class DebugUsingCustomConnector {
    ...
    public static void main(String[] main_args) throws Exception {
        ...
        LaunchingConnector connector = (LaunchingConnector) find(launchers, "SimpleLaunchingConnector");
        Map args = connector.defaultArguments();
        Connector.StringArgument arg = (Connector.StringArgument) args.get("class");
        arg.setValue("Foo");
