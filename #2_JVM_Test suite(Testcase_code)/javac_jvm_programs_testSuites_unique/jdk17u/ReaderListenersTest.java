...
public class ReaderListenersTest {
    ...
    protected static BufferedImage createTestImage() {
        BufferedImage res = new BufferedImage(100, 100, BufferedImage.TYPE_INT_RGB);
    ...
    static class IIOReadProgressAdapter implements IIOReadProgressListener {
        ...
        public void imageComplete(ImageReader source) {
            ...
            if (!isImageComplete) {
                ...
                throw new RuntimeException("The imageComplete() is called twice." + " Test failed.");
            }
            checkProgress();
        }
        ...
        public void imageStarted(ImageReader source, int imageIndex) {
            ...
            if (!isImageStarted) {
                ...
                throw new RuntimeException("The imageStarted() was called twice. " + " Test failed.");
            }
            progress.clear();
        }
