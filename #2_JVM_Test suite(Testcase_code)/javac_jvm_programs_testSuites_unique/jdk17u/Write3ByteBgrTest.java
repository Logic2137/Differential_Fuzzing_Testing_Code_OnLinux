...
public class Write3ByteBgrTest {
    ...
    static int[] bufferedImageType = { BufferedImage.TYPE_CUSTOM, BufferedImage.TYPE_BYTE_BINARY, BufferedImage.TYPE_3BYTE_BGR };

    static String[] bufferedImageStringType = { "BufferedImage.TYPE_CUSTOM: test for BandedSampleModel", "BufferedImage.TYPE_BYTE_BINARY", "BufferedImage.TYPE_3BYTE_BGR" };
    ...
    private static BufferedImage createTestImage(int type, Color c) {
        ...
        if (type == BufferedImage.TYPE_CUSTOM) {
            WritableRaster wr = Raster.createBandedRaster(DataBuffer.TYPE_BYTE, width, height, width, new int[] { 0, 1, 2 }, new int[] { 1, 2, 0 }, null);
