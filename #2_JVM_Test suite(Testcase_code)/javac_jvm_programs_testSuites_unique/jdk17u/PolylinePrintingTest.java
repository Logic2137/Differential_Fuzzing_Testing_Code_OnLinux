...
public class PolylinePrintingTest implements Printable {
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        g2d.setStroke(new BasicStroke(25, BasicStroke.CAP_ROUND, BasicStroke.JOIN_MITER, 10.0F, null, 1.0F));
    ...
    private void drawPolylineGOOD(Graphics2D g2d, int[] x2Points, int[] y2Points) {
        Path2D polyline = new Path2D.Float(Path2D.WIND_EVEN_ODD, x2Points.length);
    ...
    public static void main(String[] args) throws PrinterException {
        String[] instructions = { "You must have a printer available to perform this test.", "OK the print dialog, and collect the printed page.", "Passing test : Output should show two identical chevrons.", "Failing test : The line joins will appear different." };
        Sysout.createDialog();
