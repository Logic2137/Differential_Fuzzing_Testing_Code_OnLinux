...
public class BigDecimalCompatibilityTest {
    ...
    static final String[] exponents = { "E-100", "E100", "E-900", "E900", "" };

    static final int[] multipliers = { -1, 1, -100, 100, -9999, 9999 };
                ...
                for (int k = 0; k < input_data.length; k++) {
                    for (int l = 0; l < input_data.length; l++) {
                        for (int m = 0; m < exponents.length; m++) {
                            String s = input_data[i] + input_data[j] + '.' + input_data[k] + input_data[l] + exponents[m];
