...
public class Test4513830 {
    ...
    private static final int[] TEXTLENGTHS = { 16, 17, 18, 19, 20, 21, 22, 23 };
    ...
    public boolean execute() throws Exception {
        ...
        for (int i = 0; i < TEXTLENGTHS.length; i++) {
            ...
            if (cipherTextLength != 32) {
                throw new Exception("output size " + cipherTextLength + " for input size " + TEXTLENGTHS[i] + " when encrypting is wrong!");
            }
        }
        return true;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String testName = test.getClass().getName() + "[" + ALGO + "/" + MODE + "/" + PADDING + "]";
        if (test.execute()) {
