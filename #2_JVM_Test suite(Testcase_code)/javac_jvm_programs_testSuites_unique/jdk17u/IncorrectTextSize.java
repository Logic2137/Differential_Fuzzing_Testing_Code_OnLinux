...
public final class IncorrectTextSize {
    ...
    static BufferedImage bi = new BufferedImage(width, height, BufferedImage.TYPE_INT_ARGB);

    static final String TEXT = "The quick brown fox jumps over the lazy dog" + "The quick brown fox jumps over the lazy dog";
            ...
            for (int i = (length + 1) * scale; i < width; ++i) {
                for (int j = 0; j < height; ++j) {
                    if (bi.getRGB(i, j) != Color.white.getRGB()) {
                        ...
                        System.err.println("Color is:" + new Color(bi.getRGB(i, j)));
