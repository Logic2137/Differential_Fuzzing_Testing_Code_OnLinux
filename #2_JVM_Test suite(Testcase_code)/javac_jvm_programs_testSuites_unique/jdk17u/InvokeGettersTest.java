...
public class InvokeGettersTest {
    ...
    private static boolean test(MBeanServer mbs, ObjectName on, boolean shouldWork) throws Exception {
        ++x;
        ...
        final Object[][] badInvokes = { { "isWhatsit", null, null }, { "getWhatsit", new Object[] { 5 }, new String[] { "int" } }, { "setWhatsit", new Object[] { false }, new String[] { "boolean" } }, { "getTrue", null, null } };
        boolean ok = true;
        for (Object[] args : badInvokes) {
            String name = (String) args[0];
            Object[] params = (Object[]) args[1];
            String[] sig = (String[]) args[2];
            String what = "invoke " + name + (sig == null ? "[]" : Arrays.toString(sig));
            try {
                ...
                if (e.getCause() instanceof NoSuchMethodException)
                    ...
                    ok = fail(what + " got exception with wrong nested " + "exception: " + e.getCause());
                }
            }
        }
        return ok;
