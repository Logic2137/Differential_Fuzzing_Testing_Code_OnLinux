...
public class PageSetupDlgBlockingTest extends Panel {
    ...
    public void init() {
        ...
        String[] instructions = { "This test verifies that native modal 'Page Setup' dialog doesn't block event", "handling when called on EventDispatchThread.", " ", "After test started you will see 'Test Frame' frame which contains", "one 'Click Me' button.", "1. Click the button:", "   - 'Page Setup' dialog will appear.", "2. Drag the dialog over the 'Test Frame' so that to enforce its button redraw:", "   - if you're seeing the button redraw (as long as PAINT events are displayed)", "     the test PASSED else FAILED." };
