...
public class NegateTests {
    ...
    static int negateTests() {
        int failures = 0;
        BigDecimal[][] testCasesCeiling = { { new BigDecimal("1.3"), new BigDecimal("-1") }, { new BigDecimal("-1.3"), new BigDecimal("2") } };
        failures += negateTest(testCasesCeiling, new MathContext(1, RoundingMode.CEILING));
        BigDecimal[][] testCasesFloor = { { new BigDecimal("1.3"), new BigDecimal("-2") }, { new BigDecimal("-1.3"), new BigDecimal("1") } };
