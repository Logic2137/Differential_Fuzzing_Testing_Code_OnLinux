...
public class TestOAEPPadding {
    ...
    public static void main(String[] args) throws Exception {
        ...
        test(new OAEPParameterSpec("SHA-512/224", "MGF1", MGF1ParameterSpec.SHA224, PSource.PSpecified.DEFAULT));
        test(new OAEPParameterSpec("SHA-512/224", "MGF1", MGF1ParameterSpec.SHA512_224, PSource.PSpecified.DEFAULT));
        test(new OAEPParameterSpec("SHA-512/256", "MGF1", MGF1ParameterSpec.SHA384, PSource.PSpecified.DEFAULT));
        test(new OAEPParameterSpec("SHA-512/256", "MGF1", MGF1ParameterSpec.SHA512, PSource.PSpecified.DEFAULT));
        if (failed) {
    ...
    static void test(OAEPParameterSpec spec) throws Exception {
        ...
        try {
            ...
            System.err.println(algo + " failed with data length of " + (max + 1));
            e.printStackTrace();
            failed = true;
        }
    }
