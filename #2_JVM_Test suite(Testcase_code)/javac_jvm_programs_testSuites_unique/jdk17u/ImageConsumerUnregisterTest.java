...
public class ImageConsumerUnregisterTest extends javax.swing.JFrame {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String str = "";
        try {
            component.getToolkit().createCustomCursor(component.getGraphicsConfiguration().createCompatibleImage(16, 16, java.awt.Transparency.BITMASK), new java.awt.Point(0, 0), "Hidden");
            str = rs.toString();
        } finally {
            System.setErr(obj);
            if (!str.isEmpty()) {
