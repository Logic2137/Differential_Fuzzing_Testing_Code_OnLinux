    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            if (!bounds.equals(maxArea1)) {
                throw new RuntimeException("The bounds of the Frame do not equal" + " to screen 1 size");
            }
            ...
            if (!bounds.equals(maxArea2)) {
                throw new RuntimeException("The bounds of the Frame do not equal" + " to screen 2 size");
            }
        } finally {
            if (frame != null) {
                frame.dispose();
