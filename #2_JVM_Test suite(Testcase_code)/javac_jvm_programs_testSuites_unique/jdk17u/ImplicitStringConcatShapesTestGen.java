...
public class ImplicitStringConcatShapesTestGen {
    ...
    public static void main(String... args) throws IOException {
        ...
        String[] types = { "boolean", "byte", "byteMinus", "char", "short", "shortMinus", "int", "intMinus", "integer", "integerNull", "float", "floatMinus", "long", "longMinus", "double", "doubleMinus", "object", "objectNull", "objectNullToString", "String", "StringUTF16", "StringU1", "StringU2", "intArrayNull", "objectArrayNull" };
        ...
        for (String l1 : l) {
            lines.add(String.format("test(\"%s\", \"\" + %s);", escapeToUnicode(values.get(l1)), l1));
            lines.add(String.format("test(\"%s\", \"prefix\" + %s);", escapeToUnicode("prefix" + values.get(l1)), l1));
            lines.add(String.format("test(\"%s\", %s + \"suffix\");", escapeToUnicode(values.get(l1) + "suffix"), l1));
            lines.add(String.format("test(\"%s\", \"prefix\" + %s + \"suffix\");", escapeToUnicode("prefix" + values.get(l1) + "suffix"), l1));
        }
        for (String l1 : l) {
            for (String l2 : l) {
                lines.add(String.format("test(\"%s\", \"\" + %s + %s);", escapeToUnicode(values.get(l1) + values.get(l2)), l1, l2));
                lines.add(String.format("test(\"%s\", \"\" + %s + %s + \"suffix\");", escapeToUnicode(values.get(l1) + values.get(l2) + "suffix"), l1, l2));
                lines.add(String.format("test(\"%s\", \"prefix\" + %s + \"suffix1\" + %s + \"suffix2\");", escapeToUnicode("prefix" + values.get(l1) + "suffix1" + values.get(l2) + "suffix2"), l1, l2));
            }
        }
