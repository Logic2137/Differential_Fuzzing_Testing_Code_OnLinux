...
public class XMLResourceBundleTest {
    ...
    public static void main(String[] args) {
        ...
        if (!type.equals("XML")) {
            throw new RuntimeException("Root Locale: type: got " + type + ", expected XML (ASCII)");
        }
        rb = ResourceBundle.getBundle("XmlRB", Locale.JAPAN, xmlControl);
        type = rb.getString("type");
        if (!type.equals("\uff38\uff2d\uff2c")) {
            throw new RuntimeException("Locale.JAPAN: type: got " + type + ", expected \uff38\uff2d\uff2c (fullwidth XML)");
        }
    }
