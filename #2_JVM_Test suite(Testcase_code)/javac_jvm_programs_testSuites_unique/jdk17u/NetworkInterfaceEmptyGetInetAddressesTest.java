...
public class NetworkInterfaceEmptyGetInetAddressesTest {
    ...
    private static void testNetworkInterface_getInterfaceAddresses(NetworkInterface netIf) {
        try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("macst socket address == " + mcastSock.getLocalAddress());
