...
public class MenuItemIconTest {
    ...
    protected static ImageIcon createIcon() {
        BufferedImage bi = new BufferedImage(IMAGE_WIDTH_AND_HEIGHT, IMAGE_WIDTH_AND_HEIGHT, BufferedImage.TYPE_INT_ARGB);
    ...
    private static void executeTest() throws Exception {
        ...
        checkPixeclColor(point.x + IMAGE_WIDTH_AND_HEIGHT / 2, point.y + IMAGE_WIDTH_AND_HEIGHT / 2);
    }
}
