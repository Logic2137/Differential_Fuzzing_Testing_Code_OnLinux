...
public class NonFocusablePopupMenuTest extends Applet {
    ...
    public void init() {
        ...
        String[] instructions = { "1) The applet contains a non-focusable choice, ", "2) Click on the choice by mouse, try to change the selection of the choice, ", "3) If it's not possible to change the selection and popup menu is always open ", "   even if you click by mouse on any item of the choice, the test failed, ", "4) Otherwise, the test passed. " };
