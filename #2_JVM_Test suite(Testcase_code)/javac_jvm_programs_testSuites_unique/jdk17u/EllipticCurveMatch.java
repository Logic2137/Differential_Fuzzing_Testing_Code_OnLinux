...
public class EllipticCurveMatch {
    ...
    static String primeP256 = "0FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF";

    static String aP256 = "0FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC";

    static String bP256 = "05AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B";

    static String seedP256 = "0C49D360886E704936A6678E1139D26B7819F7E90";

    private static EllipticCurve addSeedToCurve(EllipticCurve curve) {
        Random rand = new Random();
        byte[] seed = new byte[12];
        rand.nextBytes(seed);
        return new EllipticCurve(curve.getField(), curve.getA(), curve.getB(), seed);
    }
    ...
    public static void main(String[] argv) throws Exception {
        ...
        if (!secondCurve.equals(thirdCurve))
            throw new Exception("Seeded curve doesn't equal differently " + "seeded curve");
