...
public class PageDlgPrnButton implements Printable {
    ...
    public static void main(String[] args) {
        String[] instructions = { "For non-windows OS, this test PASSes.", "You must have at least 2 printers available to perform this test.", "This test brings up a native Windows page dialog.", "Click on the Printer... button and change the selected printer. ", "Test passes if the printout comes from the new selected printer." };
        Sysout.createDialog();
