...
public class RacingReleases {
    ...
    public static void test(final boolean fair, final boolean interruptibly) throws Throwable {
    ...
    public static void main(String[] args) throws Throwable {
        for (boolean fair : new boolean[] { true, false }) for (boolean interruptibly : new boolean[] { true, false }) test(fair, interruptibly);
    }
}
