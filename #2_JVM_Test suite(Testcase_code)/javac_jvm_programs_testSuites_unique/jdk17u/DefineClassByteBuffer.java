...
public class DefineClassByteBuffer {
    ...
    public static void main(String[] arg) throws Exception {
        File oldFile = new File(System.getProperty("test.classes", "."), "TestClass.class");
        File newFile = new File(System.getProperty("test.classes", "."), "CLAZZ");
    ...
    public static class DummyClassLoader extends SecureClassLoader {
        ...
        static ByteBuffer readClassFile(String name) {
            try {
                File f = new File(System.getProperty("test.classes", "."), "CLAZZ");
