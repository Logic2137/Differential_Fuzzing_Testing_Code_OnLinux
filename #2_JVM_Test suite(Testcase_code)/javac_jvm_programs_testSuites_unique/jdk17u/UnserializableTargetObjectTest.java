...
public class UnserializableTargetObjectTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ModelMBeanInfo mmbi = new ModelMBeanInfoSupport(Resource.class.getName(), "ModelMBean to test targetObject", new ModelMBeanAttributeInfo[] { countInfo }, null, new ModelMBeanOperationInfo[] { operationInfo, getCountInfo, setCountInfo }, null);
