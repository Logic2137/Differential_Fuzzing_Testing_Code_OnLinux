...
public class TestJCheckBoxMenuItem {
    ...
    private static void createTestUI() {
        ...
        testFrame.setLocation(instructionFrame.getX() + instructionFrame.getWidth(), instructionFrame.getY());
        testFrame.setPreferredSize(new Dimension(instructionFrame.getWidth(), instructionFrame.getHeight()));
        testFrame.pack();
