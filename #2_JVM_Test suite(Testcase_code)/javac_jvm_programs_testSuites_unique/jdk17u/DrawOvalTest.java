...
public class DrawOvalTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] sequence = { -16776961, -16776961, -16776961, -65536, -65536, -65536, -65536, -16776961, -16776961, -16776961 };
        for (int i = 0; i < snapshot.getWidth(); i++) {
            if (snapshot.getRGB(i, 0) != sequence[i] || snapshot.getRGB(i, 9) != sequence[i] || snapshot.getRGB(0, i) != sequence[i] || snapshot.getRGB(9, i) != sequence[i]) {
