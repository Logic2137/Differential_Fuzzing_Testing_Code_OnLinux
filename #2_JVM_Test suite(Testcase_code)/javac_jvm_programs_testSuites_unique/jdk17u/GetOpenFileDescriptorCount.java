...
public class GetOpenFileDescriptorCount {
    ...
    private static UnixOperatingSystemMXBean mbean = (UnixOperatingSystemMXBean) ManagementFactory.getOperatingSystemMXBean();
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (count < MIN_COUNT_FOR_PASS || count > max_count_for_pass) {
            throw new RuntimeException("Open file descriptor count " + "illegal value: " + count + " bytes " + "(MIN = " + MIN_COUNT_FOR_PASS + "; " + "MAX = " + max_count_for_pass + ")");
        }
