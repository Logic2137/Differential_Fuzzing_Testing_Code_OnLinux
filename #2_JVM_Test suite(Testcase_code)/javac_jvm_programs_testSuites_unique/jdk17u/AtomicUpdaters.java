...
public class AtomicUpdaters {
    ...
    static class Config {
        ...
        Config(Class<?> clazz, String field, String access, boolean reflectOk, boolean updaterOk, String desc, TYPE type) {
            this.clazz = clazz;
            this.field = field;
            this.access = access;
    ...
    private static class NoPermissionsPolicy extends Policy {
        ...
        public boolean implies(ProtectionDomain pd, Permission p) {
            return Policy.UNSUPPORTED_EMPTY_COLLECTION.implies(p) || DEFAULT_POLICY.implies(pd, p);
        }
    }
}
