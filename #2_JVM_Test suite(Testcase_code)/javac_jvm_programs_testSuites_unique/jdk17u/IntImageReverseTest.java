...
public class IntImageReverseTest {
    ...
    private static enum ImageType {
        ...
        INT_ARGB(BufferedImage.TYPE_INT_ARGB), INT_ARGB_PRE(BufferedImage.TYPE_INT_ARGB_PRE), INT_RGB(BufferedImage.TYPE_INT_BGR), INT_BGR(BufferedImage.TYPE_INT_BGR);
