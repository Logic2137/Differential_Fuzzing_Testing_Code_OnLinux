...
public class InvalidBitString {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!test(normal, signer, " normal", true) || !test(longer, signer, " longer", false) || !test(shorter, signer, "shorter", false)) {
    ...
    private static boolean test(Certificate target, Certificate signer, String title, boolean expected) throws Exception {
        System.out.print("Checking " + title + ": expected: " + (expected ? "    verified" : "NOT verified"));
        boolean actual;
        try {
