...
public class StringConcatFactoryRepeatedConstants {
    ...
    public static void main(String[] args) throws Throwable {
        CallSite site = StringConcatFactory.makeConcatWithConstants(MethodHandles.lookup(), "foo", MethodType.methodType(String.class), "\u0002\u0002", "foo", "bar");
        ...
        site = StringConcatFactory.makeConcatWithConstants(MethodHandles.lookup(), "foo", MethodType.methodType(String.class), "\u0002\u0002test\u0002\u0002", "foo", 17.0f, 4711L, "bar");
