...
public class Assortment {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String name : names) for (int method : methods) for (byte[] data : datas) for (byte[] extra : extras) for (String comment : comments) entries.add(new Entry(uniquify(name), method, data, toExtra(extra), comment));
