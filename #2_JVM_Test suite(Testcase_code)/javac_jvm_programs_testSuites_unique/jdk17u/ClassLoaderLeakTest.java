...
public class ClassLoaderLeakTest {
    ...
    public static void main(String[] args) {
        ...
        WeakReference<MyClassLoader> ref = new WeakReference<MyClassLoader>(appClassLoader);
    ...
    private static class TestLauncher implements Runnable {
        ...
        public void run() {
            try {
                ...
                Method launch = appMain.getMethod("launch", doneSignal.getClass());
    ...
    private static class MyClassLoader extends URLClassLoader {
        ...
        private static boolean verbose = Boolean.getBoolean("verboseClassLoading");
