...
public class CompatibleConnectors {
    ...
    static Object[][] attachingConnectors() {
        return new Object[][] { { "com.sun.jdi.SocketAttach", "dt_socket", new String[] { "hostname", "Connector.StringArgument", "false" }, new String[] { "port", "Connector.IntegerArgument", "true" } }, { "com.sun.jdi.SharedMemoryAttach", "dt_shmem", new String[] { "name", "Connector.StringArgument", "true" } } };
    }

    static Object[][] listeningConnectors() {
        return new Object[][] { { "com.sun.jdi.SocketListen", "dt_socket", new String[] { "port", "Connector.IntegerArgument", "true" } }, { "com.sun.jdi.SharedMemoryListen", "dt_shmem", new String[] { "name", "Connector.StringArgument", "false" } } };
    }

    static Object[][] launchingConnectors() {
        return new Object[][] { { "com.sun.jdi.CommandLineLaunch", null, new String[] { "home", "Connector.StringArgument", "false" }, new String[] { "options", "Connector.StringArgument", "false" }, new String[] { "main", "Connector.StringArgument", "true" }, new String[] { "suspend", "Connector.BooleanArgument", "false" }, new String[] { "quote", "Connector.StringArgument", "true" }, new String[] { "vmexec", "Connector.StringArgument", "true" } }, { "com.sun.jdi.RawCommandLineLaunch", null, new String[] { "command", "Connector.StringArgument", "true" }, new String[] { "address", "Connector.StringArgument", "true" }, new String[] { "quote", "Connector.StringArgument", "true" } } };
    }
    ...
    static void type_match(String arg_name, String arg_type, Connector.Argument arg) {
        ...
        if (fail) {
            fail(arg_name + " is of type: " + arg.getClass() + ", expected: " + arg_type);
        }
    }
    ...
    static void check(Object[] desc, Connector connector) {
        ...
        if (transport_name != null) {
            ...
            if (!(transport_name.equals(connector.transport().name()))) {
                fail("transport().name() returns: " + connector.transport().name() + ", expected: " + transport_name);
            }
        }
        ...
        while (iter.hasNext()) {
            ...
            if (!found) {
                Connector.Argument connector_arg = (Connector.Argument) dfltArgs.get(arg_name);
                if (connector_arg.mustSpecify()) {
                    ...
                    if (value == null) {
                        fail("New Connector.Argument \"" + connector_arg.name() + "\" added - argument is mandatory");
                    }
                }
            }
        }
    ...
    static void compare(Object[][] prev, List list) {
        ...
        for (int i = 0; i < prev.length; i++) {
            ...
            if (!(os.startsWith("Windows"))) {
                if (name.equals("com.sun.jdi.SharedMemoryAttach") || name.equals("com.sun.jdi.SharedMemoryListen")) {
                    continue;
                }
            }
            System.out.println("");
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!(dflt.equals(expected))) {
            System.err.println("defaultConnector() is: " + dflt + ", expected:" + expected);
            failures++;
        } else {
