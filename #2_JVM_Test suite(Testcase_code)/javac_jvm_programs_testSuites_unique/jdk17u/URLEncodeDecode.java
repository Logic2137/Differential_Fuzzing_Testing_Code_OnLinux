...
public class URLEncodeDecode {
    ...
    static char[] chars = { 'H', 'e', 'l', 'l', 'o', ' ', '+', '%', '-', '_', '.', '!', '~', '*', '\'', '(', ')', '@', '\u00ae', '\u0101', '\u10a0' };
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("The Unicode bytes are: " + getHexBytes(str));
        System.out.println("");
        test("UTF-8", correctEncodedUTF8);
    }

    private static void test(String enc, String correctEncoded) throws Exception {
        String encoded = null;
        String outStr = null;
        if (enc == null) {
        ...
        System.out.println("URLEncode it (" + outStr + ") : " + encoded);
        System.out.println("The Unicode bytes are: " + getHexBytes(encoded));
        if (encoded.equals(correctEncoded))
            System.out.println("The encoding is correct!");
        else {
            throw new Exception("The encoding is incorrect!" + " It should be " + correctEncoded);
        }
        System.out.println("");
        String decoded = null;
        if (enc == null)
        ...
        System.out.println("URLDecode it (" + outStr + ") : " + decoded);
        System.out.println("The Unicode bytes are: " + getHexBytes(decoded));
