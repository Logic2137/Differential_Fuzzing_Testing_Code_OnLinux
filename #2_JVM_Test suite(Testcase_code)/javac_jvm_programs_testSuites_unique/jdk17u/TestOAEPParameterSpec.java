...
public class TestOAEPParameterSpec {
    ...
    private static boolean compareMD(OAEPParameterSpec s1, OAEPParameterSpec s2) {
    ...
    private static boolean compareSpec(OAEPParameterSpec s1, OAEPParameterSpec s2) {
        return (compareMD(s1, s2) && compareMGF(s1, s2) && comparePSource(s1, s2));
    }
