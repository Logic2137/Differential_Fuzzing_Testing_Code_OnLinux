...
public class AlawEncoderSync {
    ...
    static final AudioFormat alawFormat = new AudioFormat(AudioFormat.Encoding.ALAW, 8000f, 8, 2, 2, 8000f, false);
    ...
    static void preparePCMBuffer() {
        pcmBuffer = new byte[STREAM_LENGTH * (int) pcmFormat.getSampleRate() * (pcmFormat.getSampleSizeInBits() / 8) * pcmFormat.getChannels()];
    ...
    static class ConversionThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                AudioInputStream pcmStream = new AudioInputStream(inStream, pcmFormat, AudioSystem.NOT_SPECIFIED);
