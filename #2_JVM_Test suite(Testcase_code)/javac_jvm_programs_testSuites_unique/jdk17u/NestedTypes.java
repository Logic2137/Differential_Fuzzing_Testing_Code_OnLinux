...
class Test1 {
    ...
    @A
    Outer.GInner<Object>.GInner2<String, Integer> g;

    @A
    Outer f1;

    @A
    Outer.@B Inner f2 = f1.new @B Inner();

    @A
    Outer.@B GInner<@C Object> f3 = f1.new @B GInner<@C Object>();

    MyList<@A Outer.@B GInner<@C MyList<@D Object>>.@E GInner2<@F Integer, @G Object>> f4;

    @A
    Outer.@B GInner<@C MyList<@D Object>>.@E GInner2<@F Integer, @G Object> f4top;

    MyList<@A Outer.@B GInner<@C MyList<@D Object @E [] @F []>>.@G GInner2<@H Integer, @I Object> @J [] @K []> f4arr;

    @A
    Outer.@B GInner<@C MyList<@D Object @E [] @F []>>.@G GInner2<@H Integer, @I Object> @J [] @K [] f4arrtop;
...
class Test2 {
    ...
    void m() {
        ...
        Outer f1 = null;
        @A
        Outer.@B Inner f2 = null;
        Outer.@B Static f3 = null;
        @A
        Outer.@C Inner f4 = null;
...
class Test3 {
    ...
    void monster(@A Outer p1, @A Outer.@B Inner p2, Outer.@B Static p3, @A Outer.@Cv("Test") Inner p4, Outer.@B Static p5, Outer.@Cv("Data") Static p6, MyList<Outer.@Cv("Data") Static> p7) {
    }
}
...
class Test4 {
    ...
    void m() {
        @A
        Outer p1 = new @A Outer();
        @A
        Outer.@B Inner p2 = p1.new @B Inner();
        @A
        Outer.@Cv("Test") Inner p4 = p1.new @Cv("Test") Inner();
