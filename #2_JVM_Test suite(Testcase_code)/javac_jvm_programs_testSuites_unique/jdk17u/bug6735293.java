    ...
    public static void main(String[] args) throws Exception {
        ...
        SwingUtilities.invokeAndWait(new Runnable() {
            ...
            public void run() {
                ...
                for (int direction : new int[] { SwingConstants.EAST, SwingConstants.WEST, SwingConstants.SOUTH, SwingConstants.NORTH }) {
                    for (int position : new int[] { -100, Integer.MIN_VALUE }) {
                        for (Position.Bias bias : new Position.Bias[] { Position.Bias.Backward, Position.Bias.Forward }) {
                            try {
                                ...
                                throw new RuntimeException("BadLocationException was not thrown: position = " + position + ", bias = " + bias + ", direction = " + direction);
