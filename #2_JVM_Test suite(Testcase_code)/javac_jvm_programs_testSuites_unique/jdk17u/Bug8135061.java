...
public class Bug8135061 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (match != null) {
                throw new RuntimeException("Locale.lookup returned non-null: " + match);
            }
        } catch (Exception ex) {
            throw new RuntimeException("[Locale.lookup failed on language" + " range: " + ranges + " and language tags " + locales + "]", ex);
        }
        ...
        try {
            ...
            if (!match.toLanguageTag().equals("nv")) {
                throw new RuntimeException("Locale.lookup returned unexpected" + " result: " + match);
            }
        } catch (Exception ex) {
            throw new RuntimeException("[Locale.lookup failed on language" + " range: " + ranges + " and language tags " + locales + "]", ex);
        }
