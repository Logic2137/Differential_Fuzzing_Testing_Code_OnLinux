...
public class EncodeSubImageTest {
    ...
    private void verify(File f, boolean isSubsampled) {
        ...
        try {
            ...
            throw new RuntimeException("Test FAILED: can't readin test image " + f.getAbsolutePath(), e);
        }
        if (dst == null) {
    ...
    private void checkPixel(BufferedImage dst, int x, int y, boolean isSubsampled) {
