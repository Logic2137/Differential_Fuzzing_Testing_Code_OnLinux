...
public class TestCipherPBE {
    ...
    private static final String[] ALGORITHMS = { "PBEWithMD5AndDES", "PBEWithMD5AndDES/CBC/PKCS5Padding", "PBEWithMD5AndTripleDES", "PBEWithMD5AndTripleDES/CBC/PKCS5Padding" };
    ...
    private void runTest(String algorithm) throws InvalidKeySpecException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, ShortBufferException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException {
        ...
        boolean isUnlimited = (Cipher.getMaxAllowedKeyLength(algorithm) == Integer.MAX_VALUE);
        try {
