...
public class SmartLoginModule implements LoginModule {
    ...
    public SmartLoginModule() {
        this("testUser", new char[] { 't', 'e', 's', 't', 'P', 'a', 's', 's', 'w', 'o', 'r', 'd', '1' }, "SmartLoginModule1: ");
    }
    ...
    public boolean login() throws LoginException {
        ...
        try {
            ...
            throw new LoginException("Error: " + header + uce.getCallback().toString() + " not available to garner authentication information " + "from the user");
        }
        if (username.equals(myUsername) && Arrays.equals(password, myPassword)) {
