...
public class DefaultRowSorterIOOBEtest extends TableRowSorter<TableModel> {
    ...
    public static void main(String[] args) {
        DefaultRowSorter<TableModel, Integer> sorter = new DefaultRowSorter<>() {
    ...
    static class SorterModelWrapper extends DefaultRowSorter.ModelWrapper<TableModel, Integer> {
