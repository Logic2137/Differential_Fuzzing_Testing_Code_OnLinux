...
public class OldenCompilingWithDefaults {
    ...
    public static void main(String... args) throws Exception {
        ...
        if (clazz.isAnnotationPresent(SuppressWarnings.class) || pkg.isAnnotationPresent(SuppressWarnings.class) || ctor.isAnnotationPresent(SuppressWarnings.class) || m.isAnnotationPresent(SuppressWarnings.class) || f.isAnnotationPresent(SuppressWarnings.class))
