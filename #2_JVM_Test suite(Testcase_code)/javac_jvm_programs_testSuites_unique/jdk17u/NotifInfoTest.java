...
public class NotifInfoTest {
    ...
    public static void main(String[] args) throws Exception {
        final MBeanNotificationInfo info1 = new MBeanNotificationInfo(new String[] { "t11", "t12" }, "n1", null);
        final MBeanNotificationInfo info2 = new MBeanNotificationInfo(new String[] { "t21", "t22" }, "n2", null);
        final MBeanNotificationInfo[] mninfo1 = new MBeanNotificationInfo[] { info1, info2 };
        ...
        if (!Arrays.deepEquals(mninfo2, support1.getNotificationInfo()) || !Arrays.deepEquals(mninfo2, support2.getNotificationInfo())) {
