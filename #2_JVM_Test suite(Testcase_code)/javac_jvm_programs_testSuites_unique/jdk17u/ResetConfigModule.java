...
public class ResetConfigModule {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            Thread.currentThread().setContextClassLoader(ResetConfigModule.class.getClassLoader());
            ...
            try {
                ...
                if (le.getCause() != null && le.getCause() instanceof SecurityException) {
...
class MyConfig extends Configuration {
    ...
    private AppConfigurationEntry[] entries = { new AppConfigurationEntry("ResetModule", AppConfigurationEntry.LoginModuleControlFlag.REQUIRED, new HashMap()) };
