...
public class DefaultEntryType {
    ...
    private static class X509Cert extends X509Certificate {
        ...
        public void checkValidity(java.util.Date date) throws CertificateExpiredException, CertificateNotYetValidException {
        }
    ...
    private static void testPrivateKeyEntry() throws Exception {
        ...
        try {
            KeyStore.PrivateKeyEntry pke = new KeyStore.PrivateKeyEntry(new PrivKey1(), null);
        ...
        try {
            Certificate[] chain = new Certificate[0];
            KeyStore.PrivateKeyEntry pke = new KeyStore.PrivateKeyEntry(new PrivKey1(), chain);
        ...
        KeyStore.PrivateKeyEntry pke = new KeyStore.PrivateKeyEntry(pkey, chain);
