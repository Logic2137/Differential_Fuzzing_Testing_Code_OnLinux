...
public class ExportableBlockCipher {
    ...
    void doServerSide() throws Exception {
        ...
        if (!interrupted) {
            throw new SSLHandshakeException("A weak cipher suite is negotiated, " + "TLSv1.1 must not negotiate the exportable cipher suites.");
        }
    }
    ...
    void doClientSide() throws Exception {
        ...
        sslSocket.setEnabledCipherSuites(new String[] { "SSL_RSA_EXPORT_WITH_DES40_CBC_SHA" });
        InputStream sslIS = sslSocket.getInputStream();
        OutputStream sslOS = sslSocket.getOutputStream();
        boolean interrupted = false;
        try {
