...
public class EqualsTests {
    ...
    public static void main(String[] argv) {
        ...
        if (failures > 0) {
            throw new RuntimeException("Inccured " + failures + " failures while testing equals.");
        }
    }
