...
public class ITXtTest {
    ...
    public boolean equals(Object o) {
        ...
        if (isCompressed != t.isCompressed) {
            return false;
        }
        ...
        if (!trasKeyword.equals(t.trasKeyword)) {
            return false;
        }
    ...
    private static void writeTo(File f, ITXtTest t) {
        ...
        try (ImageOutputStream imageOutputStream = ImageIO.createImageOutputStream(f)) {
    ...
    private static BufferedImage createBufferedImage() {
        BufferedImage image = new BufferedImage(128, 128, BufferedImage.TYPE_4BYTE_ABGR_PRE);
