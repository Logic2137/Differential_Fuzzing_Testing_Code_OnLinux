...
public class MetaMessageClone {
    ...
    public static void main(String[] args) throws Exception {
        ...
        msg.setMessage(0x02, data, 80);
        checkClone(msg);
        msg.setMessage(0x02, data, 160);
        checkClone(msg);
        msg.setMessage(0x02, data, 400);
        checkClone(msg);
        msg.setMessage(0x02, data, 1000);
        checkClone(msg);
        msg.setMessage(0x02, data, 10000);
        checkClone(msg);
        msg.setMessage(0x02, data, 17000);
        checkClone(msg);
    }
}
