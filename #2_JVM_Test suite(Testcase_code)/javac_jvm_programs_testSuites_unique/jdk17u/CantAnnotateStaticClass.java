...
class Top {
    ...
    @TA
    Top.@TB5 Outer.Inner f2a;

    @TA
    Top.Outer.@TC Inner f2b;

    @TA
    Top.@TB6 Outer.@TC Inner f2c;
    ...
    void f1param(@TB41 Outer p, @TB10 Outer.Inner p1, Outer.@TC Inner p2, @TB11 Outer.@TC Inner p3) {
    }
    ...
    List<@TB23 Outer.@TC Inner> g1rc() {
        return null;
    }

    void g1param(List<@TB24 Outer> p, List<@TB25 Outer.Inner> p1, List<Outer.@TC Inner> p2, List<@TB26 Outer.@TC Inner> p3) {
    }
