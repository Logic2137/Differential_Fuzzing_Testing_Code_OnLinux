...
public class MarshalledObjectGet implements Remote, Unreferenced {
    ...
    public static void main(String[] args) {
        ...
        System.setProperty("sun.rmi.dgc.client.gcInterval", String.valueOf(GC_INTERVAL));
        ...
        try {
            ...
            synchronized (obj.lock) {
                ...
                System.err.println("waiting for unreferenced() callback " + "(SHOULD happen)...");
                obj.lock.wait(TIMEOUT);
                if (obj.unreferencedInvoked) {
                } else {
                    throw new RuntimeException("TEST FAILED: unrefereced() not invoked after " + ((double) TIMEOUT / 1000.0) + " seconds");
                }
            }
