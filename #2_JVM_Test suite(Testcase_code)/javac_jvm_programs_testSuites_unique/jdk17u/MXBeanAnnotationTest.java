...
public class MXBeanAnnotationTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            boolean ok = checkMXBean(mbs.getMBeanInfo(on), true, "empty MXBean interface");
        ...
        try {
            ...
            System.out.println("OK: non-Standard MBean with @MXBean(false) " + "rejected");
        }
        if (failure == null)
    ...
    private static boolean checkMXBean(MBeanInfo mbi, boolean expected, String what) {
