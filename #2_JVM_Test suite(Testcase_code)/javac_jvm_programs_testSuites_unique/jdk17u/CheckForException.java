...
public class CheckForException {
    ...
    public static void main(String[] argv) {
        ...
        try {
            ...
            if (we == null) {
                System.err.println("\nTEST FAILED: Write of NoPickleClass " + "should have raised an exception");
                throw new Error();
            }
            p.flush();
            ostream.close();
            ...
            if (re == null) {
                System.err.println("\nTEST FAILED: Read of NoPickleClass " + "should have raised an exception");
                throw new Error();
            }
            istream.close();
            System.err.println("\nTEST PASSED");
...
class NoPickleClass extends PickleClass {
    ...
    private void writeObject(ObjectOutputStream pw) throws NotSerializableException {
        throw new NotSerializableException("NoPickleClass");
    }

    private void readObject(ObjectInputStream pr) throws NotSerializableException {
        throw new NotSerializableException("NoPickleClass");
    }
}
