...
public class EnumSetBash {
    ...
    static <T extends Enum<T>> void bash(Class<T> enumClass) {
        ...
        for (int i = 0; i < numItr; i++) {
            ...
            EnumSet<T> diff1 = clone(s1, enumClass);
            diff1.removeAll(s2);
            EnumSet<T> diff2 = clone(s2, enumClass);
            diff2.removeAll(s1);
            EnumSet<T> union = clone(s1, enumClass);
            union.addAll(s2);
        ...
        switch(method) {
            ...
            case 4:
                if (s.isEmpty())
                    ...
                    clone = EnumSet.copyOf((Collection<E>) (Collection) Arrays.asList(s.toArray()));
                break;
            case 5:
