...
public class StreamFlush {
    ...
    private static void test(File temp1, ImageOutputStream fios, File temp2, FileOutputStream fos2) throws IOException {
        ...
        if (file1NoFlushLength != file1FlushLength) {
            System.out.println("FileImageOutputStream not flushed!");
        }
        if (file2NoFlushLength != file2FlushLength) {
            System.out.println("FileCacheImageOutputStream/BufferedOutputStream not flushed!");
        }
        if (cacheNoFlushLength != cacheFlushLength) {
            System.out.println("FileCacheImageOutputStream/ByteArrayOutputStream not flushed!");
        }
    }
}
