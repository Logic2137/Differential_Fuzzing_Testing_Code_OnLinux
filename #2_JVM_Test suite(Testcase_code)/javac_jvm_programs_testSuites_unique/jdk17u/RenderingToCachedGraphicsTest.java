...
public class RenderingToCachedGraphicsTest extends Frame {
    ...
    public static void main(String[] args) {
        int depth = GraphicsEnvironment.getLocalGraphicsEnvironment().getDefaultScreenDevice().getDefaultConfiguration().getColorModel().getPixelSize();
        if (depth < 16) {
        ...
        t1.dispose();
        if (failed) {
            throw new RuntimeException("Failed: rendering didn't show up");
        }
