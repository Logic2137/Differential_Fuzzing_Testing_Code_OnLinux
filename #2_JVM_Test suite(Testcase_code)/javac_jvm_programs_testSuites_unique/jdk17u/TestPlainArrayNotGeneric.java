...
public class TestPlainArrayNotGeneric {
    ...
    public String[] m1(List<String> p1) {
        return null;
    }

    public List<String> m2(String[] p1) {
        return null;
    }
    ...
    public <T extends List<String[]>> T m5(T p1) {
        return null;
    }

    public <T extends Object> T[] m6(T[] p1, List<T[]> p2) {
        return null;
    }

    public List<? extends Object[]> m6(List<? extends Object[]> p1) {
        return null;
    }

    public <T extends List<? extends Object[]>> T m7(T[] p1) {
        return null;
    }

    public List<? super Object[]> m8(List<? super Object[]> p1) {
        return null;
    }

    public <T extends List<? super Object[]>> T[] m9(T[] p1) {
        return null;
    }
    ...
    public static interface YMap<K extends List<String[]>, V> extends Map<K[], V[]> {
    }
