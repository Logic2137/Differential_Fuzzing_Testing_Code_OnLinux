...
public class Test6860438 {
    ...
    void check(Object key, Object value, boolean present, int size) {
        ...
        checkEnumeration(UIManager.getDefaults().keys(), key, present, "MultiUIDefaults.keys()");
        checkEnumeration(UIManager.getDefaults().elements(), value, present, "MultiUIDefaults.elements()");
        boolean found = false;
    ...
    void checkEnumeration(Enumeration<Object> e, Object elem, boolean present, String error) {
        boolean found = false;
