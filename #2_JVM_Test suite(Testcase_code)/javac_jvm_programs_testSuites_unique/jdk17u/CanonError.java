...
public class CanonError {
    ...
    public static void main(String[] args) {
        PrivateCredentialPermission pcp1 = new PrivateCredentialPermission("a b \"pcp1\"", "read");
        PrivateCredentialPermission pcp2 = new PrivateCredentialPermission("a b \"pcp1\"", "read");
        ...
        PrivateCredentialPermission pcp3 = new PrivateCredentialPermission("a b \"pcp3\"", "read");
        ...
        PrivateCredentialPermission pcp_4 = new PrivateCredentialPermission("a b \"pcp 4\"", "read");
        PrivateCredentialPermission pcp__4 = new PrivateCredentialPermission("a b \"pcp  4\"", "read");
        ...
        for (int i = 0; i < principals.length; i++) {
            for (int j = 0; j < 2; j++) {
                System.out.println("principals[" + i + "][" + j + "] = " + principals[i][j]);
            }
        }
