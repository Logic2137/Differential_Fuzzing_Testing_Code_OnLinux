...
public class DeserializedLength {
    ...
    static boolean testDeserializedLength(int elements, float loadFactor) throws Exception {
        ...
        System.out.printf("%7d %5.2f %7d %7d %7d...%7d %s\n", ht1.size(), loadFactor, table1.length, table2.length, minLength, maxLength, (ok ? "OK" : "NOT-OK"));
        return ok;
    }
    ...
    static <T> T serialClone(T o) throws IOException, ClassNotFoundException {
        ...
        T clone = (T) new ObjectInputStream(new ByteArrayInputStream(bos.toByteArray())).readObject();
        return clone;
    }
