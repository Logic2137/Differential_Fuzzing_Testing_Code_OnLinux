    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            if (!testPassed && testGeneratedInterrupt) {
                throw new RuntimeException("" + "Label HTML text does not support translucent text colors");
            }
        }
