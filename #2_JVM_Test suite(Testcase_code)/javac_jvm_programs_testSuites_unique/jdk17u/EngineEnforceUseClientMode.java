...
public class EngineEnforceUseClientMode {
    ...
    private void runTest() throws Exception {
        ...
        try {
            ...
            throw new RuntimeException("wrap():  Didn't catch the exception properly");
        ...
        try {
            ...
            throw new RuntimeException("unwrap():  Didn't catch the exception properly");
        } catch (IllegalStateException e) {
            System.out.println("Caught the correct exception.");
            appIn1.flip();
            ...
            if (!dataDone && (appOut1.limit() == appIn2.position()) && (appOut2.limit() == appIn1.position())) {
                ...
                for (boolean b : new Boolean[] { true, false }) {
                    try {
                        ...
                        throw new RuntimeException("setUseClientMode(" + b + "):  " + "Didn't catch the exception properly");
