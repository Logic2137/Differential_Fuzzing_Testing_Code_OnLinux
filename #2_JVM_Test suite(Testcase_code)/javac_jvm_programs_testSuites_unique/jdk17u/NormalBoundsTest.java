    ...
    public static void executeTest(Robot robot) throws Exception {
        ...
        SwingUtilities.invokeAndWait(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mainFrame.dispose();
                    throw new RuntimeException("Deiconize InternalFrame" + " Failed");
                }
            }
        });
        robot.waitForIdle();
        SwingUtilities.invokeAndWait(new Runnable() {
            ...
            public void run() {
                ...
                drag(robot, new Point((int) loc.x + 80, (int) loc.y + 12), new Point((int) loc.x + 100, (int) loc.y + 40), InputEvent.BUTTON1_MASK);
            }
        });
        robot.waitForIdle();
        SwingUtilities.invokeAndWait(new Runnable() {
        ...
        SwingUtilities.invokeAndWait(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mainFrame.dispose();
                    throw new RuntimeException("DeIcoize InternalFrame " + " Failed");
                }
            }
        });
        robot.waitForIdle();
        SwingUtilities.invokeAndWait(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mainFrame.dispose();
                    throw new RuntimeException("Restore InternalFrame " + " Failed");
                }
            }
        });
        robot.waitForIdle();
