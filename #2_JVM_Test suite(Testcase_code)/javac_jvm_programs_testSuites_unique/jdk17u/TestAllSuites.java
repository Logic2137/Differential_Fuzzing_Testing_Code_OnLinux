...
public class TestAllSuites {
    ...
    String[][] protocols = new String[][] { { "SSLv3" }, { "TLSv1" }, { "SSLv3", "SSLv2Hello" }, { "TLSv1", "SSLv2Hello" } };
    ...
    private static void checkResult(SSLEngineResult result) throws Exception {
        if ((result.getStatus() != Status.CLOSED) || (result.getHandshakeStatus() != HandshakeStatus.NOT_HANDSHAKING) || (result.bytesConsumed() != 0) || (result.bytesProduced() != 0)) {
