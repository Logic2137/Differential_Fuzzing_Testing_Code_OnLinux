...
public class NetworkChannelTests {
    ...
    static void localAddressTests(ChannelFactory factory) throws IOException {
        ...
        InetSocketAddress local = (InetSocketAddress) (ch.bind(new InetSocketAddress(0)).getLocalAddress());
    ...
    public static void main(String[] args) throws IOException {
        ...
        bindTests(factory);
        localAddressTests(factory);
        ServerSocketChannel.open().bind(new InetSocketAddress(0), 100).close();
        ServerSocketChannel.open().bind(new InetSocketAddress(0), 0).close();
        ServerSocketChannel.open().bind(new InetSocketAddress(0), -1).close();
        factory = new ChannelFactory() {
