...
public class PBMacBuffer {
    ...
    public static void main(String[] args) {
        String[] PBMAC1Algorithms = { "HmacPBESHA1", "PBEWithHmacSHA1", "PBEWithHmacSHA224", "PBEWithHmacSHA256", "PBEWithHmacSHA384", "PBEWithHmacSHA512" };
        String[] PBKDF2Algorithms = { "PBKDF2WithHmacSHA1", "PBKDF2WithHmacSHA224", "PBKDF2WithHmacSHA256", "PBKDF2WithHmacSHA384", "PBKDF2WithHmacSHA512" };
        ...
        for (String thePBMacAlgo : PBMAC1Algorithms) {
            for (String thePBKDF2Algo : PBKDF2Algorithms) {
                System.out.println("Running test with " + thePBMacAlgo + " and " + thePBKDF2Algo + ":");
                try {
    ...
    protected boolean doTest(String theMacAlgo, String thePBKDF2Algo) throws NoSuchAlgorithmException, InvalidKeyException, InvalidKeySpecException {
    ...
    protected boolean largeByteBufferTest(Mac theMac) {
        ...
        if (positonAfter != limitAfter) {
            System.out.println("FAIL: " + "Buffer's position isn't equal to its limit");
            return false;
        }
        return true;
    }
    ...
    protected boolean nullByteBufferTest(Mac theMac) {
        ...
        System.out.println("FAIL: " + "IllegalArgumentException hasn't been thrown as expected");
        return false;
    }
