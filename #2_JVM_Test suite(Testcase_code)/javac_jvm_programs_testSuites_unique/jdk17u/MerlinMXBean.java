...
public interface MerlinMXBean {
    ...
    CompositeType GetSetType = CompositeTypeMaker.make(GetSetBean.class.getName(), GetSetBean.class.getName(), new String[] { "int", "string", "stringArray" }, new String[] { "int", "string", "stringArray" }, new OpenType[] { SimpleType.INTEGER, SimpleType.STRING, ArrayTypeMaker.make(1, SimpleType.STRING) });
    ...
    GetterInterface Interface = new GetterInterface() {
        ...
        public boolean equals(Object o) {
            ...
            return isWhatsit() == i.isWhatsit() && Arrays.equals(getInts(), i.getInts()) && Arrays.equals(getStrings(), i.getStrings()) && getGetSet().equals(i.getGetSet());
        }
    };

    CompositeType InterfaceType = CompositeTypeMaker.make(GetterInterface.class.getName(), GetterInterface.class.getName(), new String[] { "ints", "getSet", "strings", "whatsit" }, new String[] { "ints", "getSet", "strings", "whatsit" }, new OpenType[] { ArrayTypeMaker.make(SimpleType.INTEGER, true), GetSetType, ArrayTypeMaker.make(1, SimpleType.STRING), SimpleType.BOOLEAN });
    ...
    public static class GetSetBean {
        ...
        public static GetSetBean make(int Int, String string, String[] stringArray) {
        ...
        public boolean equals(Object o) {
            ...
            return (b.Int == Int && b.string.equals(string) && Arrays.equals(b.stringArray, stringArray));
        }
    ...
    public static class CompositeTypeMaker {
        ...
        static CompositeType make(String className, String description, String[] itemNames, String[] itemDescriptions, OpenType[] itemTypes) {
            try {
                return new CompositeType(className, description, itemNames, itemDescriptions, itemTypes);
            } catch (OpenDataException e) {
                throw new Error(e);
            }
        }
    ...
    public static class Graph implements GraphMXBean {
        ...
        public Graph(Node... nodes) {
            for (Node node : nodes) node.setGraph(this);
            this.nodes = nodes;
        }
    ...
    public static class ExoticCompositeData implements CompositeDataView {
        ...
        public CompositeData toCompositeData(CompositeType ct) {
            try {
                return new CompositeDataSupport(ct, new String[] { "whatsit" }, new String[] { "!" + whatsit });
            } catch (Exception e) {
        ...
        public boolean equals(Object o) {
            return ((o instanceof ExoticCompositeData) && ((ExoticCompositeData) o).whatsit.equals(whatsit));
        }
        ...
        static {
            try {
                type = new CompositeType(ExoticCompositeData.class.getName(), ExoticCompositeData.class.getName(), new String[] { "whatsit" }, new String[] { "whatsit" }, new OpenType[] { SimpleType.STRING });
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
        }
    ...
    ExoticCompositeData opExotic(ExoticCompositeData ecd1, ExoticCompositeData ecd2);
