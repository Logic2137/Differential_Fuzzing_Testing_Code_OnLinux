...
public class MBeanExceptionTest {
    ...
    public static class DynamicExcept implements DynamicMBean {
        ...
        public Object getAttribute(String attrName) throws MBeanException {
        ...
        public void setAttribute(Attribute attr) throws MBeanException {
        ...
        public Object invoke(String opName, Object[] params, String[] sig) throws MBeanException {
        ...
        public MBeanInfo getMBeanInfo() {
            try {
                return new StandardMBean(new Except(), ExceptMBean.class).getMBeanInfo();
            } catch (Exception e) {
                assert false;
                return null;
            }
    ...
    private static final Exception theCheckedException = new Exception("The checked exception that should be seen");

    private static final RuntimeException theUncheckedException = new UnsupportedOperationException("The unchecked exception " + "that should be seen");
}
