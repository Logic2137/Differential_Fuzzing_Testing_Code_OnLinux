    ...
    public MultimonFullscreenTest(String title) {
        ...
        for (GraphicsDevice dev : gd) {
            ...
            if (dev == defDev) {
                ...
                System.out.println("Primary Dev : " + dev + " Bounds: " + dev.getDefaultConfiguration().getBounds());
            } else {
                b = new Button("Secondary screen " + num);
                System.out.println("Secondary Dev : " + dev + " Bounds: " + dev.getDefaultConfiguration().getBounds());
            }
    ...
    public static void main(String[] args) {
        for (String s : args) {
            if (s.equalsIgnoreCase("-dm")) {
                ...
                System.err.println("Usage: MultimonFullscreenTest " + "[-dm][-usewindow][-setnull]");
            }
        }
        MultimonFullscreenTest fs = new MultimonFullscreenTest("Test Full Screen");
    }
