...
public class IndexColorModelEqualsTest {
    ...
    private static void verifyEquals(IndexColorModel m1, IndexColorModel m2) {
        if (m1.equals(null)) {
    ...
    private static void testConstructor1() {
        IndexColorModel model1 = new IndexColorModel(8, 2, new byte[] { 1, 2 }, new byte[] { 1, 2 }, new byte[] { 1, 2 });
        IndexColorModel model2 = new IndexColorModel(8, 2, new byte[] { 1, 2 }, new byte[] { 1, 2 }, new byte[] { 1, 2 });
        verifyEquals(model1, model2);
    }

    private static void testConstructor2() {
        IndexColorModel model1 = new IndexColorModel(8, 2, new byte[] { 1, 2 }, new byte[] { 1, 2 }, new byte[] { 1, 2 }, new byte[] { 1, 2 });
        IndexColorModel model2 = new IndexColorModel(8, 2, new byte[] { 1, 2 }, new byte[] { 1, 2 }, new byte[] { 1, 2 }, new byte[] { 1, 2 });
        verifyEquals(model1, model2);
    }

    private static void testConstructor3() {
        IndexColorModel model1 = new IndexColorModel(8, 2, new byte[] { 1, 2 }, new byte[] { 1, 2 }, new byte[] { 1, 2 }, 1);
        IndexColorModel model2 = new IndexColorModel(8, 2, new byte[] { 1, 2 }, new byte[] { 1, 2 }, new byte[] { 1, 2 }, 1);
        verifyEquals(model1, model2);
    }

    private static void testConstructor4() {
        IndexColorModel model1 = new IndexColorModel(8, 1, new byte[] { 1, 2, 3, 4 }, 0, true);
        IndexColorModel model2 = new IndexColorModel(8, 1, new byte[] { 1, 2, 3, 4 }, 0, true);
        verifyEquals(model1, model2);
    }

    private static void testConstructor5() {
        IndexColorModel model1 = new IndexColorModel(8, 1, new byte[] { 1, 2, 3, 4 }, 0, true, 0);
        IndexColorModel model2 = new IndexColorModel(8, 1, new byte[] { 1, 2, 3, 4 }, 0, true, 0);
        verifyEquals(model1, model2);
    }
