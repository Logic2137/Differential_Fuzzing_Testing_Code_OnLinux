...
public class DescriptorSupportTest {
    ...
    private static final Object[] goodFields = { "value", "", "severity", "0", "severity", "6" };

    private static final Object[] badFields = { "name", null, "name", "", "descriptorType", null, "descriptorType", "", "setMethod", null, "getMethod", null, "role", null, "class", null, "visibility", null, "visibility", new Integer(0), "visibility", "0", "visibility", new Integer(5), "visibility", "5", "severity", null, "severity", new Integer(-1), "severity", "-1", "severity", new Integer(7), "severity", "7", "persistPolicy", null, "persistPolicy", "bogusPersistPolicy", "persistPeriod", null, "persistPeriod", "not a number", "currencyTimeLimit", null, "currencyTimeLimit", "not a number", "lastUpdatedTimeStamp", null, "lastUpdatedTimeStamp", "not a number", "lastReturnedTimeStamp", null, "lastReturnedTimeStamp", "not a number", "log", null, "log", "not T or F or true or false", "log", new Object[0] };
