        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    throw new RuntimeException("Exception while" + " validating ScreenCapture");
                }
            }
        });
...
class TestUI {
    ...
    public void validateScreenCapture() throws AWTException {
        ...
        MultiResolutionImage image = robot.createMultiResolutionScreenCapture(inputImageFrame.getBounds());
        ...
        JLabel labelImg1 = new JLabel("LEFT:Width: " + width + " Height: " + height);
        ogbc.gridx = 0;
        ogbc.gridy = 1;
        ...
        JLabel labelImg2 = new JLabel("RIGHT:Width: " + width + " Height: " + height);
        ogbc.gridx = 1;
        ogbc.gridy = 1;
