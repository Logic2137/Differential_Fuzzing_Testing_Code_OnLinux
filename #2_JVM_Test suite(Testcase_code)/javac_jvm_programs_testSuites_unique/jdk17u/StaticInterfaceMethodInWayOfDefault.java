...
public class StaticInterfaceMethodInWayOfDefault {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ClassLoader v2Loader = new V2ClassLoader(StaticInterfaceMethodInWayOfDefault.class.getClassLoader());
        Callable<String> v2Task = (Callable<String>) Class.forName(TestTask.class.getName(), true, v2Loader).newInstance();
