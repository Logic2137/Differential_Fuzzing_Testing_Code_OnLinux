...
public class PaddingTest {
    ...
    public static byte[] key = { (byte) 0x01, (byte) 0x23, (byte) 0x45, (byte) 0x67, (byte) 0x89, (byte) 0xab, (byte) 0xcd, (byte) 0xef };

    public static byte[] key3 = { (byte) 0x01, (byte) 0x23, (byte) 0x45, (byte) 0x67, (byte) 0x89, (byte) 0xab, (byte) 0xcd, (byte) 0xef, (byte) 0xf0, (byte) 0xe1, (byte) 0xd2, (byte) 0xc3, (byte) 0xb4, (byte) 0xa5, (byte) 0x96, (byte) 0x87, (byte) 0xfe, (byte) 0xdc, (byte) 0xba, (byte) 0x98, (byte) 0x76, (byte) 0x54, (byte) 0x32, (byte) 0x10 };

    public static byte[] iv = { (byte) 0xfe, (byte) 0xdc, (byte) 0xba, (byte) 0x98, (byte) 0x76, (byte) 0x54, (byte) 0x32, (byte) 0x10 };
            ...
            for (int i = 0; i < crypts.length; i++) {
                for (int j = 0; j < modes.length; j++) {
                    for (int k = 0; k < paddings.length; k++) {
                        System.out.println("===============================");
                        System.out.println(crypts[i] + " " + modes[j] + " " + paddings[k] + " " + "plain" + l + " test");
                        cfile = "c" + l + "_" + crypts[i] + "_" + modes[j] + "_" + paddings[k] + ".bin";
                        poutfile = "p" + l + "_" + crypts[i] + modes[j] + paddings[k] + ".txt";
    ...
    private static void diff(String fname1, String fname2) throws Exception {
        if (!Arrays.equals(Files.readAllBytes(Paths.get(fname1)), Files.readAllBytes(Paths.get(fname2)))) {
            throw new Exception("files " + fname1 + " and " + fname2 + " differ");
        }
    }
}
