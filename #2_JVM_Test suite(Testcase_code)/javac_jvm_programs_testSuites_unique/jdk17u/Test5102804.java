...
public class Test5102804 {
    ...
    private static final class Loader extends URLClassLoader {
        ...
        Loader() {
            super(new URL[] { Test5102804.class.getProtectionDomain().getCodeSource().getLocation() });
        }
    ...
    public static final class ExampleBeanInfo extends SimpleBeanInfo {
        ...
        public PropertyDescriptor[] getPropertyDescriptors() {
            try {
                return new PropertyDescriptor[] { new PropertyDescriptor("value", Class.forName(BEAN_NAME)) };
            } catch (ClassNotFoundException exception) {
                return null;
            } catch (IntrospectionException exception) {
                return null;
