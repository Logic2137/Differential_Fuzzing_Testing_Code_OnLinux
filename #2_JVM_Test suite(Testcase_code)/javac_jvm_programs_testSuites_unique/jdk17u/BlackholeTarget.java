...
public class BlackholeTarget {
    ...
    public static void bh_s_boolean_1_delegate(boolean v) {
        bh_s_boolean_1(v);
    }

    public static void bh_s_byte_1_delegate(byte v) {
        bh_s_byte_1(v);
    }

    public static void bh_s_short_1_delegate(short v) {
        bh_s_short_1(v);
    }

    public static void bh_s_char_1_delegate(char v) {
        bh_s_char_1(v);
    }

    public static void bh_s_int_1_delegate(int v) {
        bh_s_int_1(v);
    }

    public static void bh_s_float_1_delegate(float v) {
        bh_s_float_1(v);
    }

    public static void bh_s_long_1_delegate(long v) {
        bh_s_long_1(v);
    }

    public static void bh_s_double_1_delegate(double v) {
        bh_s_double_1(v);
    }

    public static void bh_s_Object_1_delegate(Object v) {
        bh_s_Object_1(v);
    }
    ...
    public static boolean bh_sr_boolean(boolean v) {
        return false;
    }

    public static byte bh_sr_byte(byte v) {
        return 0;
    }

    public static short bh_sr_short(short v) {
        return 0;
    }

    public static char bh_sr_char(char v) {
        return 0;
    }

    public static int bh_sr_int(int v) {
        return 0;
    }

    public static float bh_sr_float(float v) {
        return 0;
    }

    public static long bh_sr_long(long v) {
        return 0;
    }

    public static double bh_sr_double(double v) {
        return 0;
    }

    public static Object bh_sr_Object(Object v) {
        return null;
    }
}
