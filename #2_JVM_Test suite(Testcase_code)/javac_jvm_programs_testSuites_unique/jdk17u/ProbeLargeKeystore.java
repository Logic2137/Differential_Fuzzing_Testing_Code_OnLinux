...
public class ProbeLargeKeystore {
    ...
    public static final void main(String[] args) throws Exception {
        ...
        KeyStore largeKeystore = KeyStore.getInstance(new File(KEYSTORE), PASSWORD);
    ...
    private static final Certificate loadCertificate(String certFile) throws Exception {
