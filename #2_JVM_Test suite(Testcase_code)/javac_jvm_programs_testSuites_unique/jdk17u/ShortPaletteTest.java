...
public class ShortPaletteTest {
    ...
    private static IndexColorModel createColorModel(int numberColors) {
        ...
        int depth = 4;
        int startIndex = 0;
        return new IndexColorModel(depth, numberColors, colors, startIndex, false);
    }

    private static BufferedImage createImage(int numberColors) {
        return new BufferedImage(32, 32, BufferedImage.TYPE_BYTE_BINARY, createColorModel(numberColors));
    }
}
