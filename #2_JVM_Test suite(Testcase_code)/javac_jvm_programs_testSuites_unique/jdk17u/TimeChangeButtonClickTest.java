    ...
    public final void createUI() throws Exception {
        ...
        testButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                buttonPressCount++;
                buttonPressCountLabel.setText("Button Press Count : " + buttonPressCount);
            }
        });
        gbc.gridx = 0;
        gbc.gridy = 0;
        ...
        gbc.gridx = 0;
        gbc.gridy = 2;
        buttonPressCountLabel = new JLabel("Button Press Count : " + buttonPressCount);
