public class ResInNestedExpr {
    ...
    static void checkClosedCount() {
        if (expected != closed) {
            throw new RuntimeException("Did not find enough closed resources." + "Expected " + expected + ", but found " + closed);
        }
    }

    static String[] expectedOutput = { "aResource::bResource::cResource", "aResource::bResource::cResource&aResource::cResource", "aResource::bResource::cResource&aResource::cResource" };
    ...
    String test1() {
        ...
        try (bResource br = new bResource(new cResource());
            ...
            ret = ar.getClass().getSimpleName() + "::" + ar.getB().getClass().getSimpleName() + "::" + ar.getB().getC().getClass().getSimpleName();
        }
        return ret;
    }
    ...
    String test2() {
        ...
        try (aResource ar = new aResource(new bResource(new cResource()), new cResource())) {
            String abc = ar.getClass().getSimpleName() + "::" + ar.getB().getClass().getSimpleName() + "::" + ar.getB().getC().getClass().getSimpleName();
            String ac = ar.getClass().getSimpleName() + "::" + ar.getC().getClass().getSimpleName();
            ret = abc + "&" + ac;
        }
        return ret;
    }
