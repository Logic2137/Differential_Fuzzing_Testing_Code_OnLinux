...
class InstructionPanel extends JPanel implements ActionListener {
    ...
    static final String INSTRUCTIONS = "You must have a printer to peform this test.\n" + "Press the print button which will bring up a print dialog." + "Select a suitable printer, and confirm to print. " + "Examine the printed output. It should closely resemble the rendering in" + " the panel to the left. If yes, press PASS, else press FAIL";
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch(cmd) {
            case "Print":
                AlphaPrintTest.comp.doPrint();
            case "PASS":
                AlphaPrintTest.comp.doClose(true);
            case "FAIL":
                AlphaPrintTest.comp.doClose(false);
        }
    }
}
