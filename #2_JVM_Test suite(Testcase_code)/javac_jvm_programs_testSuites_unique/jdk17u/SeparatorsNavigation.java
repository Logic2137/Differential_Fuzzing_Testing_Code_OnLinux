...
public class SeparatorsNavigation {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            throw new RuntimeException("Execution interrupted by an " + "exception " + ex.getLocalizedMessage());
        } finally {
            if (f != null) {
                f.setVisible(false);
                f.dispose();
        ...
        if (!pressed) {
            throw new RuntimeException("Action was not performed, " + "considering test failed.");
        }
    }
}
