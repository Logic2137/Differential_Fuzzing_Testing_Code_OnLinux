public class InitInInterface {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        try {
            ...
            throw new RuntimeException("ClassFormatError not thrown for non-void <init> in an interface");
        ...
        try {
            ...
            throw new RuntimeException("ClassFormatError not thrown for void <init> in an interface");
        } catch (java.lang.ClassFormatError e) {
            if (!e.getMessage().contains("Interface cannot have a method named <init>")) {
