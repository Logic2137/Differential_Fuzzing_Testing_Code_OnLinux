...
public class PrintCheckboxManualTest extends Panel {
    ...
    public void init() {
        ...
        String[] instructions = { "Linux or Solaris with XToolkit ONLY!", "1. Click the 'Print' button on the frame", "2. Select a printer in the print dialog and proceed", "3. If the frame with checkbox and button on it is printed successfully test PASSED else FAILED" };
