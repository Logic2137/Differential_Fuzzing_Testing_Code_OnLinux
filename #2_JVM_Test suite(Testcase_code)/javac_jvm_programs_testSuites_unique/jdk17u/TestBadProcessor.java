...
public class TestBadProcessor {
    ...
    public void run() throws Exception {
        ...
        String expect = "error: Bad service configuration file, " + "or exception thrown while constructing Processor object: " + "javax.annotation.processing.Processor: " + "Provider AnnoProc could not be instantiated\n" + "1 error";
