...
public class FileMethods {
    ...
    private static void ck(String op, File f, String[] ls, File[] lf) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        f = new File(".");
        ck("getAbsoluteFile", f.getAbsoluteFile(), new File(f.getAbsolutePath()));
        ck("getCanonicalFile", f.getCanonicalFile(), new File(f.getCanonicalPath()));
