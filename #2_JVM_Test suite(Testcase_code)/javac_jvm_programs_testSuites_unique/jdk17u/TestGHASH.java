...
public class TestGHASH {
    ...
    private void updateGHASH(Object hash, byte[] data) throws Exception {
    ...
    private void check(int testCase, String H, String A, String C, String expected) throws Exception {
        int lenA = A.length() * 4;
        while ((A.length() % 32) != 0) {
            A += '0';
        }
        ...
        if (!expected.equals(actual)) {
            throw new AssertionError(String.format("%d: expected %s, got %s", testCase, expected, actual));
        }
    }
