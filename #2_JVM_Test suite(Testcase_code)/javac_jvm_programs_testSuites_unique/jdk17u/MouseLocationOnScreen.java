...
public final class MouseLocationOnScreen {
    ...
    private static void edge(Robot robot, GraphicsDevice device, int x1, int y1, int x2, int y2) {
        for (int x = x1; x <= x2; x++) {
            for (int y = y1; y <= y2; y++) {
                robot.mouseMove(x, y);
    ...
    private static void cross(Robot robot, GraphicsDevice device, int x0, int y0, int x1, int y1) {
