...
public class AttributeListTypeSafeTest {
    ...
    private static enum Op {
        ...
        ADD("add(Object)"), ADD_AT("add(int, Object)"), ADD_ALL("add(Collection)"), ADD_ALL_AT("add(int, Collection)"), SET("set(int, Object)");
    ...
    private static void doOp(AttributeList alist, Op op) {
        ...
        switch(op) {
            ...
            case ADD_AT:
                ...
                break;
            case ADD_ALL:
                alist.add(Collections.singleton(x));
                break;
            case ADD_ALL_AT:
                alist.add(0, Collections.singleton(x));
                break;
            case SET:
                alist.set(0, x);
                break;
            default:
                throw new AssertionError("Case not covered");
        }
    }
