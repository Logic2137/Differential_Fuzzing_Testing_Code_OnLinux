...
public class TestDefaultMethodsSyntax {
    ...
    enum VersionKind {
        ...
        PRE_LAMBDA("7"), LAMBDA("8"), POST_LAMBDA("9");
    ...
    enum ModifierKind {
        ...
        static boolean compatible(MethodKind mk, ModifierKind mod1, ModifierKind mod2, EnclosingKind ek) {
            ...
            } else if (intersect(DEFAULT, mod1, mod2) || intersect(STATIC, mod1, mod2) || intersect(PRIVATE, mod1, mod2)) {
                return mk == MethodKind.BODY;
            } else {
                return ek == EnclosingKind.INTERFACE ? mk == MethodKind.NO_BODY : mk == MethodKind.BODY;
            }
        }
        ...
        static Result[][] allowedModifierPairs = { { T, T, C, T, T, T, C, C, C, C, I }, { T, F, F, F, T, T, C, C, C, C, I }, { C, F, F, F, C, C, C, C, C, C, F }, { T, F, F, F, F, T, C, C, C, T, F }, { T, T, C, F, F, F, F, F, F, F, F }, { T, T, C, T, F, F, C, C, C, T, F }, { C, C, C, C, F, C, F, C, C, F, F }, { C, C, C, C, F, C, C, F, C, C, F }, { C, C, C, C, F, C, C, C, F, C, F }, { C, C, C, T, F, T, F, C, C, F, I }, { I, I, F, F, F, F, F, F, F, I, F } };
    }

    enum MethodKind {

        NO_BODY("void m();"), BODY("void m() { }");
    ...
    enum EnclosingKind {
        ...
        ABSTRACT_CLASS("abstract class Test "), INTERFACE("interface Test ");
    ...
    class JavaSource extends SimpleJavaFileObject {
        ...
        public JavaSource() {
            ...
            source = template.replaceAll("#EK", ek.enclStr).replaceAll("#MOD1", modk1.modStr).replaceAll("#MOD2", modk2.modStr).replaceAll("#METH", mk.methStr);
        }
    ...
    void run(JavaCompiler tool, StandardJavaFileManager fm) throws Exception {
        JavacTask ct = (JavacTask) tool.getTask(null, fm, diagChecker, vk.getOptions(), null, Arrays.asList(source));
        try {
            ct.analyze();
        } catch (Throwable ex) {
    ...
    void check() {
        ...
        errorExpected |= ModifierKind.intersect(ModifierKind.DEFAULT, modk1, modk2) && vk == VersionKind.PRE_LAMBDA;
        errorExpected |= ModifierKind.intersect(ModifierKind.STATIC, modk1, modk2) && ek == EnclosingKind.INTERFACE && vk == VersionKind.PRE_LAMBDA;
        errorExpected |= ModifierKind.intersect(ModifierKind.PRIVATE, modk1, modk2) && ek == EnclosingKind.INTERFACE && (vk == VersionKind.LAMBDA || vk == VersionKind.PRE_LAMBDA);
        checkCount++;
