...
public class AccelPaintsTest extends JPanel {
    ...
    BufferedImage bi = new BufferedImage(80, 100, BufferedImage.TYPE_INT_ARGB_PRE);

    RadialGradientPaint rgp = new RadialGradientPaint(100, 100, 100, new float[] { 0f, 0.2f, 0.6f, 1f }, new Color[] { Color.red, Color.yellow, Color.blue, Color.green }, CycleMethod.REFLECT);

    LinearGradientPaint lgp = new LinearGradientPaint(30, 30, 120, 130, new float[] { 0f, 0.2f, 0.6f, 1f }, new Color[] { Color.red, Color.yellow, Color.blue, Color.green });

    GradientPaint gp = new GradientPaint(30, 30, Color.red, 120, 130, Color.yellow, true);

    TexturePaint tp = new TexturePaint(bi, new Rectangle2D.Float(30, 30, 120, 130));
