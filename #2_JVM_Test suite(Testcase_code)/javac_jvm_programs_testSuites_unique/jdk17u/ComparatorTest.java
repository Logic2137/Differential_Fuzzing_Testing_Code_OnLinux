...
public class ComparatorTest {
    ...
    private static final String[][] tests = { { String.valueOf(LT), ":k1=v1", "d:k1=v1" }, { String.valueOf(EQ), "d:k1=v1", "d:k1=v1" }, { String.valueOf(GT), "d2:k1=v1", "d1:k1=v1" }, { String.valueOf(GT), "d:type=a,k1=v1", "d:k1=v1" }, { String.valueOf(GT), "d:type=a,k1=v1", "d:type=" }, { String.valueOf(GT), "d:type=a,k1=v1", "d:type=,k1=v1" }, { String.valueOf(LT), "d:type=a,k1=v1", "d:type=b,k1=v1" }, { String.valueOf(LT), "d:type=a,k2=v2", "d:type=b,k1=v1" }, { String.valueOf(EQ), "d:k1=v1,k2=v2", "d:k2=v2,k1=v1" }, { String.valueOf(LT), "d:k1=v1,k2=v2", "d:k1=v1,k3=v3" }, { String.valueOf(LT), "d:k1=v1,k2=v2", "d:k2=v2,k1=v1,k3=v3" }, { String.valueOf(LT), "d:k1=v1", "d:k1=v1,*" }, { String.valueOf(GT), "d:k1=v1,k2=v2", "d:k1=v1,*" }, { String.valueOf(GT), "domain:k1=v1", "?:k1=v1" }, { String.valueOf(GT), "domain:k1=v1", "*:k1=v1" }, { String.valueOf(GT), "domain:k1=v1", "domai?:k1=v1" }, { String.valueOf(GT), "domain:k1=v1", "domai*:k1=v1" }, { String.valueOf(GT), "domain:k1=v1", "do?ain:k1=v1" }, { String.valueOf(GT), "domain:k1=v1", "do*ain:k1=v1" } };
        ...
        try {
            ...
            switch(comparator) {
                ...
                case GT:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Test incorrect: case: " + comparator);
            }
        } catch (Exception e) {
            ok = false;
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("----------------------------------------------");
        for (int i = 0; i < tests.length; i++) error += runTest(tests[i][0].charAt(0), tests[i][1], tests[i][2]);
        if (error > 0) {
