...
public class SSLSocketSSLEngineTemplate {
    ...
    private final byte[] clientMsg = "Hello Server, I'm a Client! Pleased to meet you!".getBytes();
    ...
    public static void main(String[] args) throws Exception {
        ...
        SSLSocketSSLEngineTemplate test = new SSLSocketSSLEngineTemplate(protocol);
        log("-------------------------------------");
    ...
    private Thread createClientThread(final int port, final boolean serverClose) throws Exception {
        Thread t = new Thread("ClientThread") {

            @Override
            public void run() {
                try (SSLSocket sslSocket = (SSLSocket) sslc.getSocketFactory().createSocket("localhost", port)) {
