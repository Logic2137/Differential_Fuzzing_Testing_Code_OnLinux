...
public class TestSIMPPlugin {
    ...
    static byte[] simpData = { (byte) 'S', (byte) 'I', (byte) 'M', (byte) 'P', 1, 1, 0, 0, 0 };
    ...
    public static void main(String[] args) throws Exception {
        ...
        IIOMetadataFormat spiFmt = spi.getImageMetadataFormat("simp_metadata_1.0");
        ...
        IIOMetadataFormat format = metadata.getMetadataFormat("simp_metadata_1.0");
