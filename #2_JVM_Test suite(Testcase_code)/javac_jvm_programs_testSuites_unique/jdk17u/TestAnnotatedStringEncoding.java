...
public class TestAnnotatedStringEncoding {
        ...
        for (Method m : this.getClass().getMethods()) {
            if (m.isAnnotationPresent(Test.class)) {
                ...
                if (!str.equals(strValue[index])) {
                    throw new RuntimeException(m.getName() + " failed: \"" + str + "\" (0x" + Integer.toHexString(str.charAt(0)) + ") does not equal \"" + strValue[index] + "\" (0x" + Integer.toHexString(strValue[index].charAt(0)) + ") .");
                }
            }
        }
    ...
    public static String[] strValue = { "\u0000", "\u0020", "\u0021", "\u0080", "\u00FF", "\u0100", "\u017F", "\u01FF", "\u07FF", "\u0800", "\uC280", "\uC2BF", "\uC380", "\uC3BF", "\uC5BF", "\uFFFF", "\u10000", "\u1FFFFF", "\u200000", "\u3FFFFFF", "\u4000000", "\u7FFFFFFF", "ab\uff23\uff24ef\uff27", "\uff21\uff22cd\uff25g", "\u00FF\u00FF\u00FF", "\u00A1\u00A1\u00A1\u00A1", "" };
