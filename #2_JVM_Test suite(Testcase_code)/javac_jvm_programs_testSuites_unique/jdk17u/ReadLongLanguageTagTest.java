...
public class ReadLongLanguageTagTest {
    ...
    private static void createITXTNode() throws IIOInvalidTreeException {
        ...
        iTXt_Entry.setAttribute("languageTag", "en-Java" + "JavaJavaJavaJavaJavaJavaJavaJavaJavaJavaJavaJava" + "JavaJavaJavaJavaJavaJavaJavaJavaJavaJavaJavaJava");
    ...
    private static void readITXTChunk() throws IOException {
        ...
        try {
            ...
            if (iterReader.hasNext()) {
                ...
                throw new RuntimeException("Requested PNGImageReader" + " not available");
            }
        } finally {
            input.close();
        }
