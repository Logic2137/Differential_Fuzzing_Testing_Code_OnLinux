...
public class HandlersOnComplexResetUpdate {
    ...
    static {
        ...
        properties = Collections.unmodifiableList(Arrays.asList(props1, props2, props3, props4, props5));
    }
    ...
    static void test(String name, List<Properties> properties) throws Exception {
        ...
        try {
            ...
            boolean checkHandlersOnParent = Boolean.parseBoolean(previousProps.getProperty("test.checkHandlersOnParent", "true"));
            ...
            for (int i = 1; i < properties.size(); i++) {
                ...
                if (checkHandlersOnParent) {
                    assertEquals(expectedHandlersCount, fooChild.getParent().getHandlers().length, "fooChild.getParent().getHandlers().length");
                }
                if (checkHandlersOn != null) {
                    ...
                    assertEquals(expectedHandlersCount, loggerWithHandlers.getHandlers().length, checkHandlersOn + ".getHandlers().length");
                }
                ...
                if (checkHandlersOn != null) {
                    ...
                    assertEquals(0, loggerWithHandlers.getHandlers().length, checkHandlersOn + ".getHandlers().length");
                }
                if (i == 4) {
                ...
                checkHandlersOnParent = Boolean.parseBoolean(nextProps.getProperty("test.checkHandlersOnParent", "true"));
    ...
    static class Configure {
        ...
        static void updateConfigurationWith(Properties propertyFile, boolean append) {
            try {
                ...
                Function<String, BiFunction<String, String, String>> remapper = append ? (x) -> ((o, n) -> n == null ? o : n) : (x) -> ((o, n) -> n);
