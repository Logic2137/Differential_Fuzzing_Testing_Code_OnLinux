public class SecurityRace implements Runnable {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        if (argv.length > 0) {
            if (argv[0].equals("time")) {
                ...
                throw new RuntimeException("SecurityRace: " + argv[0] + " argument to main not recognized");
            }
        }
        long start = System.currentTimeMillis(), end = start + MAX_MILLISECONDS;
    ...
    public static void timeit(int timing_trials, int get_timing_loops, int set_timing_loops) {
        try {
            long start;
