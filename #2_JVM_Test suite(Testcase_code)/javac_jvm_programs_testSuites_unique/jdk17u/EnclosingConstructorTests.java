...
public class EnclosingConstructorTests {
    ...
    public static void main(String[] argv) {
        ...
        failures += examine(StaticLocal.class, null);
        failures += examine(localClass, "EnclosingConstructorTests()");
        failures += examine(anotherLocalClass, "private EnclosingConstructorTests(int)");
