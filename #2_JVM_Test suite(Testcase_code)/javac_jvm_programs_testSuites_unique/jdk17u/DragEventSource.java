...
public class DragEventSource {
    ...
    private static void init() {
        ...
        if (!isSupported) {
            String[] instructions = { "The test cannot be run because SystemTray is not supported.", "Simply press PASS button." };
            Sysout.createDialog();
            Sysout.printInstructions(instructions);
            return;
        }
        String[] instructions = { "Click 'Open file dialog' button. FileDialog should appear.", "Using left mouse button,", "Drag the mouse from the Tray icon to FileDialog.", "If exception is thrown, the test fails.", "Otherwise, pass." };
        Sysout.createDialog();
        Sysout.printInstructions(instructions);
