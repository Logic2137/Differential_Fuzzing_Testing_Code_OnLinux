...
public class CrashPaintTest {
    ...
    public static void main(String[] argv) {
        ...
        try {
            ...
            final Ellipse2D.Double ellipse = new Ellipse2D.Double(0, 0, width, height);
    ...
    private static class CustomPaint extends TexturePaint {
        ...
        CustomPaint(final int size) {
            super(new BufferedImage(size, size, BufferedImage.TYPE_INT_ARGB), new Rectangle2D.Double(0, 0, size, size));
            this.size = size;
        }
        ...
        public PaintContext createContext(ColorModel cm, Rectangle deviceBounds, Rectangle2D userBounds, AffineTransform at, RenderingHints hints) {
            ...
            try {
                ...
                g2d.fillOval(size / 10, size / 10, size * 8 / 10, size * 8 / 10);
            } finally {
                g2d.dispose();
            }
