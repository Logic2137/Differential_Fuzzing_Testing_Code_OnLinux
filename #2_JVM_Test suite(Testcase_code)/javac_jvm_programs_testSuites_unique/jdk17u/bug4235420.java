...
public class bug4235420 {
    ...
    public static void main(String[] argv) throws Exception {
        for (UIManager.LookAndFeelInfo LF : UIManager.getInstalledLookAndFeels()) {
            ...
            if ("Nimbus".equals(UIManager.getLookAndFeel().getName()) || "GTK".equals(UIManager.getLookAndFeel().getID())) {
        ...
        public void test() {
            ...
            for (Class rendererClass : rendererClasses) {
                ...
                if (obj instanceof TableCellRenderer) {
                    throw new Error("Failed: TableCellRenderer created for " + rendererClass.getClass().getName());
                }
            }
            ...
            for (Class editorClass : editorClasses) {
                ...
                if (obj instanceof TableCellEditor) {
                    throw new Error("Failed: TableCellEditor created for " + editorClass.getClass().getName());
                }
            }
        }
    }
