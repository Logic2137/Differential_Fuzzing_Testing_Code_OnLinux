...
public class Test6998541 {
    ...
    private static void dolong() throws Throwable {
        ...
        for (int i = 0; i < N; i++, x += D) long2prim(x);
        long2prim_invalid(x);
    }
    ...
    private static void dofloat() throws Throwable {
        ...
        for (int i = 0; i < N; i++, x += D) float2prim(x);
    ...
    private static void dodouble() throws Throwable {
        ...
        for (int i = 0; i < N; i++, x += D) double2prim(x);
    ...
    private static final Class<?>[] NUMERIC_TYPE_WIDENING_ORDER = { byte.class, short.class, int.class, long.class, float.class, double.class };
    ...
    private static boolean canDoAsType(Class<?> src, Class<?> dst) {
        ...
        if (!src.isPrimitive() || !dst.isPrimitive())
            return true;
        if (src == boolean.class || dst == boolean.class)
            return false;
        if (dst == char.class)
            return false;
        if (src == char.class)
    ...
    private static MethodHandle mh_z(Class ret) {
        return mh(ret, boolean.class);
    }
    ...
    private static void boolean2prim_invalid(boolean x) throws Throwable {
        ...
        try {
            short y = (short) mh_sz.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            int y = (int) mh_iz.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            long y = (long) mh_jz.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            float y = (float) mh_fz.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            double y = (double) mh_dz.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
    }

    private static MethodHandle mh_b(Class ret) {
        return mh(ret, byte.class);
    }
    ...
    private static void byte2prim_invalid(byte x) throws Throwable {
        if (DO_CASTS)
            return;
        try {
            char y = (char) mh_cb.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
    ...
    private static MethodHandle mh_c(Class ret) {
        return mh(ret, char.class);
    }
    ...
    private static void char2prim_invalid(char x) throws Throwable {
        if (DO_CASTS)
            return;
        try {
            boolean y = (boolean) mh_zc.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
        ...
        try {
            short y = (short) mh_sc.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
    }

    private static MethodHandle mh_s(Class ret) {
        return mh(ret, short.class);
    }
    ...
    private static void short2prim_invalid(short x) throws Throwable {
        if (DO_CASTS)
            return;
        try {
            boolean y = (boolean) mh_zs.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
        ...
        try {
            char y = (char) mh_cs.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
    }

    private static MethodHandle mh_i(Class ret) {
        return mh(ret, int.class);
    }
    ...
    private static void int2prim_invalid(int x) throws Throwable {
        if (DO_CASTS)
            return;
        try {
            boolean y = (boolean) mh_zi.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            byte y = (byte) mh_bi.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            char y = (char) mh_ci.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
    ...
    private static MethodHandle mh_j(Class ret) {
        return mh(ret, long.class);
    }
    ...
    private static void long2prim_invalid(long x) throws Throwable {
        if (DO_CASTS)
            return;
        try {
            boolean y = (boolean) mh_zj.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
        ...
        try {
            char y = (char) mh_cj.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
        ...
        try {
            int y = (int) mh_ij.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
    }

    private static MethodHandle mh_f(Class ret) {
        return mh(ret, float.class);
    }
    ...
    private static void float2prim_invalid(float x) throws Throwable {
        if (DO_CASTS)
            return;
        try {
            boolean y = (boolean) mh_zf.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            byte y = (byte) mh_bf.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            char y = (char) mh_cf.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            short y = (short) mh_sf.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            int y = (int) mh_if.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            long y = (long) mh_jf.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
    }

    private static MethodHandle mh_d(Class ret) {
        return mh(ret, double.class);
    }
    ...
    private static void double2prim_invalid(double x) throws Throwable {
        if (DO_CASTS)
            return;
        try {
            boolean y = (boolean) mh_zd.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            byte y = (byte) mh_bd.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            char y = (char) mh_cd.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            short y = (short) mh_sd.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            int y = (int) mh_id.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            long y = (long) mh_jd.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
        try {
            float y = (float) mh_fd.invokeExact(x);
            fail();
        } catch (ClassCastException expected) {
        }
    }
    ...
    private static MethodHandle mh_v(Class arg) {
        return mh(void.class, arg);
    }
