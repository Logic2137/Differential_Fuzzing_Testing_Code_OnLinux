...
public class TestCipherMode {
    ...
    private static final String[] TRANSFORMATIONS = { "DES/ECB/PKCS5Padding", "AES/GCM/NoPadding", "AES/KW/NoPadding", "AES/KW/PKCS5Padding", "AES/KWP/NoPadding", "RSA/ECB/NoPadding", "DESedeWrap/CBC/NoPadding", "ChaCha20-Poly1305" };

    private static final byte[] BYTES32 = Arrays.copyOf(TRANSFORMATIONS[0].getBytes(), 32);

    private static final SecretKey DES_KEY = new SecretKeySpec(BYTES32, 0, 8, "DES");

    private static final SecretKey AES_KEY = new SecretKeySpec(BYTES32, 0, 16, "AES");

    private static enum CipherMode {

        ENCRYPT(Cipher.ENCRYPT_MODE), DECRYPT(Cipher.DECRYPT_MODE), WRAP(Cipher.WRAP_MODE), UNWRAP(Cipher.UNWRAP_MODE), NONEXISTENT(100);
    ...
    private static Key getKey(String t, CipherMode m) throws NoSuchAlgorithmException, NoSuchProviderException {
        Key key;
        ...
        switch(algo) {
            ...
            case "RSA":
                ...
                key = ((m == CipherMode.ENCRYPT || m == CipherMode.UNWRAP) ? kp.getPrivate() : kp.getPublic());
                break;
    ...
    private TestCipherMode(String provName, String... transformations) throws Exception {
    ...
    private void checkMode(String t, CipherMode mode, String provName) throws Exception {
