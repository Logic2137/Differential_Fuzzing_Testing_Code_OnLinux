...
public class StressTest {
    ...
    static final Locale[] locales = { Locale.US, Locale.CHINA, ROOT_LOCALE, Locale.JAPAN, Locale.CANADA, Locale.KOREA };

    static final String[] expected = { "U.S.A.", "China", "U.S.A.", "Japan", "U.S.A.", "Korea" };
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.printf("%d processors, intervalForCounterCheck = %d [sec]%n", nProcessors, intervalForCounterCheck);
            try {
    ...
    static class Worker implements Runnable {
        ...
        Worker(int i) {
            ...
            System.out.println("Worker" + i + ": locale=" + locale + ", expected=" + str + ", max=" + max);
        }
