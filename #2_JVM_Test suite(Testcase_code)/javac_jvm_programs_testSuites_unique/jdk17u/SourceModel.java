...
public class SourceModel {
    ...
    public static abstract class Type extends Element {
        ...
        protected Type(String name, List<AccessFlag> flags, List<TypeParameter> params, List<Extends> ifaces, List<Method> methods) {
            this.name = name;
    ...
    public static class Class extends Type {
        ...
        public Class(String name, List<AccessFlag> flags, List<TypeParameter> params, Extends sprClass, List<Extends> interfaces, List<Method> methods) {
    ...
    public static class Interface extends Type {
        ...
        public Interface(String name, List<AccessFlag> flags, List<TypeParameter> params, List<Extends> interfaces, List<Method> methods) {
            super(name, flags, params, interfaces, methods);
        }
    ...
    public static abstract class Method extends Element {
        ...
        protected Method(String ret, String name, Element... params) {
            ...
            Arrays.asList(params).stream().filter(x -> x instanceof MethodParameter).map(x -> (MethodParameter) x).forEach(this.parameters::add);
            Arrays.asList(params).stream().filter(x -> x instanceof AccessFlag).map(x -> (AccessFlag) x).forEach(this.accessFlags::add);
            assert accessFlags.size() + parameters.size() == params.length : "Non method parameters or access flags in constructor";
        }
    ...
    public static class ConcreteMethod extends Method {
        ...
        public static ConcreteMethod std(String value) {
            return new ConcreteMethod("int", SourceModel.stdMethodName, "return " + value + ";", AccessFlag.PUBLIC);
        }
    }
