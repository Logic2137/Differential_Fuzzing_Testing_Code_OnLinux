...
public class NegativeInitSize {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            throw new Exception("ByteArrayOutputStream failed to detect negative init size");
        }
        ...
        try {
            ...
            throw new Exception("PushbackReader failed to detect negative init size");
        }
        try {
            PushbackInputStream pbis = new PushbackInputStream(null, -1);
        } catch (IllegalArgumentException e) {
        } catch (Exception e) {
            throw new Exception("PushbackInputStream failed to detect negative init size");
        }
        ...
        try {
            ...
            throw new Exception("BufferedOutputStream failed to detect negative init size");
        }
        byte[] ba = { 123 };
        ...
        try {
            ...
            throw new Exception("BufferedInputStream failed to detect negative init size");
        }
        try {
            CharArrayWriter caw = new CharArrayWriter(-1);
        } catch (IllegalArgumentException e) {
        } catch (Exception e) {
            throw new Exception("CharArrayWriter failed to detect negative init size");
        }
    }
}
