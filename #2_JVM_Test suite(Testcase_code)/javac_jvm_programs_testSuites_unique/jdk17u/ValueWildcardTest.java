...
public class ValueWildcardTest {
    ...
    private static int createObjectName(int i, String s, String d, String k, String v, Hashtable<String, String> t, boolean plp, boolean pvp) throws Exception {
        System.out.println("----------------------------------------------");
        switch(i) {
            case 1:
    ...
    private static int createObjectName1(String s, boolean plp, boolean pvp) throws Exception {
        return createObjectName(1, s, null, null, null, null, plp, pvp);
    }

    private static int createObjectName2(String d, String k, String v, boolean plp, boolean pvp) throws Exception {
        return createObjectName(2, null, d, k, v, null, plp, pvp);
    }

    private static int createObjectName3(String d, Hashtable<String, String> t, boolean plp, boolean pvp) throws Exception {
