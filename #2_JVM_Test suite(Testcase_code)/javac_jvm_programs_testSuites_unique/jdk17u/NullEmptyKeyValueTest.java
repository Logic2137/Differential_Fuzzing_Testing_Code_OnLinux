...
public class NullEmptyKeyValueTest {
    ...
    private static int createObjectName(int i, Class c, String s, String d, String k, String v, Hashtable<String, String> t) throws Exception {
        System.out.println("----------------------------------------------");
        switch(i) {
            case 1:
    ...
    private static int createObjectName1(Class c, String s) throws Exception {
        return createObjectName(1, c, s, null, null, null, null);
    }

    private static int createObjectName2(Class c, String d, String k, String v) throws Exception {
        return createObjectName(2, c, null, d, k, v, null);
    }

    private static int createObjectName3(Class c, String d, Hashtable<String, String> t) throws Exception {
