...
public final class Sysout {
    ...
    public static void createDefaultInstructionDialog() {
        final String[] instructions = { "This is an AUTOMATIC test, simply wait until it is done.", "The result (passed or failed) will be shown in the", "message window below." };
