...
public class TestBeanInfoPriority {
    ...
    @JavaBean(description = "annotation-description", defaultProperty = "other", defaultEventSet = "mouse")
    ...
    public static class TestClass {
        ...
        @BeanProperty(bound = false, expert = false, hidden = false, preferred = false, required = false, visualUpdate = false, description = "annotation-value", enumerationValues = { "javax.swing.SwingConstants.NORTH" })
        ...
        @BeanProperty(bound = true, expert = true, hidden = true, preferred = true, required = true, visualUpdate = true, description = "annotation-other", enumerationValues = { "javax.swing.SwingConstants.LEFT", "javax.swing.SwingConstants.RIGHT", "javax.swing.SwingConstants.CENTER" })
    ...
    public static class TestClassBeanInfo extends SimpleBeanInfo {
        ...
        public PropertyDescriptor[] getPropertyDescriptors() {
            ...
            try {
                PropertyDescriptor pdValue = new PropertyDescriptor("value", TestClass.class, "getValue", "setValue");
                ...
                pdValue.setValue("enumerationValues", new Object[] { "EAST", 3, "javax.swing.SwingConstants.EAST", "WEST", 7, "javax.swing.SwingConstants.WEST" });
                p[iValue] = pdValue;
                PropertyDescriptor pdOther = new PropertyDescriptor("other", TestClass.class, "getOther", "setOther");
                ...
                pdOther.setValue("enumerationValues", new Object[] { "TOP", 1, "javax.swing.SwingConstants.TOP" });
                p[iOther] = pdOther;
        ...
        public EventSetDescriptor[] getEventSetDescriptors() {
            ...
            try {
                es[iAction] = new EventSetDescriptor(TestClass.class, "actionListener", java.awt.event.ActionListener.class, new String[] { "actionPerformed" }, "addActionListener", "removeActionListener");
                es[iMouse] = new EventSetDescriptor(TestClass.class, "mouseListener", java.awt.event.MouseListener.class, new String[] { "mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited" }, "addMouseListener", "removeMouseListener");
            } catch (IntrospectionException e) {
                e.printStackTrace();
            }
            return es;
    ...
    public static void main(String[] args) throws Exception {
        ...
        checkEq("containerDelegate", i.getBeanDescriptor().getValue("containerDelegate"), "user-defined-delegate");
        System.out.println("");
        ...
        for (PropertyDescriptor pd : pds) {
            ...
            switch(name) {
                case "value":
                    ...
                    checkEnumEq(pd.getName(), pd.getValue("enumerationValues"), new Object[] { "EAST", 3, "javax.swing.SwingConstants.EAST", "WEST", 7, "javax.swing.SwingConstants.WEST" });
                    System.out.println("");
                    break;
                case "other":
                    ...
                    checkEnumEq(pd.getName(), pd.getValue("enumerationValues"), new Object[] { "TOP", 1, "javax.swing.SwingConstants.TOP" });
                    System.out.println("");
                    break;
                default:
