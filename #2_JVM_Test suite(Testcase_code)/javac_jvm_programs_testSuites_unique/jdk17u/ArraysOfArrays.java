            ...
            for (int ix = 0; ix < s_u.length; ix++) {
                for (int iy = 0; iy < s_u[ix].length; iy++) {
                    if (s[ix][iy] != s_u[ix][iy]) {
                        System.err.println("\nshort array mismatch [" + ix + "][" + iy + "] expected " + s[ix][iy] + " actual = " + s_u[ix][iy]);
                        throw new Error();
                    }
                }
            }
            ...
            for (int ix = 0; ix < c_u.length; ix++) {
                for (int iy = 0; iy < c_u[ix].length; iy++) {
                    if (c[ix][iy] != c_u[ix][iy]) {
                        System.err.println("\nchar array mismatch [" + ix + "][" + iy + "] expected " + c[ix][iy] + " actual = " + c_u[ix][iy]);
                        throw new Error();
                    }
                }
            }
            ...
            for (int ix = 0; ix < i_u.length; ix++) {
                for (int iy = 0; iy < i_u[ix].length; iy++) {
                    if (i[ix][iy] != i_u[ix][iy]) {
                        System.err.println("\nint array mismatch [" + ix + "][" + iy + "] expected " + i[ix][iy] + " actual = " + i_u[ix][iy]);
                        throw new Error();
                    }
                }
            }
            ...
            for (int ix = 0; ix < l_u.length; ix++) {
                for (int iy = 0; iy < l_u[ix].length; iy++) {
                    if (l[ix][iy] != l_u[ix][iy]) {
                        System.err.println("\nlong array mismatch [" + ix + "][" + iy + "] expected " + l[ix][iy] + " actual = " + l_u[ix][iy]);
                        throw new Error();
                    }
                }
            }
            ...
            for (int ix = 0; ix < z_u.length; ix++) {
                for (int iy = 0; iy < z_u[ix].length; iy++) {
                    if (z[ix][iy] != z_u[ix][iy]) {
                        System.err.println("\nboolean array mismatch [" + ix + "][" + iy + "] expected " + z[ix][iy] + " actual = " + z_u[ix][iy]);
                        throw new Error();
                    }
                }
            }
            ...
            for (int ix = 0; ix < f_u.length; ix++) {
                for (int iy = 0; iy < f_u[ix].length; iy++) {
                    if (f[ix][iy] != f_u[ix][iy]) {
                        System.err.println("\nfloat array mismatch [" + ix + "][" + iy + "] expected " + f[ix][iy] + " actual = " + f_u[ix][iy]);
                        throw new Error();
                    }
                }
            }
            ...
            for (int ix = 0; ix < d_u.length; ix++) {
                for (int iy = 0; iy < d_u[ix].length; iy++) {
                    if (d[ix][iy] != d_u[ix][iy]) {
                        System.err.println("\ndouble array mismatch [" + ix + "][" + iy + "] expected " + d[ix][iy] + " actual = " + d_u[ix][iy]);
                        throw new Error();
                    }
                }
            }
            ...
            for (int ix = 0; ix < Int_u.length; ix++) {
                for (int iy = 0; iy < Int_u[ix].length; iy++) {
                    if (!Int[ix][iy].equals(Int_u[ix][iy])) {
                        System.err.println("\nInteger array mismatch [" + ix + "][" + iy + "] expected " + Int[ix][iy] + " actual = " + Int_u[ix][iy]);
                        throw new Error();
                    }
                }
            }
