...
public class DragTestWithHIDPI extends TransferHandler {
    ...
    private void createGUI() throws Exception {
        SwingUtilities.invokeAndWait(() -> {
            String[] listData = new String[] { "Pacific Ocean", "Atlantic Ocean", "Indian Ocean", "Arctic Ocean" };
    ...
    private void doTest() throws Exception {
        ...
        for (Direction direction : Direction.values()) {
            ...
            if (didDrag) {
                disposeGUI();
                throw new RuntimeException("Shouldn't start drag until > " + threshold + " pixels " + " while moving " + direction);
            }
            didDrag = false;
            ...
            if (!didDrag) {
                disposeGUI();
                throw new RuntimeException("Should start drag after > " + threshold + " pixels" + " while moving " + direction);
            }
        }
    }
