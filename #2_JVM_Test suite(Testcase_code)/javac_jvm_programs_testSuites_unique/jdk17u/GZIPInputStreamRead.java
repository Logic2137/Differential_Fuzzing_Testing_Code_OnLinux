    ...
    public static void main(String[] args) throws Throwable {
        ...
        for (int i = 1; i < 100; i++) {
            ...
            for (int j = 0; j < 10; j++) {
                ...
                test(srcBytes, dstBytes, readBufSZ, 512);
                test(srcBytes, dstBytes, readBufSZ, rnd.nextInt(4096) + 1);
            }
        }
    }

    private static void test(byte[] src, byte[] dst, int readBufSize, int gzisBufSize) throws Throwable {
