    ...
    public void changeMousePosition() {
        ...
        try {
            ...
            if (pMousePosition == null) {
                throw new RuntimeException("Test failed: " + "Component.getMousePosition() returned null result " + "inside Component");
            }
            if (pMousePosition.x != button.getWidth() / 2 || pMousePosition.y != button.getHeight() / 2) {
                throw new RuntimeException("Test failed: " + "Component.getMousePosition() returned incorrect " + "result inside Component");
            }
            pMousePosition = overlappedButton.getMousePosition();
            if (pMousePosition != null) {
                throw new RuntimeException("Test failed: Overlapped component " + "did not return null result when a pointer was inside" + " the components bounds.");
            }
            ...
            if (pMousePosition != null) {
                throw new RuntimeException("FAILED: " + "Component.getMousePosition() returned non-null " + "results outside Component");
            }
