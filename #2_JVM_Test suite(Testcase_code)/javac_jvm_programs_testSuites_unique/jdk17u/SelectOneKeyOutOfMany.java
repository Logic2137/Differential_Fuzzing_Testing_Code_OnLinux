...
public class SelectOneKeyOutOfMany {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < resultArrayRSA.length; i++) {
            System.out.println("        resultArrayRSA#" + i + ": " + resultArrayRSA[i]);
        }
        ...
        for (int i = 0; i < resultArrayDSA.length; i++) {
            System.out.println("        resultArrayDSA#" + i + ": " + resultArrayDSA[i]);
        }
        System.out.println("=====");
        ...
        if (resultsRsa == null) {
            throw new Exception("km.chooseClientAlias(rsa, null, null) != null");
        }
        System.out.println("km.chooseClientAlias(rsa) passed");
        resultsDsa = km.chooseClientAlias(dsa, null, null);
        if (resultsDsa == null) {
            throw new Exception("km.chooseClientAlias(dsa, null, null) != null");
        }
        ...
        if (resultsRsa == null) {
            throw new Exception("km.chooseServerAlias(\"RSA\", null, null) != null");
        }
        System.out.println("km.chooseServerAlias(\"RSA\") passed");
        resultsDsa = km.chooseServerAlias("DSA", null, null);
        if (resultsDsa == null) {
            throw new Exception("km.chooseServerAlias(\"DSA\", null, null) != null");
        }
