...
public class JFileChooserOrientation {
                ...
                fileChooserButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try {
                            ...
                            Logger.getLogger(JFileChooserOrientation.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
                });
                gbc.gridx = 0;
    ...
    private static void fail() throws Exception {
        frame.dispose();
        System.err.println(lookAndFeelComboBox.getSelectedItem().toString() + " : Incorrect Orientation");
    }
