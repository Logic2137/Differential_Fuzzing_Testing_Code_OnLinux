...
public class AutoTestOnTop {
    ...
    static final Object uncheckedSrc = new Object();
    ...
    static boolean[] eventsCheckInitVals = new boolean[] { true, true, true, true, true, false, false, false, false };

    static String[] msgEventsChecks = new String[] { null, null, null, null, null, "expected WindowEvent.WINDOW_STATE_CHANGED hasn't been generated", "expected WindowEvent.WINDOW_STATE_CHANGED hasn't been generated", "expected WindowEvent.WINDOW_STATE_CHANGED hasn't been generated", "expected WindowEvent.WINDOW_STATE_CHANGED hasn't been generated" };
    ...
    private static void doStage(int stageNum, int actNum) {
        try {
            ...
            waitForIdle(true);
            if (!topw.isAlwaysOnTopSupported())
                return;
    ...
    public static void testForAlwaysOnTop() {
        ...
        clickOn(topw, f, 10, 50, "setting " + msgVisibility + " window (1) always-on-top didn't make it topmost");
        f.toFront();
        clickOn(uncheckedSrc, f, 450, 50, "");
        pause(300);
        clickOn(topw, f, 10, 50, "setting " + msgVisibility + " window (1) always-on-top didn't make it such");
        if (isAlwaysOnTop(topw) != true)
            error("Test failed: stage #" + stageNum + ", action #" + actNum + ": " + msgCase + ": " + msgAction + ": isAlwaysOnTop() returned 'false' for window (1) set always-on-top at state " + msgVisibility);
    }
    ...
    public static void testForNotAlwaysOnTop() {
        ...
        if (msgVisibility.equals("visible") && actNum != 2) {
            clickOn(topw, f, 10, 50, "setting " + msgVisibility + " window (1) not always-on-top didn't keep it topmost");
        }
        f.toFront();
        clickOn(uncheckedSrc, f, 450, 50, "");
        pause(300);
        clickOn(f, f, 10, 50, "setting " + msgVisibility + " window (1) not always-on-top didn't make it such");
        if (isAlwaysOnTop(topw) != false)
            error("Test failed: stage #" + stageNum + ", action #" + actNum + ": " + msgCase + ": " + msgAction + ": isAlwaysOnTop() returned 'true' for window (1) set not always-on-top at state " + msgVisibility);
    }
    ...
    public static void postAction_0() {
        if (topw.isShowing()) {
            error("Test failed: stage #" + stageNum + ", action #" + actNum + ": " + msgCase + ": no actions with windows: changing always-on-top property at window (1) state 'invisible' makes window (1) visible");
        }
    ...
    public static void checkActionEvents_1(AWTEvent e) {
        ...
        error("Test failed: stage #" + stageNum + ", action # " + actNum + ": " + msgCase + ": " + msgAction + ": after call " + msgFunc + ":  unexpected event " + e + " was generated");
    }
    ...
    public static void checkActionEvents_2(AWTEvent e) {
        System.err.println(e.toString());
        if ((e.getID() >= FocusEvent.FOCUS_FIRST && e.getID() <= FocusEvent.FOCUS_LAST) || (e.getID() == WindowEvent.WINDOW_LOST_FOCUS && e.getID() == WindowEvent.WINDOW_GAINED_FOCUS)) {
            eventsCheckPassed = false;
            error("Test failed: stage #" + stageNum + ", action # " + actNum + ": " + msgCase + ": " + msgAction + ": after call " + msgFunc + ": unexpected event " + e + " was generated");
        }
    }
    ...
    public static void preAction_6() {
        ...
        if (!waitForStateChange()) {
            error("Test failed: stage #" + stageNum + ", action # " + actNum + ": " + msgCase + ": " + msgAction + ": after call " + msgFunc + ":  state change to ICONIFIED hasn't been generated");
        }
    }
    ...
    public static void postAction_6() {
        ...
        ((Frame) topw).setExtendedState(Frame.NORMAL);
        if (!waitForStateChange()) {
            error("Test failed: stage #" + stageNum + ", action # " + actNum + ": " + msgCase + ": " + msgAction + ": after call " + msgFunc + ":  state change to NORMAL hasn't been generated");
        }
    }
    ...
    public static void postAction_8() {
        ((Frame) topw).setExtendedState(Frame.MAXIMIZED_BOTH);
        if (!waitForStateChange()) {
            error("Test failed: stage #" + stageNum + ", action # " + actNum + ": " + msgCase + ": " + msgAction + ": after call " + msgFunc + ":  state change to MAXIMIZED hasn't been generated");
        }
        ((Frame) topw).setExtendedState(Frame.NORMAL);
        if (!waitForStateChange()) {
            error("Test failed: stage #" + stageNum + ", action # " + actNum + ": " + msgCase + ": " + msgAction + ": after call " + msgFunc + ":  state change to NORMAL hasn't been generated");
    ...
    private static void setAlwaysOnTop(Window w, boolean value) {
        ...
        try {
            ...
            error("Test failed: stage#" + stageNum + "action #" + actNum + ": " + msgCase + ": " + msgAction + ": setAlwaysOnTop(" + value + ") called at state " + msgVisibility + " threw exeption " + e);
        }
    }
    ...
    private static boolean isAlwaysOnTop(Window w) {
        ...
        try {
            ...
            error("Test failed: stage #" + stageNum + ", action # " + actNum + ": " + msgCase + ": " + msgAction + ": isAlwaysOnTop() called at state " + msgVisibility + " threw exeption " + e);
        }
        return result;
    }
    ...
    private static void waitForIdle(boolean doCheck) {
        ...
        if (doCheck) {
            eventsCheckPassed = eventsCheckInitVals[actNum];
        } else if (!eventsCheckPassed && msgEventsChecks[actNum] != null) {
            doCheckEvents = true;
            pause(500);
            doCheckEvents = false;
            if (!eventsCheckPassed) {
                testResult = -1;
                error("Test failed: stage #" + stageNum + ", action # " + actNum + ": " + msgCase + ": " + msgAction + ": after call " + msgFunc + ": " + msgEventsChecks[actNum]);
            }
        }
    }
