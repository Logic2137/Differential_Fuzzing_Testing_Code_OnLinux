...
class GoodOOS1 extends ObjectOutputStream {
    ...
    GoodOOS1(OutputStream out) throws IOException {
        super(out);
    }
}
...
class GoodOOS2 extends GoodOOS1 {
    ...
    GoodOOS2(OutputStream out) throws IOException {
        super(out);
    }
}
...
class BadOOS1 extends ObjectOutputStream {
    ...
    BadOOS1(OutputStream out) throws IOException {
        super(out);
    }
...
class BadOOS2 extends ObjectOutputStream {
    ...
    BadOOS2(OutputStream out) throws IOException {
        super(out);
    }
...
class BadOOS3 extends GoodOOS1 {
    ...
    BadOOS3(OutputStream out) throws IOException {
        super(out);
    }
...
class GoodOIS1 extends ObjectInputStream {
    ...
    GoodOIS1(InputStream in) throws IOException {
        super(in);
    }
}
...
class GoodOIS2 extends GoodOIS1 {
    ...
    GoodOIS2(InputStream in) throws IOException {
        super(in);
    }
}
...
class BadOIS1 extends ObjectInputStream {
    ...
    BadOIS1(InputStream in) throws IOException {
        super(in);
    }
...
class BadOIS2 extends ObjectInputStream {
    ...
    BadOIS2(InputStream in) throws IOException {
        super(in);
    }
...
class BadOIS3 extends GoodOIS1 {
    ...
    BadOIS3(InputStream in) throws IOException {
        super(in);
    }
