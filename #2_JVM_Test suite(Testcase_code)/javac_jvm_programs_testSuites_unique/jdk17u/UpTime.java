...
public class UpTime {
    ...
    private static final RuntimeMXBean metrics = ManagementFactory.getRuntimeMXBean();
    ...
    public static void main(String[] argv) throws Exception {
        ...
        if (testUptime > TIMEOUT * 60 * MULTIPLIER)
            throw new RuntimeException("Uptime of the JVM is more than 30 " + "minutes (" + (metricsStart / 60 / MULTIPLIER) + " minutes).");
        Object o = new Object();
        ...
        if (metricsDifference - systemDifferenceInner < -1)
            throw new RuntimeException("Flow of the time in " + "RuntimeMXBean.getUptime() (" + metricsDifference + ") is slower than " + " in system (" + systemDifferenceInner + ")");
        if (metricsDifference - systemDifferenceOuter > 1)
            throw new RuntimeException("Flow of the time in " + "RuntimeMXBean.getUptime() (" + metricsDifference + ") is faster than " + "in system (" + systemDifferenceOuter + ")");
