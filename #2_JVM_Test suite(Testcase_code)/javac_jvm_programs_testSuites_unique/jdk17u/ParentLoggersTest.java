...
public class ParentLoggersTest {
    ...
    private static boolean checkNames(List<String> expNames, List<String> retNames, String failMsg) {
    ...
    private static void printFailMsg(List<String> expNames, List<String> retNames, String failMsg) {
        out.println();
        out.println(failMsg);
        if (expNames.isEmpty()) {
