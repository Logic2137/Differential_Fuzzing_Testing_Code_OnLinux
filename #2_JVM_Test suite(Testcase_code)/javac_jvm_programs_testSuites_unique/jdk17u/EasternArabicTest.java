...
public class EasternArabicTest {
    ...
    static String[][] testData = { { "\u0623\u0643\u062a\u0648\u0628\u0631 10", "\u0623\u0643\u062a\u0648\u0628\u0631 \u06f1\u06f0" }, { "\u0b86\u0ba3\u0bcd\u0b9f\u0bc1 2009", "\u0b86\u0ba3\u0bcd\u0b9f\u0bc1 \u0be8\u0be6\u0be6\u0bef" }, { "\u1200 2009", "\u1200 \u136a00\u1371" } };

    public static void main(String[] args) {
        ns_old = getContextualShaper(TAMIL | ETHIOPIC | EASTERN_ARABIC | ARABIC | THAI | LAO, EUROPEAN);
        ns_new = getContextualShaper(EnumSet.of(Range.THAI, Range.TAMIL, Range.ETHIOPIC, Range.EASTERN_ARABIC, Range.ARABIC, Range.LAO), Range.EUROPEAN);
