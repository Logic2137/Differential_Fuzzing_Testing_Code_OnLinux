...
public class PlatformLoggingMXBeanTest {
    ...
    private void runTest(PlatformLoggingMXBean mBean) throws Exception {
        ...
        try {
            ...
            if (l.equals(l.ALL)) {
                ...
                throw new RuntimeException("Level Set to ALL but returned " + l.toString());
            }
            params = new Object[1];
            signature = new String[1];
            params[0] = LOGGER_NAME_2;
            ...
            if (l.equals(l.FINER)) {
                ...
                throw new RuntimeException("Level Set to FINER but returned " + l.toString());
            }
        } catch (Exception e) {
            throw e;
        }
    ...
    public static void main(String[] argv) throws Exception {
        PlatformLoggingMXBean mbean = ManagementFactory.getPlatformMXBean(PlatformLoggingMXBean.class);
