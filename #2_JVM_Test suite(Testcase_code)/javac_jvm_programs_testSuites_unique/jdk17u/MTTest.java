...
public class MTTest {
    ...
    public static void main(String[] args) {
        ...
        ns1 = getContextualShaper(EnumSet.of(Range.EASTERN_ARABIC, Range.THAI), Range.EUROPEAN);
        ns2 = getContextualShaper(EnumSet.of(Range.ARABIC, Range.THAI), Range.EUROPEAN);
