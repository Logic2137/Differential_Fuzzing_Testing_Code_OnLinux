...
public class DisposeDialogNotActivateOwnerTest {
    ...
    public static void main(String[] args) {
        DisposeDialogNotActivateOwnerTest test = new DisposeDialogNotActivateOwnerTest();
        test.performTest();
        test.dispose();
    }
    ...
    public void performTest() {
        ...
        if (!buttonReceivedFocus) {
            dispose();
            throw new RuntimeException("Test failed: Dialog activates invisible owner when disposed!");
        }
    }
