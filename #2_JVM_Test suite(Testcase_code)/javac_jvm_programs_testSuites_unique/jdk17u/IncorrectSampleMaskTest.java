...
public class IncorrectSampleMaskTest {
    ...
    private static AffineTransform at = AffineTransform.getScaleInstance(0.5, 0.5);

    private static RasterOp op = new AffineTransformOp(at, AffineTransformOp.TYPE_NEAREST_NEIGHBOR);
