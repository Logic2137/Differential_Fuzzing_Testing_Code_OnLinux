    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            if (!testPassed && testGeneratedInterrupt) {
                throw new RuntimeException("Page dialog not disposed." + " Page dialog is not associated with owner Frame`");
            }
        }
