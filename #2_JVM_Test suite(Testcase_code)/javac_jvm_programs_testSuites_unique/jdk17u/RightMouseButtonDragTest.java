...
public class RightMouseButtonDragTest implements AWTEventListener {
    ...
    public void init() {
        ...
        dragSource.createDefaultDragGestureRecognizer(frame, DnDConstants.ACTION_COPY_OR_MOVE, dragGestureListener);
    ...
    public void start() {
        try {
            ...
            for (; !srcPoint.equals(dstPoint); srcPoint.translate(sign(dstPoint.x - srcPoint.x), sign(dstPoint.y - srcPoint.y))) {
                robot.mouseMove(srcPoint.x, srcPoint.y);
                Thread.sleep(50);
            }
