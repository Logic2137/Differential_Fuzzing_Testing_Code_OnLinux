...
public class ConstrainedPrintingTest implements ActionListener {
    ...
    public void init() {
        ...
        String[] instructions = { "1.Look at the frame titled \"PrintTest\". If you see green or", "  red lines on the white area below the \"Print\" button, the", "  test fails. Otherwise go to step 2.", "2.Press \"Print\" button. The print dialog will appear. Select", "  a printer and proceed. Look at the output. If you see multiple", "  lines outside of the frame bounds or in the white area below", "  the image of the \"Print\" button, the test fails. Otherwise", "  the test passes." };
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        PrintJob pjob = frame.getToolkit().getPrintJob(frame, "NewTest", new JobAttributes(), pa);
        if (pjob != null) {
    ...
    public static void paintOutsideBounds(Component comp, Graphics g, Color color) {
