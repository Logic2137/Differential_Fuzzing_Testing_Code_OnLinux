...
public class ByteBuffersNull {
    ...
    ByteBuffer getByteBuffer(int capacity, int position, boolean limitAt0) {
    ...
    BufferDescr[] getByteBuffersForTest(int defaultSize) {
        ...
        buffers[0] = new BufferDescr("ByteBuffer with capacity == 0", getByteBuffer(0, 0, false));
        buffers[1] = new BufferDescr("ByteBuffer with some capacity but limit == 0", getByteBuffer(defaultSize, 0, true));
        buffers[2] = new BufferDescr("ByteBuffer with some data", getByteBuffer(defaultSize, 0, false));
        buffers[3] = new BufferDescr("ByteBuffer with data but position at the limit", getByteBuffer(defaultSize, defaultSize, false));
        return buffers;
    }
    ...
    public class CipherSpiImpl extends CipherSpi {
        ...
        public Key engineUnwrap(byte[] wKey, String wKeyAlgorithm, int wKeyType) throws InvalidKeyException, NoSuchAlgorithmException {
