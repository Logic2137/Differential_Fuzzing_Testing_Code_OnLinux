...
public class CheckModifiers {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        TestClass1 tc1 = new TestClass1(100, 25.56, 2000, new String("Test modifiers of serialPersistentFields"));
        TestClass2 tc2 = new TestClass2(100, 25.56, 2000, new String("Test modifiers of serialPersistentFields"));
        TestClass3 tc3 = new TestClass3(100, 25.56, 2000, new String("Test Type of serialPersistentFields"));
        TestClass4 tc4 = new TestClass4(100, 25.56, 2000, new String("Test modifiers of serialPersistentFields"));
