public class T6215213 {
    ...
    <T extends T6215213> Box1<T> testBox1(T t) {
        return null;
    }

    <T> Pair<T, T> testPair(T t) {
        return null;
    }

    <T extends T6215213> Pair1<T, T> testPair1(T t) {
        return null;
    }

    <T> Triple<T, T, T> testTriple(T t) {
        return null;
    }

    <T extends T6215213> Triple1<T, T, T> testTriple1(T t) {
        return null;
    }

    <T> Quad<T, T, T, T> testQuad(T t) {
        return null;
    }

    <T extends T6215213> Quad1<T, T, T, T> testQuad1(T t) {
        return null;
    }
