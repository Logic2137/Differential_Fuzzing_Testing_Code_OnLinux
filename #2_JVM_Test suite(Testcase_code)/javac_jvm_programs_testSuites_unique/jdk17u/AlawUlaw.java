...
public class AlawUlaw {
    ...
    public static final AudioFormat PCM_FORMAT_1 = new AudioFormat(AudioFormat.Encoding.PCM_SIGNED, 8000f, 16, 1, 2, 8000f, false);

    public static final AudioFormat PCM_FORMAT_2 = new AudioFormat(AudioFormat.Encoding.PCM_SIGNED, 8000f, 16, 1, 2, 8000f, true);

    public static final AudioFormat ULAW_FORMAT_1 = new AudioFormat(AudioFormat.Encoding.ULAW, 8000f, 8, 1, 1, 8000f, false);

    public static final AudioFormat ULAW_FORMAT_2 = new AudioFormat(AudioFormat.Encoding.ULAW, 8000f, 8, 1, 1, 8000f, true);

    public static final AudioFormat ALAW_FORMAT_1 = new AudioFormat(AudioFormat.Encoding.ALAW, 8000f, 8, 1, 1, 8000f, false);

    public static final AudioFormat ALAW_FORMAT_2 = new AudioFormat(AudioFormat.Encoding.ALAW, 8000f, 8, 1, 1, 8000f, true);
}
