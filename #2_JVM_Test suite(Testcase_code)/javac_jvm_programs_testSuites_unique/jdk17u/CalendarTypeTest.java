...
public class CalendarTypeTest {
    ...
    static Locale[] locales = new Locale[] { Locale.US, Locale.forLanguageTag("th-TH-u-ca-gregory"), new Locale("th", "TH"), Locale.forLanguageTag("en-US-u-ca-buddhist"), new Locale("ja", "JP", "JP"), Locale.forLanguageTag("en-US-u-ca-japanese") };

    static final String[] TYPES = new String[] { "gregory", "buddhist", "japanese" };

    static final String[] ALIASES = new String[] { "gregorian", "iso8601" };
