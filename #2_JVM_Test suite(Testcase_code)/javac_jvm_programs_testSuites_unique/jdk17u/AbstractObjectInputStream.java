...
public abstract class AbstractObjectInputStream extends ObjectInputStream {
    ...
    public AbstractObjectInputStream(InputStream in) throws IOException, StreamCorruptedException {
        this.in = in;
    }
    ...
    public abstract void defaultReadObject() throws IOException, ClassNotFoundException, NotActiveException;

    protected final native Object allocateNewObject(Class<?> ofClass, Class<?> ctorClass) throws InstantiationException, IllegalAccessException;

    protected final native Object allocateNewArray(Class<?> componentClass, int length) throws InstantiationException, IllegalAccessException;

    public abstract ObjectInputStream.GetField readFields() throws IOException, ClassNotFoundException, NotActiveException;
