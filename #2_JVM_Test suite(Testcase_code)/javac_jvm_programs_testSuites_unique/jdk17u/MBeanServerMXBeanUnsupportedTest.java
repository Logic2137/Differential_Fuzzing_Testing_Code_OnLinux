...
public class MBeanServerMXBeanUnsupportedTest {
    ...
    public static class MBeanServerForwarderInvocationHandler implements InvocationHandler {

        public static final HashSet<String> excludeList = new HashSet<String>(Arrays.asList("com.sun.management:type=DiagnosticCommand"));
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (methodName.equals("registerMBean")) {
                ...
                System.out.println("registerMBean: class=" + mbean.getClass().getName() + "\tname=" + name);
                Object result = method.invoke(mbs, args);
                if (domain.equals("java.lang") || domain.equals("java.util.logging") || domain.equals("com.sun.management")) {
                    if (!excludeList.contains(name.getCanonicalName())) {
                        String mxbean = (String) mbs.getMBeanInfo(name).getDescriptor().getFieldValue("mxbean");
                        if (mxbean == null || !mxbean.equals("true")) {
                            throw new RuntimeException("Platform MBeans must be MXBeans!");
                        }
                        if (!(mbean instanceof StandardMBean)) {
                            throw new RuntimeException("MXBeans must be wrapped in StandardMBean!");
                        }
                    }
                }
                return result;
    ...
    public static void main(String[] args) throws Exception {
        System.setProperty("javax.management.builder.initial", MBeanServerBuilderImpl.class.getName());
        try {
