...
public class UseLocaleWithProvider {
    ...
    public static void main(String[] args) {
        try {
            ...
            throw new RuntimeException("[FAILED: With" + " java.locale.providers=SPI,COMPAT, Scanner.useLocale()" + " shouldn't throw ClassCastException]");
        }
    }

    private static void testScannerUseLocale(String number, Locale locale, Number actual) {
