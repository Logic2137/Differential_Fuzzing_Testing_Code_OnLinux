...
public class TestParameterizedType {
    ...
    static List<Type> createTypes() throws Exception {
        ...
        String[] methodNames = { "genericMethod0", "genericMethod1", "genericMethod2", "genericMethod3", "genericMethod4", "genericMethod5", "genericMethod6", "genericMethod7", "genericMethod8", "genericMethod9" };
            ...
            for (int j = 0; j < take2.size(); j++) {
                ...
                if (i == j) {
                    if (!type1.equals(type2)) {
                        failed = true;
                        System.err.printf("Unexpected inequality: [%d, %d] %n\t%s%n\t%s%n", i, j, type1, type2);
                    }
                } else {
                    if (type1.equals(type2)) {
                        failed = true;
                        System.err.printf("Unexpected equality: [%d, %d] %n\t%s%n\t%s%n", i, j, type1, type2);
                    }
                }
            }
        }
