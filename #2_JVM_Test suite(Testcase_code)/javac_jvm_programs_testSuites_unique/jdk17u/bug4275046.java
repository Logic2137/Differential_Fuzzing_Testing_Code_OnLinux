...
public class bug4275046 {
    ...
    private static final Object[][] data = { { 1, "red", "abc" }, { 2, "red", "def" }, { 3, "red", "ghijk" } };
    ...
    private void runTest() throws Exception {
        ...
        robot.mouseMove(tableLoc.x + cellRect.x + cellRect.width / 2, tableLoc.y + cellRect.y + cellRect.height / 2);
    ...
    private void checkResult() throws Exception {
        ...
        if (!testResult) {
            throw new RuntimeException("Expected value in the cell: '" + EXPECTED_VALUE + "' but found '" + editedValue + "'.");
        }
    }
}
