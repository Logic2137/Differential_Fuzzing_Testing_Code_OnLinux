...
public class InheritanceBeanPropertyTest {
    ...
    public static class OverrideAbstractGet extends AbstractGet {
        ...
        private final static String TESTCASE = "override abstract annotated getter";
    ...
    public static class OverrideAbstractGet2 extends AbstractGet {
        ...
        private final static String TESTCASE = "override abstract annotated getter - 2";
    ...
    public abstract static class AbstractGetExt extends AbstractGet {
        ...
        private final static String TESTCASE = "extend abstract annotated getter";
    ...
    public static class OverrideAbstractIs extends AbstractIs {
        ...
        private final static String TESTCASE = "override abstract annotated is";
    ...
    public static class OverrideAbstractIs2 extends AbstractIs {
        ...
        private final static String TESTCASE = "override abstract annotated is - 2";
    ...
    public abstract static class AbstractIsExt extends AbstractIs {
        ...
        private final static String TESTCASE = "extend abstract annotated is";
    ...
    public static class OverrideAbstractSet extends AbstractSet {
        ...
        private final static String TESTCASE = "override abstract annotated setter";
    ...
    public static class OverrideAbstractSet2 extends AbstractSet {
        ...
        private final static String TESTCASE = "override abstract annotated setter - 2";
    ...
    public abstract static class AbstractSetExt extends AbstractSet {
        ...
        private final static String TESTCASE = "extend abstract annotated setter";
    ...
    private static boolean checkDefault(BeanInfo i) {
        ...
        if (!ok) {
            System.out.println("invalid description: " + descr + ", expected: x");
        }
        ...
        ok &= check("visualUpdate", (boolean) d.getValue("visualUpdate"), false);
        Object[] vals = (Object[]) d.getValue("enumerationValues");
