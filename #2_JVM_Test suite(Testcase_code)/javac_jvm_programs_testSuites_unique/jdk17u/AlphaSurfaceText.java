...
public class AlphaSurfaceText {
    ...
    public AlphaSurfaceText(int biType, Color c) {
        BufferedImage opaquebi0 = new BufferedImage(wid, hgt, BufferedImage.TYPE_INT_RGB);
        drawText(opaquebi0, c);
        BufferedImage alphabi = new BufferedImage(wid, hgt, biType);
        drawText(alphabi, c);
        BufferedImage opaquebi1 = new BufferedImage(wid, hgt, BufferedImage.TYPE_INT_RGB);
