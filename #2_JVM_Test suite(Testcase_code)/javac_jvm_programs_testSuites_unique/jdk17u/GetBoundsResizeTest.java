...
public class GetBoundsResizeTest extends Applet {
    ...
    public void start() {
        String[] message = { "Resize the window using the upper left corner.", "Press the button to print the result of getBounds() to the terminal.", "If getBounds() prints the correct values for the window", "then click Pass, else click Fail." };
