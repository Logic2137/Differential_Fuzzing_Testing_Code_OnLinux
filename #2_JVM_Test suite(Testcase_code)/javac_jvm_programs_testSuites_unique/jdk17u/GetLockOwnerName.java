...
public class GetLockOwnerName {
    ...
    public int doWork(int timeMax, PrintStream out) {
        ...
        while (System.currentTimeMillis() < start_time + (timeMax * 1000)) {
            ...
            if (retCode != 0) {
                throw new RuntimeException("error in JVMTI GetThreadState " + "or GetCurrentContendedMonitor " + "retCode=" + retCode);
            }
            ...
            if (name == null) {
                ...
                throw new RuntimeException("ThreadInfo.GetLockOwnerName() " + "returned null name for " + "contender.");
            } else if (!name.equals("blocker")) {
                out.println("Failure at " + count + " loops.");
                throw new RuntimeException("name='" + name + "': name " + "should be blocker.");
            } else {
            ...
            logDebug("made " + lateCount + " late calls to getThreadInfo() " + "and info.getLockOwnerName().");
            try {
