...
public class ISO8601ZoneTest {
    ...
    static final String[][] formatData = { { "America/Los_Angeles", "2010-09-06T00:27:19.020-07" }, { "America/Los_Angeles", "2010-09-06T00:27:19.020-0700" }, { "America/Los_Angeles", "2010-09-06T00:27:19.020-07:00" }, { "Australia/Sydney", "2010-09-06T17:27:19.020+10" }, { "Australia/Sydney", "2010-09-06T17:27:19.020+1000" }, { "Australia/Sydney", "2010-09-06T17:27:19.020+10:00" }, { "GMT-07:00", "2010-09-06T00:27:19.020-07" }, { "GMT-07:00", "2010-09-06T00:27:19.020-0700" }, { "GMT-07:00", "2010-09-06T00:27:19.020-07:00" }, { "UTC", "2010-09-06T07:27:19.020Z" }, { "UTC", "2010-09-06T07:27:19.020Z" }, { "UTC", "2010-09-06T07:27:19.020Z" } };

    static final String[] zones = { "America/Los_Angeles", "Australia/Sydney", "GMT-07:00", "UTC", "GMT+05:30", "GMT-01:23" };

    static final String[] isoZoneFormats = { "yyyy-MM-dd'T'HH:mm:ss.SSSX", "yyyy-MM-dd'T'HH:mm:ss.SSSXX", "yyyy-MM-dd'T'HH:mm:ss.SSSXXX" };

    static final String[][] badData = { { "X", "1", "1" }, { "X", "+1", "+1" }, { "X", "-2", "-2" }, { "X", "-24", "-2" }, { "X", "+24", "+2" }, { "XX", "9", "9" }, { "XX", "23", "2" }, { "XX", "234", "2" }, { "XX", "3456", "3" }, { "XX", "23456", "2" }, { "XX", "+1", "+1" }, { "XX", "-12", "-12" }, { "XX", "+123", "+123" }, { "XX", "-12:34", "-12" }, { "XX", "+12:34", "+12" }, { "XX", "-2423", "-2" }, { "XX", "+2423", "+2" }, { "XX", "-1260", "-126" }, { "XX", "+1260", "+126" }, { "XXX", "9", "9" }, { "XXX", "23", "2" }, { "XXX", "234", "2" }, { "XXX", "3456", "3" }, { "XXX", "23456", "2" }, { "XXX", "2:34", "2" }, { "XXX", "12:4", "1" }, { "XXX", "12:34", "1" }, { "XXX", "-1", "-1" }, { "XXX", "+1", "+1" }, { "XXX", "-12", "-12" }, { "XXX", "+12", "+12" }, { "XXX", "-123", "-12" }, { "XXX", "+123", "+12" }, { "XXX", "-1234", "-12" }, { "XXX", "+1234", "+12" }, { "XXX", "+24:23", "+2" }, { "XXX", "+12:60", "+12:6" }, { "XXX", "+1:23", "+1" }, { "XXX", "+12:3", "+12:3" } };

    static String[] badFormats = { "XXXX", "XXXXX", "XXXXXX" };
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            for (int i = 0; i < formatData.length; i++) {
                ...
                formatTest(isoZoneFormats[i % isoZoneFormats.length], formatData[i][1]);
            }
