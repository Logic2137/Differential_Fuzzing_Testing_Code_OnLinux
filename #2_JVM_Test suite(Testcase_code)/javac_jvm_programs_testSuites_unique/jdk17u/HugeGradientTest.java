...
public class HugeGradientTest extends Frame {
    ...
    public HugeGradientTest() {
        Image dstImg = getGraphicsConfiguration().createCompatibleVolatileImage(30, 30);
        Graphics2D g = (Graphics2D) dstImg.getGraphics();
        g.setPaint(new LinearGradientPaint(0f, Short.MAX_VALUE, 0f, Short.MAX_VALUE + 31, new float[] { 0f, 1f }, new Color[] { Color.BLACK, Color.RED }));
        g.translate(0, -Short.MAX_VALUE);
        g.fillRect(0, 0, Short.MAX_VALUE * 2, Short.MAX_VALUE * 2);
        BufferedImage readBackImg = new BufferedImage(dstImg.getWidth(null), dstImg.getHeight(null), BufferedImage.TYPE_INT_RGB);
