...
public class MXBeanPreRegisterTest {
    ...
    public static void main(String[] args) throws Exception {
        for (boolean mx : new boolean[] { false, true }) for (boolean wrapped : new boolean[] { false, true }) test(mx, wrapped);
        if (failure != null)
    ...
    private static void test(boolean mx, boolean wrapped) throws Exception {
        ...
        String testDescr = (mx ? "MXBean" : "Standard MBean") + (wrapped ? " wrapped in StandardMBean class should not" : " should") + " call MBeanRegistration methods";
