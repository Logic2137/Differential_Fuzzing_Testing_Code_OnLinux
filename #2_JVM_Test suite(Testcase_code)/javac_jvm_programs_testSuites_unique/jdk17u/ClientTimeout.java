...
public class ClientTimeout {
    ...
    void doClientSide() throws Exception {
        ...
        SSLSocket sslSocket = (SSLSocket) sslsf.createSocket(baseSocket, "localhost", serverPort, true);
        InputStream sslIS = sslSocket.getInputStream();
        OutputStream sslOS = sslSocket.getOutputStream();
        ...
        while (true) {
            try {
                ...
                System.out.println("Handshaker exception: " + e.getMessage());
            }
        }
        MessageDigest md = MessageDigest.getInstance("SHA");
    ...
    static class MyInputStream extends InputStream {
        ...
        public int read(byte[] data, int offset, int len) throws IOException {
            if (!ClientTimeout.rhythm) {
                throw new SocketTimeoutException("Throwing a timeout exception");
            }
