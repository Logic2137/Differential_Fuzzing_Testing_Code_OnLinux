...
public class EnclosingMethodTests {
    ...
    public static void main(String[] argv) {
        ...
        ;
        failures += examine(StaticLocal.class, "public static void EnclosingMethodTests.main(java.lang.String[])");
        failures += examine((new EnclosingMethodTests()).getLocalClass(null), "java.lang.Class EnclosingMethodTests.getLocalClass(Object o)");
