    ...
    static int test() {
        ...
        int errn = 0;
        {
            ...
            for (int i = 0; i < ARRLEN / 4; i++) {
                errn += verify("test_pack4: ", i, p4[i], ((long) (ADD_INIT + 4 * i + 0) & 0xFFFFl) | (((long) (ADD_INIT + 4 * i + 1) & 0xFFFFl) << 16) | (((long) (ADD_INIT + 4 * i + 2) & 0xFFFFl) << 32) | (((long) (ADD_INIT + 4 * i + 3) & 0xFFFFl) << 48));
            }
            for (int i = 0; i < ARRLEN; i++) {
                a0[i] = (char) -1;
            }
            ...
            test_pack4_swap(p4, a1);
            for (int i = 0; i < ARRLEN / 4; i++) {
                errn += verify("test_pack4_swap: ", i, p4[i], ((long) (ADD_INIT + 4 * i + 3) & 0xFFFFl) | (((long) (ADD_INIT + 4 * i + 2) & 0xFFFFl) << 16) | (((long) (ADD_INIT + 4 * i + 1) & 0xFFFFl) << 32) | (((long) (ADD_INIT + 4 * i + 0) & 0xFFFFl) << 48));
            }
            for (int i = 0; i < ARRLEN; i++) {
                a0[i] = (char) -1;
            }
