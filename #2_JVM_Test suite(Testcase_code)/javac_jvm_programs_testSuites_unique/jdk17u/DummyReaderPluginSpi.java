...
public class DummyReaderPluginSpi extends ImageReaderSpi {
    ...
    private static String[] writerSpiNames = { "DummyWriterPluginSpi" };
    ...
    public DummyReaderPluginSpi() {
        super("Sun Microsystems, Inc.", "1.0", formatNames, entensions, mimeType, "DummyPluginReader", STANDARD_INPUT_TYPE, writerSpiNames, false, null, null, null, null, false, "", "", null, null);
    }
