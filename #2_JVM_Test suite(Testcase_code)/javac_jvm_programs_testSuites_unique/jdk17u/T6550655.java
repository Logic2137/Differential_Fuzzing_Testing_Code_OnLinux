...
public class T6550655 {
    ...
    class DiagnosticChecker implements DiagnosticListener<JavaFileObject> {
        ...
        String[][] expectedKeys = new String[][] { { "compiler.err.cant.resolve.location", "compiler.warn.unknown.enum.constant" }, { "compiler.err.cant.resolve.location.args", "compiler.warn.annotation.method.not.found" }, { "compiler.err.cant.resolve", "compiler.warn.unknown.enum.constant.reason" } };
        ...
        public void report(Diagnostic<? extends JavaFileObject> diagnostic) {
            ...
            if (!diagnostic.getCode().equals(keyToIgnore) && !diagnostic.getCode().equals(expectedCode)) {
    ...
    enum TestKind {
        ...
        DIRECT("@I(val = E.NORTH)class C1 {}"), INDIRECT("class C2 { A a; }");
