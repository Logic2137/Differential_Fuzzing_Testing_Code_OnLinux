            ...
            try {
                ...
                SwingUtilities.invokeAndWait(() -> {
                    ...
                    if (!opaqueValue.equals(" ")) {
                        throw new RuntimeException("Default value of " + "\"opaque\" property for " + opaqueValue + " is changed ");
                    }
                    ...
                    if (!opaqueValue.equals(" ")) {
                        throw new RuntimeException("setUIProperty failed to clear " + opaqueValue + " opaque" + " when opaque is not set by client");
                    }
                    list.setOpaque(true);
                    ...
                    if (!opaqueValue.equals(" ")) {
                        throw new RuntimeException("" + "setUIProperty cleared the " + opaqueValue + " Opaque when opaque is set by client");
                    }
                });
