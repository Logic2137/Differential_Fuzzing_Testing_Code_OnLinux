...
public class BroadcasterSupportDeadlockTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread t1 = new Thread() {
            ...
            public void run() {
                try {
                    mbs.invoke(name, "block", new Object[] { semaphore }, new String[] { Semaphore.class.getName() });
                } catch (Exception e) {
        ...
        semaphore.acquire();
        Thread.sleep(100);
        while (t1.getState() != Thread.State.WAITING) Thread.sleep(1);
    ...
    private static void showStackTrace(String title, StackTraceElement[] stack) {
    ...
    public static class Broadcaster extends NotificationBroadcasterSupport implements BroadcasterMBean {
