...
public class ResolvedMethodTableHash extends ClassLoader {
    ...
    private int writeClass(byte[] buf, String className) {
        return ByteBuffer.wrap(buf).putInt(0xCAFEBABE).putInt(50).putShort((short) 7).put((byte) 7).putShort((short) 2).put((byte) 1).putShort((short) className.length()).put(className.getBytes()).put((byte) 7).putShort((short) 4).put((byte) 1).putShort((short) 16).put("java/lang/Object".getBytes()).put((byte) 1).putShort((short) 1).put("m".getBytes()).put((byte) 1).putShort((short) 3).put("()V".getBytes()).putShort((short) 0x21).putShort((short) 1).putShort((short) 3).putShort((short) 0).putShort((short) 0).putShort((short) 1).putShort((short) 0x109).putShort((short) 5).putShort((short) 6).putShort((short) 0).putShort((short) 0).position();
    }
