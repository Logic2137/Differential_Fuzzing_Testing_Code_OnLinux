...
public class OcspUnauthorized {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            if (cpve.getReason() != BasicReason.UNSPECIFIED && !cpve.getMessage().contains("OCSP response error: UNAUTHORIZED")) {
                throw new Exception("FAILED: unexpected " + "CertPathValidatorException reason");
            }
        }
    }
