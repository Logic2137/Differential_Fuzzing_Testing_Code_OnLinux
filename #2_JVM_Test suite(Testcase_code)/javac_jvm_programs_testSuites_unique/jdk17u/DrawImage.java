...
public class DrawImage {
    ...
    public static void main(String[] args) {
        String[] instructions = { "You must have a printer available to perform this test.", "The test passes if you get a printout of a gray rectangle", "with white text without any exception." };
        Sysout.createDialog();
