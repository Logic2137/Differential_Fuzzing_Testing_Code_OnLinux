...
public class ProxyObjectMethodsTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SimpleMBean simple0 = MBeanServerInvocationHandler.newProxyInstance(client.getMBeanServerConnection(), name, SimpleMBean.class, false);
        SimpleMBean simple1 = MBeanServerInvocationHandler.newProxyInstance(client.getMBeanServerConnection(), name, SimpleMBean.class, false);
        Simplest simple3 = MBeanServerInvocationHandler.newProxyInstance(client.getMBeanServerConnection(), name, Simplest.class, false);
        if (!simple0.equals(simple1) || simple0.equals(simple) || simple0.equals(simple3)) {
            throw new RuntimeException("The method equals does not work correctly.");
        }
        if (simple0.hashCode() != simple1.hashCode() || simple.hashCode() == simple0.hashCode()) {
            throw new RuntimeException("The method hashCode does not work correctly.");
        }
        if (!simple0.toString().equals(simple1.toString()) || simple.toString().equals(simple0.toString())) {
        ...
        TestMBean test0 = MBeanServerInvocationHandler.newProxyInstance(mbs, name1, TestMBean.class, false);
        ...
        SimpleMBean simple2;
        try {
            simple2 = MBeanServerInvocationHandler.newProxyInstance(null, name, SimpleMBean.class, false);
            throw new RuntimeException("Null connection does not cause an IllegalArgumentException.");
        } catch (IllegalArgumentException ie) {
        }
        try {
            simple2 = MBeanServerInvocationHandler.newProxyInstance(mbs, null, SimpleMBean.class, false);
            throw new RuntimeException("Null object name does not cause an IllegalArgumentException.");
        } catch (IllegalArgumentException ie) {
        }
    }
