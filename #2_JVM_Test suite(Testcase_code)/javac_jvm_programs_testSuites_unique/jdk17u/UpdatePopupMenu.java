...
public class UpdatePopupMenu implements ActionListener {
    ...
    private Image createSystemTrayIconImage() {
        final BufferedImage trayImage = new BufferedImage(imageSize, imageSize, BufferedImage.TYPE_INT_ARGB);
        ...
        imageGraphics.fillRect(0, 0, trayImage.getWidth(), trayImage.getHeight());
    ...
    public static void main(final String[] args) throws Exception {
        if (SystemTray.isSupported()) {
            ...
            try {
                ...
                if (!testPassed) {
                    throw new RuntimeException("Updating TrayIcon popup menu" + " items FAILED");
                }
            } finally {
                cleanUp();
            }
