...
public class DESCipherWrapper {
    ...
    public DESCipherWrapper(String algo, String mode, String pad) throws NoSuchAlgorithmException, NoSuchPaddingException {
        ...
        key = kg.generateKey();
        keyStrength = algo.equalsIgnoreCase("DESede") ? 112 : key.getEncoded().length * 8;
        this.algo = algo;
        this.mode = mode;
        this.pad = pad;
    }
