...
public class CursorOverlappedPanelsTest extends JApplet {
    ...
    public void init() {
        ...
        String[] instructions = { "Verify that the Crosshair cursor from enabled panel" + " is displayed on the panels intersection", "1) Move the mosue cursor on the Enabled and Disabled panels" + " intersection", "2) Check that the Crosshair cursor is displayed ", "If so, press PASS, else press FAIL." };
