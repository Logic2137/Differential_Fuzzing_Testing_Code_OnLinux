...
public class RacingCows {
    ...
    private static void realMain(String[] args) throws Throwable {
        ...
        s1.add(1);
        final Thread t1 = new CheckedThread() {
        ...
        l1.add(1);
        final Thread t2 = new CheckedThread() {
        ...
        t2.start();
        final Thread t3 = new CheckedThread() {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            check(!l2.equals(l1));
            try {
                new CopyOnWriteArrayList<Integer>(l2);
            } catch (Throwable t) {
                unexpected(t);
            }
            try {
                new CopyOnWriteArrayList<Integer>().addAllAbsent(l3);
            } catch (Throwable t) {
                unexpected(t);
            }
            try {
                new CopyOnWriteArrayList<Integer>().addAll(l3);
            } catch (Throwable t) {
                unexpected(t);
            }
            try {
                new CopyOnWriteArrayList<Integer>().addAll(0, l3);
            } catch (Throwable t) {
                unexpected(t);
            }
        }
