...
public class SuspendWithCurrentThread {
    ...
    private ThreadToSuspend[] startTestedThreads(int threadsCount) throws RuntimeException {
        ...
        for (int i = 0; i < threads.length; i++) {
            threads[i] = new ThreadToSuspend("ThreadToSuspend#" + i, i == suspenderIndex);
        }
    ...
    private void run() throws Exception {
        ...
        try {
            ...
            log("Main: trigger " + threads[suspenderIndex].getName() + " to suspend all tested threads including itself");
