...
public class AdaptServerSocket {
    ...
    static void startClient(final int port, final int dally) throws Exception {
        Thread t = new Thread() {
    ...
    static void test(int clientDally, int timeout, boolean shouldTimeout) throws Exception {
