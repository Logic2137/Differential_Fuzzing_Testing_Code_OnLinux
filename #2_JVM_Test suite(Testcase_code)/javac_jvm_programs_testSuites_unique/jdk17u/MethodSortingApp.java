...
public class MethodSortingApp {
    ...
    static interface InterfaceA {
        ...
        default public String aaa() {
            return "aaa";
        }

        default public String bbb() {
            return "bbb";
        }

        default public String ddd() {
            return "ddd";
        }

        default public String eee() {
            return "eee";
        }

        default public String ggg() {
            return "ggg";
        }
    }
