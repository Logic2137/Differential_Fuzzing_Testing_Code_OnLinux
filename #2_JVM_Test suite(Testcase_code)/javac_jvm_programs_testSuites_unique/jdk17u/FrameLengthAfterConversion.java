...
public final class FrameLengthAfterConversion {
    ...
    private static void testAfterSaveToStream(final AudioFileWriter afw, final AudioFileFormat.Type type, final AudioInputStream ais) throws IOException {
        try {
        ...
        } catch (IllegalArgumentException | UnsupportedAudioFileException ignored) {
        }
    }

    private static void testAfterSaveToFile(final AudioFileWriter afw, final AudioFileFormat.Type type, AudioInputStream ais) throws IOException {
    ...
    private static void testAfterConversion(final FormatConversionProvider fcp, final AudioFormat to, final AudioInputStream ais) {
