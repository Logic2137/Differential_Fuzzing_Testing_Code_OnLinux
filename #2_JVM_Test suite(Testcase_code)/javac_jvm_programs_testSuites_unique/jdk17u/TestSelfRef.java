...
public class TestSelfRef {
    ...
    enum RefKind {
        ...
        SELF_LAMBDA("SAM s = x->{ System.out.println(s); };", true, false), FORWARD_LAMBDA("SAM s = x->{ System.out.println(f); };\nObject f = null;", false, true), SELF_ANON("Object s = new Object() { void test() { System.out.println(s); } };", true, false), FORWARD_ANON("Object s = new Object() { void test() { System.out.println(f); } }; Object f = null;", false, true);
    ...
    enum EnclosingKind {
        ...
        TOPLEVEL("class C { #S }"), MEMBER_INNER("class Outer { class C { #S } }"), NESTED_INNER("class Outer { static class C { #S } }");
    ...
    enum InnerKind {
        ...
        NONE("#R"), LOCAL_NONE("class Local { #R }"), LOCAL_MTH("class Local { void test() { #R } }"), ANON_NONE("new Object() { #R };"), ANON_MTH("new Object() { void test() { #R } };");
    ...
    enum SiteKind {
        ...
        NONE("#I"), STATIC_INIT("static { #I }"), INSTANCE_INIT("{ #I }"), CONSTRUCTOR("C() { #I }"), METHOD("void test() { #I }");
    ...
    class JavaSource extends SimpleJavaFileObject {
        ...
        public JavaSource() {
            ...
            source = bodyTemplate.replace("#B", ek.enclStr.replace("#S", sk.siteStr.replace("#I", ik.innerStr.replace("#R", rk.refStr))));
        }
