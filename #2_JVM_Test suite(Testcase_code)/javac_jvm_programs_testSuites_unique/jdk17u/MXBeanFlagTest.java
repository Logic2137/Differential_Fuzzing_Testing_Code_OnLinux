...
public class MXBeanFlagTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        StandardMBean compliant2 = new StandardMBean(new Compliant2(), Compliant2MXBean.class, true);
        Compliant3 compliant3 = new Compliant3();
        StandardMBean compliant4 = new StandardMBean(new Compliant4(), Compliant4MBean.class, false);
        ...
        String flag1 = (String) mbs.getMBeanInfo(on1).getDescriptor().getFieldValue("mxbean");
        String flag2 = (String) mbs.getMBeanInfo(on2).getDescriptor().getFieldValue("mxbean");
        String flag3 = (String) mbs.getMBeanInfo(on3).getDescriptor().getFieldValue("mxbean");
        String flag4 = (String) mbs.getMBeanInfo(on4).getDescriptor().getFieldValue("mxbean");
        ...
        if (flag1 != null && flag1.equals("true") && flag2 != null && flag2.equals("true") && flag3 != null && flag3.equals("false") && flag4 != null && flag4.equals("false"))
