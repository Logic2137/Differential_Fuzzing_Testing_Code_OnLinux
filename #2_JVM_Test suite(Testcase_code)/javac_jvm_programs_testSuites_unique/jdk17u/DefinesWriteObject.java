...
public class DefinesWriteObject implements Externalizable {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ois.close();
        if (obj1.intData != readObject1.intData || obj2.intData != readObject2.intData) {
            throw new Error("Unexpected mismatch between integer data written and read.");
        }
        if (!((String) obj1.objData).equals((String) readObject1.objData) || !((String) obj2.objData).equals((String) readObject2.objData)) {
