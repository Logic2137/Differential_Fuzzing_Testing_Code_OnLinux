...
public class bug8037575 {
    ...
    private static void init() throws Exception {
        SwingUtilities.invokeAndWait(new Runnable() {
            ...
            @Override
            public void run() {
                String[] instructions = { "1) You see a dialog with buttons and text area.", "2) Pressing Run button will start test. A new Frame will open automatically" + " and minimize after 2 seconds.", "3) Frame should minimize gradually with animation effect.", "4) If frame disappers without animation then test " + "failed otherwise passed.", "5) Pressing Pass/Fail button will mark test as " + "pass/fail and will shutdown JVM as well" };
