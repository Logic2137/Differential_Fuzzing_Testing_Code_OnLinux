...
public class ECDSAJavaVerify {
    ...
    static final String[] ALL_ALGS = new String[] { "SHA1withECDSA", "SHA256withECDSA", "SHA384withECDSA", "SHA512withECDSA" };

    static final String[] ALL_CURVES = new String[] { "secp256r1", "secp384r1", "secp521r1" };
    ...
    static void debug() throws Exception {
        ...
        arguments.get("options").setValue("-cp " + System.getProperty("test.classes"));
        ...
        if (pos != numberOfTests - 1 || sResult.contains("x") || sResult.contains(".")) {
    ...
    static class Test {
        ...
        public boolean run(int seed, String sigAlg, String curve) throws Exception {
            ...
            if (rand.nextInt(10) < 8) {
                sig[rand.nextInt(10000) % sig.length] = (byte) rand.nextInt(10000);
            } else {
            ...
            System.out.printf("%10d %20s %20s -- %5s %5s -- %s\n", seed, sigAlg, curve, result1, result2, finalResult ? "succeed" : "fail");
            return finalResult;
        }
    }
}
