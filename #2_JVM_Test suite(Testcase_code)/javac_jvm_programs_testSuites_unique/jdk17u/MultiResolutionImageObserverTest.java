...
public class MultiResolutionImageObserverTest {
    ...
    private static void waitForImageLoading(LoadImageObserver observer, String errorMessage) throws Exception {
    ...
    private static void generateImage(int scale) throws Exception {
        BufferedImage image = new BufferedImage(scale * 200, scale * 300, BufferedImage.TYPE_INT_RGB);
