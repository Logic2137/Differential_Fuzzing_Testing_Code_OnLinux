...
public class ConstructFlavoredObjectTest {
    ...
    public static void main(String[] args) throws Exception {
        if (args[0].equals("COPY")) {
            final String TEXT_MIME_TYPE = DataFlavor.javaJVMLocalObjectMimeType + ";class=" + String.class.getName();
            ...
            transferHandler.exportToClipboard(new JLabel(text), clipboard, TransferHandler.COPY);
        } else if (args[0].equals("PASTE")) {
            final String TEST_MIME_TYPE = "text/plain;class=" + MyStringReader.class.getName();
