...
public class Test4353056 implements PropertyChangeListener {
    ...
    public void setColor(int index, Color color) {
        ...
        this.index = index;
        this.name = COLOR;
        this.pcs.fireIndexedPropertyChange(COLOR, index, oldColor, color);
    }
    ...
    public void setBoolean(int index, boolean flag) {
        ...
        this.index = index;
        this.name = BOOLEAN;
        this.pcs.fireIndexedPropertyChange(BOOLEAN, index, oldBool, flag);
    }
    ...
    public void setInteger(int index, int value) {
        ...
        this.index = index;
        this.name = INTEGER;
        this.pcs.fireIndexedPropertyChange(INTEGER, index, oldInt, value);
    }
