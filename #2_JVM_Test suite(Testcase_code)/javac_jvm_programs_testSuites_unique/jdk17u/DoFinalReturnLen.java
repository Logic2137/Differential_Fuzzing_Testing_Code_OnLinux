...
public class DoFinalReturnLen {
    ...
    static byte[] dataToEncrypt = { (byte) 0x02, (byte) 0xA4, (byte) 0x20, (byte) 0x87, (byte) 0xB6, (byte) 0xC4, (byte) 0x54, (byte) 0x89, (byte) 0xA2, (byte) 0xA4, (byte) 0x10, (byte) 0x87, (byte) 0xCD, (byte) 0x76, (byte) 0x43, (byte) 0xF0, (byte) 0x72, (byte) 0xA4, (byte) 0xA0, (byte) 0x82, (byte) 0x26, (byte) 0xC4, (byte) 0x54, (byte) 0x19, (byte) 0x09, (byte) 0xAC, (byte) 0x2A, (byte) 0xE7, (byte) 0x1D, (byte) 0x74, (byte) 0x13, (byte) 0x20, (byte) 0xAD, (byte) 0xD4, (byte) 0xD0, (byte) 0x87, (byte) 0xB6, (byte) 0xC5, (byte) 0x24, (byte) 0x89, (byte) 0x02, (byte) 0xF4, (byte) 0x90, (byte) 0x8E, (byte) 0x5D, (byte) 0x76, (byte) 0x43, (byte) 0x2F, (byte) 0x03, (byte) 0xAD, (byte) 0x20, (byte) 0x8C, (byte) 0xB5, (byte) 0xC4, (byte) 0xA4, (byte) 0x39, (byte) 0xD2, (byte) 0xA4, (byte) 0xE0, (byte) 0x87, (byte) 0xCD, (byte) 0x56, (byte) 0x53, (byte) 0x20 };

    static byte[] dataToEncryptUneven = { (byte) 0x02, (byte) 0xA4, (byte) 0x20, (byte) 0x87, (byte) 0xB6, (byte) 0xC4, (byte) 0x54, (byte) 0x89, (byte) 0xA2, (byte) 0xA4, (byte) 0x10, (byte) 0x87, (byte) 0xCD, (byte) 0x76, (byte) 0x43, (byte) 0xF0, (byte) 0x72, (byte) 0xA4, (byte) 0xA0, (byte) 0x82, (byte) 0x26, (byte) 0xC4, (byte) 0x54, (byte) 0x19, (byte) 0x09, (byte) 0xAC, (byte) 0x2A, (byte) 0xE7, (byte) 0x1D, (byte) 0x74, (byte) 0x13, (byte) 0x20, (byte) 0xAD, (byte) 0xD4, (byte) 0xD0, (byte) 0x87, (byte) 0xB6, (byte) 0xC5, (byte) 0x24, (byte) 0x89, (byte) 0x02, (byte) 0xF4, (byte) 0x90, (byte) 0x8E, (byte) 0x5D, (byte) 0x76, (byte) 0x43, (byte) 0x2F, (byte) 0x03, (byte) 0xAD, (byte) 0x20, (byte) 0x8C, (byte) 0xB5, (byte) 0xC4, (byte) 0xA4, (byte) 0x39, (byte) 0xD2, (byte) 0xA4, (byte) 0xE0, (byte) 0x87, (byte) 0xCD, (byte) 0x56, (byte) 0x53, (byte) 0x20, (byte) 0x22 };

    static byte[] iv = { (byte) 0x03, (byte) 0xAD, (byte) 0x20, (byte) 0x8C, (byte) 0xB5, (byte) 0xC4, (byte) 0xA4, (byte) 0x39 };
    ...
    public static void main(String[] args) throws Exception {
        ...
        newDES = Cipher.getInstance("DES/CBC/PKCS5Padding", "SunJCE");
        byte[] keyData = { (byte) 0x46, (byte) 0x19, (byte) 0x20, (byte) 0x5e, (byte) 0xef, (byte) 0x0b, (byte) 0x7c, (byte) 0x45 };
        SecretKeyFactory desFactory = SecretKeyFactory.getInstance("DES", "SunJCE");
        ...
        encryptedData = new byte[newDES.getOutputSize(dataToEncrypt.length)];
        int outputLenUpdate = newDES.update(dataToEncrypt, 0, dataToEncrypt.length, encryptedData);
        int outputLenFinal = newDES.doFinal(encryptedData, outputLenUpdate);
        System.out.println("ENCRYPT : Update " + outputLenUpdate + " bytes");
        System.out.println("ENCRYPT : Final " + outputLenFinal + " bytes");
        System.out.println("Encrypted data:");
        printBuffer(encryptedData);
        newDES.init(Cipher.DECRYPT_MODE, sKey, IvParamSpec);
        decryptedData = new byte[newDES.getOutputSize(encryptedData.length)];
        System.out.println("encrLen: " + encryptedData.length);
        System.out.println("decrLen: " + decryptedData.length);
        outputLenUpdate = newDES.update(encryptedData, 0, encryptedData.length, decryptedData, 0);
        outputLenFinal = newDES.doFinal(decryptedData, outputLenUpdate);
        System.out.println("DECRYPT : Update " + outputLenUpdate + " bytes");
        System.out.println("DECRYPT : Final " + outputLenFinal + " bytes");
        ...
        for (int i = 0; i < len; i++) if (dataToEncrypt[i] != decryptedData[i])
        ...
        newDES.init(Cipher.ENCRYPT_MODE, sKey, IvParamSpec);
        encryptedData = new byte[newDES.getOutputSize(dataToEncryptUneven.length)];
        outputLenUpdate = newDES.update(dataToEncryptUneven, 0, dataToEncryptUneven.length, encryptedData);
        outputLenFinal = newDES.doFinal(encryptedData, outputLenUpdate);
        System.out.println("ENCRYPT : Update " + outputLenUpdate + " bytes");
        System.out.println("ENCRYPT : Final " + outputLenFinal + " bytes");
        System.out.println("Encrypted data:");
        printBuffer(encryptedData);
        ...
        for (int i = 0; i < len; i++) if (dataToEncryptUneven[i] != decryptedData[i])
            throw new Exception("Original and recovered data differ");
        newDES.init(Cipher.DECRYPT_MODE, sKey, IvParamSpec);
