...
public class EscapeUnescapeTests {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < valids.length; i++) {
            ...
            System.out.println("Orig val: " + valids[i] + "       Unescaped val: " + unescVal);
        }
        ...
        for (int i = 0; i < invalids.length; i++) {
            ...
            if (!isExcepThrown) {
                throw new Exception("Unescaped successfully an invalid string " + val + " as Rdn: " + unescVal);
            }
            isExcepThrown = false;
        }
        ...
        System.out.println("Orig val: " + bytes + "       Escaped val: " + escVal);
    }
