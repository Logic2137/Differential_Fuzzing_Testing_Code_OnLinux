...
public class CheckHistoricalNames {
    ...
    private static void checkMappedName(String alias, String canonical) throws Exception {
    ...
    private static void checkCharsetAndHistoricalName() {
        for (Charset cs : Charset.availableCharsets().values()) {
            ...
            try {
                ...
                if (!cs.equals(csHist)) {
                    System.out.println("Failed charset name" + " - expected " + cs.name() + ", got " + csHist.name());
                    failed++;
                }
            } catch (UnsupportedCharsetException uce) {
                System.out.println("Failed : charset - " + cs.name() + ", missing alias entry - " + encoding);
                failed++;
            }
        }
    }
