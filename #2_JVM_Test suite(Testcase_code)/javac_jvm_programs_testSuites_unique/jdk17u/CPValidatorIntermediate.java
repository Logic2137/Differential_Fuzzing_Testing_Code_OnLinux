...
public class CPValidatorIntermediate {
    ...
    private static CertPath generateCertificatePath(String certStr) throws CertificateException {
    ...
    private static void validate(String intermediate) throws CertPathValidatorException, Exception {
