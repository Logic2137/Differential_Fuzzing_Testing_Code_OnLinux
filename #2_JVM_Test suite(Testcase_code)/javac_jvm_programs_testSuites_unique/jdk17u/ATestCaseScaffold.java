public abstract class ATestCaseScaffold {
    ...
    protected ATestCaseScaffold(String name) {
        fName = name;
        fVerbose = false;
    }
    ...
    public final void assertNotNull(Object o) {
        assertTrue(o != null);
    }

    public final void assertNotNull(String message, Object o) {
    ...
    public final void assertEquals(String message, Object expected, Object actual) {
        if ((expected == null) && (actual == null)) {
            ...
            throw new TestCaseScaffoldException(message + ". Expected: '" + expected + "'. Actual: '" + actual + "'.");
        }
    }
    ...
    public final void assertEquals(String message, int expected, int actual) {
    ...
    public static final class TestCaseScaffoldException extends RuntimeException {

        public TestCaseScaffoldException() {
            super();
        }

        public TestCaseScaffoldException(String m) {
            super(m);
        }
    }
}
