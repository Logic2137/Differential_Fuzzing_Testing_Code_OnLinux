...
public class ChangeHostName extends UnicastRemoteObject implements Receiver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] hostlist = new String[] { localAddress.getHostAddress(), localAddress.getHostName() };
        for (int i = 0; i < hostlist.length; i++) {
            ...
            if (stub.toString().indexOf(hostlist[i]) >= 0) {
                System.err.println("stub's ref contains hostname: " + hostlist[i]);
            } else {
                throw new RuntimeException("TEST FAILED: stub's ref doesn't contain hostname: " + hostlist[i]);
            }
        }
