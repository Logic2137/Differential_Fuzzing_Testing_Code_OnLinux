...
public class T8071847 {
    ...
    String testJavaSource = "public class testInvalidFlags extends invalidFlags {" + "invalidFlags c = null;" + "public testInvalidFlags() {  c = new invalidFlags(); }" + "public static void main(String... args) { " + "new testInvalidFlags();}}";
    ...
    String javac(String className) {
        ...
        rc = com.sun.tools.javac.Main.compile(javacArgs.toArray(new String[javacArgs.size()]), out);
        out.close();
        if (rc > 1) {
