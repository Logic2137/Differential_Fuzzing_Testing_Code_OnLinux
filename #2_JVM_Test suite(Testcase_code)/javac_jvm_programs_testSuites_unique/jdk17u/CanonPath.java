...
public class CanonPath {
    ...
    private static void printCanonPath(String label, String path) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FilePermission recursive = new FilePermission(file.getCanonicalPath() + File.separatorChar + "-", "read");
        FilePermission wild = new FilePermission(file.getCanonicalPath() + File.separatorChar + "*", "read");
        FilePermission standard = new FilePermission(file.getCanonicalPath(), "read");
