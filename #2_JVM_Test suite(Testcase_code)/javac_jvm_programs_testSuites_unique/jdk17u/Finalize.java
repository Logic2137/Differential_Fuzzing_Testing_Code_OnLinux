...
public class Finalize {
    ...
    public static void main(String[] args) throws Exception {
        Thread.sleep(5000);
        inFile = new File(System.getProperty("test.dir", "."), inFileName);
        inFile.createNewFile();
        inFile.deleteOnExit();
        writeToInFile();
        doFileInputStream();
        outFile = new File(System.getProperty("test.dir", "."), outFileName);
    ...
    private static void doFileOutputStream() throws Exception {
    ...
    private static void doRandomAccessFile() throws Exception {
    ...
    private static void doFileChannel() throws Exception {
        ...
        System.gc();
        Thread.sleep(200);
        bb = ByteBuffer.allocateDirect(data.length).put(data).flip();
        ret = fc2.write(bb);
