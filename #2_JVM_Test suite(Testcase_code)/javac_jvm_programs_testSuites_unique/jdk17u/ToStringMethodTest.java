...
public class ToStringMethodTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!expected.equals(oi.toString())) {
            throw new RuntimeException("The test failed on the method \"toString\" " + "of the ObjectInstance class, expected to get " + expected + ", but got " + oi.toString());
        }
        ...
        if (!exp.equals(at.toString())) {
            throw new RuntimeException("The test failed on  the method \"toString\" " + "of the Attribute class, expected to get " + exp + ", but got " + at.toString());
        }
