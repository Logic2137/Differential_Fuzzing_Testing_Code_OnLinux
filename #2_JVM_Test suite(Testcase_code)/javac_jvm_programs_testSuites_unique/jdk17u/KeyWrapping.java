...
public class KeyWrapping {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SecretKey unwrappedSessionKey = (SecretKey) c1.unwrap(wrappedKey, "DES", Cipher.SECRET_KEY);
        ...
        c1.init(Cipher.UNWRAP_MODE, sKey);
        Key unwrappedPub = c1.unwrap(wrappedPub, "DSA", Cipher.PUBLIC_KEY);
        Key unwrappedPri = c1.unwrap(wrappedPri, "DSA", Cipher.PRIVATE_KEY);
    }
}
