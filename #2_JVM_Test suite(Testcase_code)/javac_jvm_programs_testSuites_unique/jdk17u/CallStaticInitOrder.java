...
public class CallStaticInitOrder {
    ...
    private static class Init1 {
        ...
        static {
            Init1Tick = tick("foo -> Init1.<clinit>");
        }
    ...
    private static class Init2 {
        ...
        static {
            Init2Tick = tick("bar -> Init2.<clinit>");
        }
    ...
    private static class Init3 {
        ...
        static {
            Init3Tick = tick("baz -> Init3.<clinit>");
        }
    ...
    private static class Init4 {
        ...
        static {
            Init4Tick = tick("bat -> Init4.<clinit>");
        }
    ...
    private static class Init5 {
        ...
        static {
            Init5Tick = tick("read bang -> Init5.<clinit>");
        }
    ...
    private static class Init6 {
        ...
        static {
            Init6Tick = tick("write pong -> Init6.<clinit>");
        }
    ...
    private static CallSite bsm(Lookup caller, String name, MethodType type) throws ReflectiveOperationException {
        ...
        switch(name) {
            case "foo":
                res = new ConstantCallSite(MH_foo());
                break;
            case "bar":
                res = new ConstantCallSite(CONSTANT_MH_bar);
                break;
            case "baz":
                res = CONSTANT_CS_baz;
                break;
            case "bat":
                res = new ConstantCallSite(CONSTANT_MH_bat);
                break;
            case "bang":
                res = new ConstantCallSite(CONSTANT_MH_bangGetter);
                break;
            case "pong":
                res = new ConstantCallSite(CONSTANT_MH_pongSetter);
                break;
            default:
                res = null;
        }
