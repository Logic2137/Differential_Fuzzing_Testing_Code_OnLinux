    ...
    public static int run(String[] argv, PrintStream out) {
        ...
        for (; ; ) {
            try {
                ...
                out.println(sErr1 + "no Connecter with needed BooleanArgument found\n");
                return exitCode0;
            }
        }
        boolean b;
        ...
        if (b) {
            exitCode = exitCode2;
            out.println(sErr2 + "check: 'tru' -> true = ? \n" + "result: booleanValue() == " + b + "\n");
        }
        ...
        if (b) {
            exitCode = exitCode2;
            out.println(sErr2 + "check: 'fals' -> 'false' = ? \n" + "result: booleanValue() == " + b + "\n");
        }
