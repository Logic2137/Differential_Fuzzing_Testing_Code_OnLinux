...
public class FloatControlBug {
    ...
    public boolean runTest() {
        AudioInputStream theAudioInputStream = new AudioInputStream(new ByteArrayInputStream(new byte[0]), new AudioFormat(44100.0f, 16, 2, true, false), 441000);
        ...
        try {
            ...
            FloatControl theFloatControl = (FloatControl) (theClip.getControl(FloatControl.Type.MASTER_GAIN));
            float theFloatControlPrecision = theFloatControl.getPrecision();
            System.out.println("theFloatControlPrecision: " + theFloatControlPrecision);
