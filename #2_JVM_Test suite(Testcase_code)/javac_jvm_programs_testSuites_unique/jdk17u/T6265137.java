...
public class T6265137 {
    ...
    public static void main(String... args) throws IOException {
        ...
        try (StandardJavaFileManager fm = javac.getStandardFileManager(dl, null, null)) {
            ...
            Iterable<? extends JavaFileObject> files = fm.getJavaFileObjectsFromFiles(Arrays.asList(new File(srcdir, "T6265137a.java")));
            javac.getTask(null, fm, dl, Arrays.asList("-target", Integer.toString(Runtime.version().feature())), null, files).call();
        }
    }
}
