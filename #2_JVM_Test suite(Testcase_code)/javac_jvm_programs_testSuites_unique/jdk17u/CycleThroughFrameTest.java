...
public class CycleThroughFrameTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (testContinueFlag) {
            dispose();
            throw new RuntimeException("Timed out after " + (sleepTime - remainingSleepTime) / 1000 + " seconds");
        }
    }
}
