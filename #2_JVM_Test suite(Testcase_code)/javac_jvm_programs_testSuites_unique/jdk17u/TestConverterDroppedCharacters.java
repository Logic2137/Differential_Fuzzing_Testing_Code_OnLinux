...
public class TestConverterDroppedCharacters {
    ...
    public static void main(String[] args) throws java.io.IOException, java.io.UnsupportedEncodingException, java.io.FileNotFoundException {
        tryEncoding("Big5");
    ...
    static void tryEncoding(String encoding) throws java.io.IOException, java.io.UnsupportedEncodingException, java.io.FileNotFoundException {
