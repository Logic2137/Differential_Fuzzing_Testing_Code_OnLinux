...
public class RemoveDropTargetCrashTest {
    ...
    private static void runTest(int delay) throws Exception {
        ...
        try {
            ...
            for (; !tmpPoint.equals(dropPoint); tmpPoint.translate(sign(dropPoint.x - tmpPoint.x), sign(dropPoint.y - tmpPoint.y))) {
    ...
    private static void pressOnButton(Robot robot, Point clickPoint) throws InterruptedException {
    ...
    static class DragSourceButton extends Button implements Serializable, Transferable, DragGestureListener, DragSourceListener {
    ...
    private static void runProcess() throws Exception {
        ...
        String command = javaPath + File.separator + "bin" + File.separator + "java" + " " + RemoveDropTargetCrashTest.class.getName() + " " + RUN_TEST;
        ...
        if (!processExit) {
            process.destroy();
            throw new RuntimeException("" + "The sub process has not exited!");
        }
    }
