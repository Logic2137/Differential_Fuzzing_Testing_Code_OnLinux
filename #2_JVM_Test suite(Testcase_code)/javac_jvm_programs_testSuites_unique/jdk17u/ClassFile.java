...
public class ClassFile {
    ...
    static class CpInterfaceMethodRef extends CpRef {
        ...
        CpInterfaceMethodRef(CfInputStream in) {
            super(TAG, in);
        }
    }
