...
public class redefclass002r {
    ...
    redefclass002r() {
        System.err.println("NEW redefclass002r (" + this + "): initializer of the redefined class was invoked!");
    }
    ...
    public void activeMethod(PipedInputStream pipeIn, PipedOutputStream pipeOut, PrintStream out, Object readyObj, boolean verbose) {
