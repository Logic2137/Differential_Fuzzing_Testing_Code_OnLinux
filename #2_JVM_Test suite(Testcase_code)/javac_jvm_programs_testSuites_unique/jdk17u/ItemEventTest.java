...
public class ItemEventTest extends Frame {
    ...
    void performTest() {
        ...
        if (!expectedSelectionOrder.equals(actualSelectionOrder.toString())) {
            dispose();
            throw new RuntimeException("ItemEvent for selection & deselection" + " of multi select List's item is not correct" + " Expected : " + expectedSelectionOrder + " Actual : " + actualSelectionOrder);
        }
    }
