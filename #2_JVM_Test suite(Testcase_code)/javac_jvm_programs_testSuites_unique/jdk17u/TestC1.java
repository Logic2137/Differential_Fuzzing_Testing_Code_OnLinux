...
public class TestC1 {
    ...
    static void testTypeParameters() {
        ...
        assert bs[0] == Object.class : "The default bound of a type variable should be Object";
    }
    ...
    static void testMethods() throws NoSuchMethodException {
        ...
        assert bs[0] == Object.class : "The bound of T should be Object (mc1t)";
        ...
        assert pt.getRawType() == cls : "Type of parameter 2 of mc1t is instantiation of C1";
        ...
        Type ta = tas[0];
        assert ta instanceof TypeVariable : "The actual type arg of C1<T> is a type variable (mc1t)";
        tv = (TypeVariable) ta;
        ...
        assert bs[0] == Object.class : "mc1t: The bound of the type arg of C1<T> should be Object";
        Type p3_mc1t = pt_mc1t[2];
        assert p3_mc1t == cls : "Type of parameter 3 of mc1t is C1";
        ...
        bs = tv.getBounds();
        assert bs.length == 1 : "T should have one bound";
        assert bs[0] == Object.class : "The bound of T should be Object";
    ...
    static void testFields() throws NoSuchFieldException {
        ...
        assert gt_ft instanceof TypeVariable : "The generic type of C1.ft is a type variable";
        ...
        assert bs[0] == Object.class : "The bound of the type of ft should be Object";
        Type gt_fc1t = fc1t.getGenericType();
        assert gt_fc1t instanceof ParameterizedType : "The generic type of C1.fc1t is a parameterized type";
        ParameterizedType pt = (ParameterizedType) gt_fc1t;
        assert pt.getRawType() == cls : "Type of C1.fc1t is instantiation of C1";
        assert pt.getOwnerType() == null : "Type of C1.fc1t is has null owner";
        Type[] tas = pt.getActualTypeArguments();
        assert tas.length == 1 : "The type of fc1t has one type argument";
        Type ta = tas[0];
        assert ta instanceof TypeVariable : "The actual type arg of C1<T> is a type variable";
        tv = (TypeVariable) ta;
        ...
        assert bs[0] == Object.class : "The bound of the type arg of C1<T> should be Object";
        Type gt_fc1 = fc1.getGenericType();
        assert gt_fc1 == cls : " Type of C1.fc1 should be C1";
    }
    ...
    static void testConstructor() throws NoSuchMethodException {
        ...
        Type pt = pt_con[0];
        assert pt instanceof TypeVariable : "The generic type of the parameter of C1(T) is a type variable";
