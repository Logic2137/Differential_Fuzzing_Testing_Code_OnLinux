...
public class ArrayClassTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        mbs.createMBean(Test.class.getName(), testName, loaderName, new Object[1], new String[] { X[].class.getName() });
        ...
        mbs.invoke(testName, "ignore", new Object[1], new String[] { Y[].class.getName() });
    ...
    public static class SpyLoader extends URLClassLoader implements SpyLoaderMBean, PrivateClassLoader {
