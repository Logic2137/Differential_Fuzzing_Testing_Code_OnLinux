...
public class Compress {
    ...
    public static class CompressRMIClientSocketFactory implements java.rmi.server.RMIClientSocketFactory, Serializable {
    ...
    public static class CompressRMIServerSocketFactory implements RMIServerSocketFactory, Serializable {
    ...
    public static class CompressInputStream extends FilterInputStream implements CompressConstants {
    ...
    public static class CompressOutputStream extends FilterOutputStream implements CompressConstants {
        ...
        public void flush() throws IOException {
            while (bufPos > 0) writeCode(NOP);
        }

        private void writeCode(int c) throws IOException {
            buf[bufPos++] = c;
            if (bufPos == 5) {
                int pack = (buf[0] << 24) | (buf[1] << 18) | (buf[2] << 12) | (buf[3] << 6) | buf[4];
