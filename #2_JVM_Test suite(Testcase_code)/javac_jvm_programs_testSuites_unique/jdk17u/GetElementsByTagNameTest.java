...
public class GetElementsByTagNameTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ImageInputStream in = new MemoryCacheImageInputStream(new ByteArrayInputStream(tmp.toByteArray()));
        ...
        if (root.getElementsByTagName("*").getLength() == 0) {
            throw new RuntimeException("getElementsByTagName(\"*\") returns" + " nothing");
        }
    }
}
