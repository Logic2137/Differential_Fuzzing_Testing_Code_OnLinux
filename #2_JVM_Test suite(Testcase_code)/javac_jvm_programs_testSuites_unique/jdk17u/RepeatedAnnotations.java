...
class RepeatingOnConstructor {
    ...
    @RepTypeUseB
    @RepTypeUseB
    RepeatingOnConstructor(int i, int j) {
    }
    ...
    @RepAllContextsB
    @RepAllContextsB
    RepeatingOnConstructor(int i, int j, int k) {
    }
    ...
    class Inner {
        ...
        Inner(@RepParameterA @RepParameterA @RepParameterB @RepParameterB String parameter, @RepParameterA @RepParameterA @RepParameterB @RepParameterB String@RepTypeUseA @RepTypeUseA @RepTypeUseB @RepTypeUseB ... vararg) {
        }
    }
}
...
@Target({ CONSTRUCTOR })
@Documented
@interface ContConstructorA {

    RepConstructorA[] value();
}
...
@Target({ CONSTRUCTOR })
@Documented
@interface ContConstructorB {

    RepConstructorB[] value();
}
