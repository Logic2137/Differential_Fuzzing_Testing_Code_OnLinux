...
public class Test4314141 {
    ...
    static void doTestCandidateOmission(String language, String country, String variant, String[] expectedSuffixes) {
    ...
    static void doTest(String baseName, String language, String country, String variant, String[] expectedSuffixes) {
