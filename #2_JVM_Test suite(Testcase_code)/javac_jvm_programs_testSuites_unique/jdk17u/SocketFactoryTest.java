...
public class SocketFactoryTest {
    ...
    public static final String[] ciphersuite = new String[] { "SSL_RSA_WITH_NULL_MD5" };

    public static final String[] protocol = new String[] { "TLSv1" };

    public static class MySslRMIClientSocketFactory extends SslRMIClientSocketFactory {
    }

    public static class MySslRMIServerSocketFactory extends SslRMIServerSocketFactory {

        public MySslRMIServerSocketFactory() {
            super();
        }

        public MySslRMIServerSocketFactory(String[] ciphers, String[] protocols, boolean need) {
            super(ciphers, protocols, need);
        }

        public MySslRMIServerSocketFactory(SSLContext context, String[] ciphers, String[] protocols, boolean need) {
