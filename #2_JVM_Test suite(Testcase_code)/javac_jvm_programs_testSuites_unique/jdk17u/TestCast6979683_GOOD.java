public class TestCast6979683_GOOD {
    ...
    static boolean zconv1(Boolean o) {
        return o;
    }

    static boolean zconv2(Object o) {
        return (boolean) o;
    }

    static boolean zconv3(Comparable<Boolean> o) {
        return (boolean) o;
    }
    ...
    static int iconv1(Integer o) {
        return o;
    }

    static int iconv2(Object o) {
        return (int) o;
    }

    static int iconv3(java.io.Serializable o) {
        return (int) o;
    }

    static int iconv4(Number o) {
        return (int) o;
    }

    static int iconv5(Comparable<Integer> o) {
        return (int) o;
    }
    ...
    static float bconv1(Byte o) {
        return o;
    }

    static float bconv2(Object o) {
        return (byte) o;
    }

    static float bconv3(java.io.Serializable o) {
        return (byte) o;
    }

    static float bconv4(Number o) {
        return (byte) o;
    }
    ...
    static float cconv1(Character o) {
        return o;
    }

    static float cconv2(Object o) {
        return (char) o;
    }

    static float cconv3(java.io.Serializable o) {
        return (char) o;
    }

    static float cconv4(Comparable<Character> o) {
        return (char) o;
    }
