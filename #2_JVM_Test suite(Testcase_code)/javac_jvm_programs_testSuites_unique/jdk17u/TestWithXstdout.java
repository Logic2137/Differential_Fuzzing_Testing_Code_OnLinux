...
public class TestWithXstdout {
    ...
    public static void main(String... args) throws Exception {
        ...
        run_javac("-XDrawDiagnostics", "-XprintProcessorInfo", "-Werror", "-proc:only", "-processor", "Test", "-Xstdout", stdout.getPath(), "-classpath", testClassPath, new File(testSrc, "Test.java").getPath());
