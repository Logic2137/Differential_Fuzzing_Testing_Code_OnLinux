...
public class Krb5NameEquals {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        boolean result = true;
        GSSName name1 = mgr.createName(NAME_STR1, GSSName.NT_HOSTBASED_SERVICE, MECH);
        GSSName name2 = mgr.createName(NAME_STR2, GSSName.NT_HOSTBASED_SERVICE, MECH);
        GSSName name3 = mgr.createName(NAME_STR1, GSSName.NT_HOSTBASED_SERVICE, MECH);
        if (!name1.equals(name1) || !name1.equals(name3) || !name1.equals((Object) name1) || !name1.equals((Object) name3)) {
