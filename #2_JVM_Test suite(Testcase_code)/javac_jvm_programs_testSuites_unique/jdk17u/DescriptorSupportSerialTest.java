...
public class DescriptorSupportSerialTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        d.setField("foo", "bar");
        ModelMBeanOperationInfo getNameInfo = new ModelMBeanOperationInfo("Get name", getName, d);
        ModelMBeanInfo mmbi = new ModelMBeanInfoSupport(Thread.class.getName(), "Thread!", null, null, new ModelMBeanOperationInfo[] { getNameInfo }, null);
    ...
    private static void test(MBeanServerConnection mbsc, ObjectName on) throws Exception {
