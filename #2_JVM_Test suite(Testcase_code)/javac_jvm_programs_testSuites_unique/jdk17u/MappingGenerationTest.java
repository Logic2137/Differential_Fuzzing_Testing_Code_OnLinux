...
public class MappingGenerationTest {
    ...
    private static final SystemFlavorMap fm = (SystemFlavorMap) SystemFlavorMap.getDefaultFlavorMap();
    ...
    public static void test5() {
        final DataFlavor flavor = new DataFlavor("text/plain-TEST5; charset=Unicode", null);
