...
public class SupportedDSAParamGen {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DSAGenParameterSpec spec = new DSAGenParameterSpec(Integer.valueOf(args[0]).intValue(), Integer.valueOf(args[1]).intValue());
        System.out.println("Generating (" + spec.getPrimePLength() + ", " + spec.getSubprimeQLength() + ") DSA Parameters");
