...
public class AllLocations {
    ...
    public class ParamStream<T> extends FileOutputStream {
        ...
        public ParamStream(File f) throws FileNotFoundException {
            super(f);
        }
    }
    ...
    @L
    public Object @M [] @N [] arr = new @O Object @P [5] @Q [5];
    ...
    public <@AE T extends @AF Inner<@AG Integer @AH []>> Function func2() {
        ...
        return Ext.f((@AK Object) arr[0]) instanceof @AL Inner @AM [] @AN [] ? @AO @AP Ext::<@AQ @AR Integer>f : @AS @AT Ext::<@AU @AV Integer>f;
    }
    ...
    @BR
    public <@BL T extends @BO Inner<@BP Integer @BQ []>> Inner<@BS Inner<@BT String>> func4() {
        return (@BU Inner<@BV Inner<@BW String>>) new <@BX Inner<@BY Integer>> @BZ Inner<@CA Inner<@CB String>>(null) {
        };
    }

    {
        Inner<@CC ? extends @CD Inner<@CE ? extends @CF Integer>> loc = new @CG Inner<@CH Inner<@CI Integer>>() {
        };
        Ext.func(Ext.func(@CJ WeakReference::new));
        Ext.func(Ext.func(@CK Ext::<@CL Integer>f));
        Ext.func((@CM Object a) -> {
            @CN
            Object b = a;
            return b;
        });
...
class Ext {
    ...
    public static Function func(Function f) {
        return f;
    }
}
