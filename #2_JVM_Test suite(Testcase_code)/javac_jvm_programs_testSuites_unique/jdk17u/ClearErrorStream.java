...
public class ClearErrorStream extends PrintStream {
    ...
    public static void main(String[] args) throws Exception {
        File f = new File(System.getProperty("test.dir", "."), "print-stream.out");
        f.deleteOnExit();
        ClearErrorStream out = new ClearErrorStream(new BufferedOutputStream(new FileOutputStream(f)), true);
