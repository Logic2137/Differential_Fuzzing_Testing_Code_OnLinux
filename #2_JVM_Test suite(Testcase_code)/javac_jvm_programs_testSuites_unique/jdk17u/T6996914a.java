...
public class T6996914a {
    ...
    static class FooClass extends SimpleJavaFileObject {
        ...
        final static String sourceStub = "#P\n" + "public class Foo<X> {\n" + "  #M Foo() {}\n" + "}\n";
    ...
    static class ClientClass extends SimpleJavaFileObject {
        ...
        final static String sourceStub = "#I\n" + "class Test {\n" + "  Foo<String> fs = #D\n" + "}\n";
    ...
    static boolean check(PackageKind pk, ConstructorKind ck, DiamondKind dk) {
        switch(pk) {
            case A:
                return ck == ConstructorKind.PUBLIC || (ck == ConstructorKind.PROTECTED && dk == DiamondKind.ANON);
            case DEFAULT:
