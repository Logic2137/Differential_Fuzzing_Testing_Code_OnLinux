...
public class DescriptorSupportXMLTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int failed = 0;
        final Object[] testValues = { "", "ok", "null", "(open", "close)", "(parens)", "quote\"quote", "a description with several words", "magic&\"\\<> \r\t\n\f;&;magic", "&lt;descriptor&gt;&&&&lt;/descriptor&gt;", "&lt;descriptor&gt;&&&&lt;/blahblahblah&gt;", null, new Integer(10), Boolean.TRUE, new Float(1.0f), new Character('!'), new java.util.HashMap() };
