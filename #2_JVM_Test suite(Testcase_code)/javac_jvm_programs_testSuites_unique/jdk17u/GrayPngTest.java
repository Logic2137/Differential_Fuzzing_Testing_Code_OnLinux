...
public class GrayPngTest {
    ...
    public void doTest(int trans_type, int trans_index) throws IOException {
        ...
        File f = File.createTempFile("gray_png_" + bpp + "bpp_" + trans_type + "tt_" + trans_index + "tp_", ".png", pwd);
    ...
    private void checkImages() {
        for (int i = 0; i < numColors; i++) {
            ...
            if ((0xff000000 & src_rgb) != (0xff000000 & dst_rgb)) {
                throw new RuntimeException("Test FAILED. Color difference detected: " + Integer.toHexString(dst_rgb) + " instead of " + Integer.toHexString(src_rgb) + " for index " + i);
            }
        }
    }
}
