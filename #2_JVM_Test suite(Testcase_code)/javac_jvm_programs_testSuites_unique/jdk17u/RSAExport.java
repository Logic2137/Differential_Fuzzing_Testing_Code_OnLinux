...
public class RSAExport {
    ...
    void doServerSide() throws Exception {
        SSLServerSocketFactory sslssf = getSSLContext(true).getServerSocketFactory();
        SSLServerSocket sslServerSocket = (SSLServerSocket) sslssf.createServerSocket(serverPort);
        serverPort = sslServerSocket.getLocalPort();
        serverReady = true;
        try {
            String[] enabledSuites = { "SSL_RSA_EXPORT_WITH_RC4_40_MD5", "SSL_RSA_EXPORT_WITH_DES40_CBC_SHA" };
    ...
    void doClientSide() throws Exception {
        ...
        SSLSocketFactory sslsf = getSSLContext(false).getSocketFactory();
