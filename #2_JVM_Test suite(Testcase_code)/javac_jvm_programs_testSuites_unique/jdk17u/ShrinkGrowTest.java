...
public class ShrinkGrowTest {
    ...
    public void run() {
        if (System.getProperty("requiresCompressedClassSpace") != null && !isCompressedClassSpaceAvailable()) {
    ...
    private void eatALittleMemory() {
        try {
            ...
            ShrinkGrowTest.Foo foo = (ShrinkGrowTest.Foo) Proxy.newProxyInstance(cl, new Class[] { ShrinkGrowTest.Foo.class }, new ShrinkGrowTest.FooInvocationHandler(new ShrinkGrowTest.FooBar()));
