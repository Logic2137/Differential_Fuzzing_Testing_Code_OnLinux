    ...
    public static void main(String[] args) throws Exception {
        ...
        Files.walkFileTree(fs.getPath("/modules/java.desktop"), new SimpleFileVisitor<Path>() {
            ...
            public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) {
                ...
                if (file.startsWith("java/awt/") || file.startsWith("javax/accessibility/") || file.startsWith("javax/swing/")) {
                    ...
                    if (name.endsWith(".class")) {
                        ...
                        if (!BeanInfo.class.isAssignableFrom(type) && !type.isInterface() && !type.isEnum() && !type.isAnnotation() && !type.isAnonymousClass()) {
    ...
    private static void print(FeatureDescriptor descriptor) {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (value.getClass().isArray()) {
                ...
                while (index < length) {
                    set.add(Array.get(value, index++) + ", " + Array.get(value, index++) + ", " + Array.get(value, index++));
                }
                value = set.toString();
            }
            map.put(id, value);
