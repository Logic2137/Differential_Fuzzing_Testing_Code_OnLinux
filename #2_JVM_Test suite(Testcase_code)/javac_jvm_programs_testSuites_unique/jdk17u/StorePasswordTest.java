...
public class StorePasswordTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        keystore.setEntry(ALIAS, new KeyStore.SecretKeyEntry(convertPassword(USER_PASSWORD), attrs), new KeyStore.PasswordProtection(PASSWORD));
        ...
        System.out.println("Retrieved entry with " + attrCount + " attrs: " + entry);
    ...
    private static SecretKey convertPassword(String password) throws NoSuchAlgorithmException, InvalidKeySpecException {
