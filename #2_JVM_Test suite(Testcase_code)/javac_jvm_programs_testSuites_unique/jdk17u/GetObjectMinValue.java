...
public class GetObjectMinValue {
    ...
    private static void test(boolean minInclusive, boolean maxInclusive) {
        ...
        fmt.addObjectValue("root", defValue.getClass(), defValue, minValue, maxValue, minInclusive, maxInclusive);
        try {
            ...
            throw new RuntimeException("getObjectMinValue: unexpected exception: " + e);
        }
        try {
            ...
            throw new RuntimeException("getObjectMaxValue: unexpected exception: " + e);
        }
    }
    ...
    static class MyFormatImpl extends IIOMetadataFormatImpl {
        ...
        public void addObjectValue(String elementName, Class<?> classType, Integer defaultValue, Comparable minValue, Comparable maxValue, boolean minInclusive, boolean maxInclusive) {
            super.<Integer>addObjectValue(elementName, (Class<Integer>) classType, defaultValue, (Comparable<? super Integer>) minValue, (Comparable<? super Integer>) maxValue, minInclusive, maxInclusive);
        }
