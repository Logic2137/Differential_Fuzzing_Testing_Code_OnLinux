...
public class UnderlineTest {
    ...
    public static void main(String[] args) {
        ...
        scrtx.scale(1, 2);
        Font[] fonts = { font.deriveFont(1f), font.deriveFont(20f), font.deriveFont(40f), font.deriveFont(80f), font.deriveFont(AffineTransform.getRotateInstance(rot)), font.deriveFont(AffineTransform.getScaleInstance(1, 2)), font.deriveFont(AffineTransform.getScaleInstance(2, 4)), font.deriveFont(scrtx) };
        ...
        if (ds2 != ds1 * 2 || du2 != du1 * 2) {
            throw new IllegalStateException("non-linear scale: " + ds1 + " / " + ds2 + ", " + du1 + " / " + du2);
        }
