...
public final class IncorrectClipXorModeSurface2Surface {
    ...
    private static BufferedImage getSourceGold(GraphicsConfiguration gc, int size) {
    ...
    private static BufferedImage getTargetGold(GraphicsConfiguration gc, int size) {
