public class TestCondAddDeadBranch {
    ...
    public void mainTest(String[] strArr1) {
        ...
        init(iArr, 39165);
        for (float f : fArr) {
            for (int smallinvoc = 0; smallinvoc < 62; smallinvoc++) vSmallMeth(TestCondAddDeadBranch.instanceCount = ((TestCondAddDeadBranch.instanceCount++) * 65430), ((iFld + iFld) * (iFld++)) + (iFld + (iFld + iFld)), -s);
        }
