...
public class RotatedFontTest {
    ...
    static void test(Object fm, int x, int y, Font font, AffineTransform gtx, String fileName) throws Exception {
    ...
    private static void checkImageForRotation(BufferedImage img) throws Exception {
        ...
        if ((firstRowWithBlackPixel == -1) || (lastRowWithBlackPixel - firstRowWithBlackPixel < 40)) {
            ImageIO.write(img, "png", new File("font-rotation-failed.png"));
            throw new RuntimeException("no rotation " + "first = " + firstRowWithBlackPixel + " last = " + lastRowWithBlackPixel);
        }
    }
    ...
    private static void compareImages(BufferedImage i1, BufferedImage i2) throws Exception {
    ...
    private static void draw(BufferedImage img, int api, String s, int x, int y, Font font, AffineTransform gtx, Object fm) {
