...
public class PrintTextTest extends Component implements Printable {
    ...
    public PrintTextTest(String page, Font font, AffineTransform gxTx, boolean fm) {
        this.page = page;
        textFont = font;
        this.gxTx = gxTx;
        this.useFM = fm;
    ...
    public void paint(Graphics g) {
        ...
        iy += LS;
        s = "drawString(AttributedCharacterIterator iterator, " + "float x, float y)";
...
class PrintJAText extends PrintTextTest {
    ...
    private static final String TEXT = "\u3042\u3044\u3046\u3048\u304a\u30a4\u30ed\u30cf" + "\u30cb\u30db\u30d8\u30c8\u4e00\u4e01\u4e02\u4e05\uff08";
