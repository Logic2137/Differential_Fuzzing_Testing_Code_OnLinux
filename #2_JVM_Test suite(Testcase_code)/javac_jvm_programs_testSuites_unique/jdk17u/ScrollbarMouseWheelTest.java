...
public final class ScrollbarMouseWheelTest implements MouseWheelListener, WindowListener {
    ...
    public void test() {
        ...
        if (sb1upevents == REPS && sb2upevents == 0 && pnlupevents == PANEL_REPS && sb1downevents == REPS && sb2downevents == 0 && pnldownevents == PANEL_REPS) {
