...
abstract class TestArrayCopyUtils {
    ...
    void doTest(String name) throws Exception {
        ...
        boolean isIntArray = (retType.isPrimitive() && !retType.equals(Void.TYPE)) || (retType.equals(Void.TYPE) && paramTypes[0].getComponentType().isPrimitive()) || (retType.isArray() && retType.getComponentType().isPrimitive());
