...
public class ReadCloseRaceNPE {
    ...
    private static void testReader(final Supplier<Reader> readerSupplier) throws InterruptedException {
        AtomicReference<Reader> readerRef = new AtomicReference<>(readerSupplier.get());
