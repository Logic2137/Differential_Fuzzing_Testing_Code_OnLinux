...
public class RemotePrinterStatusRefresh extends WindowAdapter {
    ...
    private static class ServiceItem {
        ...
        public boolean equals(Object obj) {
            return (obj instanceof ServiceItem) && ((ServiceItem) obj).name.equals(name);
        }
    ...
    private RemotePrinterStatusRefresh() {
        ...
        beforeList = new ServiceItemListModel(Collections.unmodifiableList(collectPrinterList()));
    ...
    private JPanel createInfoPanel() {
        ...
        JTextField javaVersion = new JTextField(System.getProperty("java.runtime.version"));
        ...
        layout.setHorizontalGroup(layout.createSequentialGroup().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(javaLabel).addComponent(timeoutLabel)).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, true).addComponent(javaVersion).addComponent(timeLeft)));
        layout.setVerticalGroup(layout.createSequentialGroup().addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(javaLabel).addComponent(javaVersion)).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(timeoutLabel).addComponent(timeLeft)));
        return infoPanel;
    }
    ...
    private JPanel createListPanel(final ServiceItemListModel model, final String title, final char mnemonic) {
