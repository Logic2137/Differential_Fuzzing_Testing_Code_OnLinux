...
public class PageFormatChange {
    ...
    static String[] text = { "This is is a manual test intended to be run on Windows, and you", "must have at least two printers installed, and ideally the second", "printer should support large paper sizes. When the pageDialog appears", "first change printers, then choose a large paper size, then OK", "the dialog. The test will throw an Exception if it fails" };
