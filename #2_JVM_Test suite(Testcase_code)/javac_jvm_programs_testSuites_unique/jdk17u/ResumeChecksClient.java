...
public class ResumeChecksClient {
    ...
    enum TestMode {
        ...
        BASIC, VERSION_2_TO_3, VERSION_3_TO_2, CIPHER_SUITE, SIGNATURE_SCHEME
    }
    ...
    private static SSLSession connect(SSLContext sslContext, int port, TestMode mode, boolean second) {
        try {
            ...
            switch(mode) {
                ...
                case CIPHER_SUITE:
                    ...
                    break;
                case SIGNATURE_SCHEME:
                    AlgorithmConstraints constraints = params.getAlgorithmConstraints();
                    if (second) {
    ...
    private static void checkResumedSession(SSLSession initSession, SSLSession resSession) throws Exception {
