...
public class ImmutableNotificationInfoTest {
    ...
    public static class UserBroadcaster implements UserBroadcasterMBean, NotificationBroadcaster {
    ...
    public static class NoOverrideNBS extends NotificationBroadcasterSupport implements NoOverrideNBSMBean {
    }

    public static class OverrideNBS extends NotificationBroadcasterSupport implements OverrideNBSMBean {
