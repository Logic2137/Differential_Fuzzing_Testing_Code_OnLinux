...
public class NamedBuffer {
    ...
    public NamedBuffer(String name, byte[] buffer) {
        fName = name;
        fBuffer = buffer;
    }

    public NamedBuffer(String name, InputStream stream) throws IOException {
        this(name, loadBufferFromStream(stream));
    }
    ...
    public static byte[] loadBufferFromStream(InputStream stream) throws IOException {
