...
public class AttributeArbitraryDataTypeTest implements NotificationListener {
    ...
    public enum Match {
        ...
        do_not_match_0, do_not_match_1, do_not_match_2, do_match_now
    }
    ...
    public static class MatchBeanInfo extends SimpleBeanInfo {
        ...
        public PropertyDescriptor[] getPropertyDescriptors() {
            try {
                return new PropertyDescriptor[] { new PropertyDescriptor("name", Match.class, "name", null) };
    ...
    public class ObservedObject implements ObservedObjectMBean {
        ...
        public CompositeData getCompositeDataAttribute() throws OpenDataException {
            CompositeType ct = new CompositeType("CompositeDataAttribute", "Composite Data Attribute", itemNames, itemDescriptions, itemTypes);
        ...
        private String[] itemNames = { "IntegerAttribute", "DoubleAttribute", "StringAttribute" };

        private String[] itemDescriptions = { "Integer Attribute", "Double Attribute", "String Attribute" };

        private OpenType[] itemTypes = { SimpleType.INTEGER, SimpleType.DOUBLE, SimpleType.STRING };
    }
    ...
    public static Object elementFromComplex(Object complex, String element) throws AttributeNotFoundException {
        try {
            ...
            AttributeNotFoundException anfe = new AttributeNotFoundException(e.getMessage());
            anfe.initCause(e);
            throw anfe;
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        AttributeArbitraryDataTypeTest test = new AttributeArbitraryDataTypeTest();
        int error = test.monitorNotifications();
        if (error > 0) {
            echo(">>> Unhappy Bye, Bye!");
            throw new IllegalStateException("Test FAILED: Didn't get all " + "the notifications that were " + "expected by the test!");
        } else {
            echo(">>> Happy Bye, Bye!");
        }
    }
