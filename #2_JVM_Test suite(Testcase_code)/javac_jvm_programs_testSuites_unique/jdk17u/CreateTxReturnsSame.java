...
public class CreateTxReturnsSame {
    ...
    public static void test(Path2D p2d) {
        ...
        if (s1.getClass() != p2d.getClass() || s2.getClass() != p2d.getClass()) {
            throw new RuntimeException(p2d.getClass().getName() + ".createTransformedShape() " + "did not return a " + p2d.getClass().getName());
        }
    }
}
