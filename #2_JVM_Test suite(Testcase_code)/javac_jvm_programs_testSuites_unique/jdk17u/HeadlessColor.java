...
public class HeadlessColor {
    ...
    public static void main(String[] args) {
        ...
        c = new Color(ColorSpace.getInstance(ColorSpace.CS_sRGB), new float[] { 0.8f, 0.8f, 0.3f }, 1f);
        ...
        if (!exceptions)
            throw new RuntimeException("Constructor did not throw IllegalArgumentException " + "when expected in headless mode");
        exceptions = false;
        try {
        ...
        exceptions = false;
        try {
            c = new Color(ColorSpace.getInstance(ColorSpace.CS_sRGB), new float[] { -8f, -8f, -3f }, 1f);
        } catch (IllegalArgumentException e) {
            exceptions = true;
        }
        if (!exceptions)
