...
public class B4769350 {
    ...
    class Server implements AutoCloseable {
        ...
        class AuthenticationHandlerT1a implements HttpHandler {
            ...
            public void handle(HttpExchange exchange) throws IOException {
                ...
                try {
                    switch(count) {
                        case 0:
                            AuthenticationHandler.errorReply(exchange, "Basic realm=\"realm1\"");
                            break;
                        case 1:
                            t1Cond1.await();
        ...
        class AuthenticationHandlerT1b implements HttpHandler {
            ...
            public void handle(HttpExchange exchange) throws IOException {
                ...
                try {
                    switch(count) {
                        case 0:
                            AuthenticationHandler.errorReply(exchange, "Basic realm=\"realm2\"");
                            break;
                        case 1:
                            t1Cond1.await();
                            AuthenticationHandler.okReply(exchange);
        ...
        class AuthenticationHandlerT2a implements HttpHandler {
            ...
            public void handle(HttpExchange exchange) throws IOException {
                ...
                AuthenticationHandler.errorReply(exchange, "Basic realm=\"realm3\"");
            }
        }
        ...
        class AuthenticationHandlerT3a implements HttpHandler {
            ...
            public void handle(HttpExchange exchange) throws IOException {
                ...
                switch(count) {
                    case 0:
                        AuthenticationHandler.proxyReply(exchange, "Basic realm=\"proxy\"");
                        break;
                    case 1:
                        t3cond1.countDown();
                        AuthenticationHandler.errorReply(exchange, "Basic realm=\"realm4\"");
                        break;
                    case 2:
                        AuthenticationHandler.okReply(exchange);
                        break;
    ...
    static class AuthenticationHandler {
        ...
        static void errorReply(HttpExchange exchange, String reply) throws IOException {
        ...
        static void proxyReply(HttpExchange exchange, String reply) throws IOException {
    ...
    static void doServerTests(String authority, Server server) throws Exception {
        ...
        int f = auth.getCount();
        if (f != 2) {
            except("Authenticator was called " + f + " times. Should be 2", server);
        }
        if (error) {
        ...
        f = auth.getCount();
        if (f != redirects + 1) {
            except("Authenticator was called " + f + " times. Should be: " + redirects + 1, server);
        }
        if (error) {
            except("error occurred", server);
        }
