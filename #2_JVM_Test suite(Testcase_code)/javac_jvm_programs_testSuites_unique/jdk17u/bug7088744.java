...
public class bug7088744 {
    ...
    private static final int[][] BUTTON_EVENTS_SEQUENCE = { { MOUSE_PRESSED, 1 }, { MOUSE_PRESSED, 2 }, { MOUSE_PRESSED, 3 }, { MOUSE_RELEASED, 1 }, { MOUSE_CLICKED, 1 }, { MOUSE_RELEASED, 2 }, { MOUSE_CLICKED, 2 }, { MOUSE_RELEASED, 3 }, { MOUSE_CLICKED, 3 } };
    ...
    public static void main(String[] args) throws Exception {
        SwingUtilities.invokeAndWait(new Runnable() {
            ...
            public void run() {
                ...
                MouseEvent mouseEventNoButtons = new MouseEvent(source, 0, System.currentTimeMillis(), Event.ALT_MASK | Event.META_MASK | InputEvent.ALT_DOWN_MASK | InputEvent.META_DOWN_MASK, 0, 0, 0, false, MouseEvent.NOBUTTON);
