...
public class GetAnnotatedSuperclass {
    ...
    private static final Class<?>[] nullTestData = { Object.class, If.class, Object[].class, void.class, int.class };

    private static final Class<?>[] nonNullTestData = { Class.class, GetAnnotatedSuperclass.class, (new If() {
    }).getClass(), (new Clz() {
    }).getClass(), (new Object() {
    }).getClass() };
    ...
    private static void testReturnsNull() {
        for (Class<?> toTest : nullTestData) {
            ...
            if (res != null) {
                failed++;
                System.out.println(toTest + ".getAnnotatedSuperclass() returns: " + res + ", should be null");
            }
        }
    }
