...
public class TestISO2022JPSubBytes {
    ...
    public static void main(String[] args) throws Exception {
        CharsetEncoder enc = Charset.forName("ISO2022JP").newEncoder().onUnmappableCharacter(CodingErrorAction.REPLACE);
    ...
    public static void test(CharsetEncoder enc, char[] inputChars, byte[] expectedBytes) throws Exception {
