...
public class LoadParsing2 {
    ...
    private static Properties getLoadedProperties(InputStream is, boolean doStream) throws Exception {
    ...
    private static void test(String fnData, String[] keys, String[] values, boolean doStream) throws Exception {
