...
public class StackTraceSerialization {
    ...
    private static void testWithSetStackTrace() {
        ...
        Throwable t = new TestThrowable(true, false);
    ...
    private static class TestThrowable extends Throwable {
        ...
        public TestThrowable(boolean enableSuppression, boolean writableStackTrace) {
            super("the medium", null, enableSuppression, writableStackTrace);
        }
    }
    ...
    private static boolean equal(Throwable t1, Throwable t2) {
        return t1 == t2 || (Arrays.equals(t1.getStackTrace(), t2.getStackTrace()) && equal(t1.getCause(), t2.getCause()) && Objects.equals(t1.getSuppressed(), t2.getSuppressed()));
    }
