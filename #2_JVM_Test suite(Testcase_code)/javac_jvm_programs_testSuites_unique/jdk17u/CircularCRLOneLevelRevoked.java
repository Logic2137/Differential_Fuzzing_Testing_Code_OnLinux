...
public class CircularCRLOneLevelRevoked {
    ...
    private static CertPath generateCertificatePath() throws CertificateException {
        ...
        List<Certificate> list = Arrays.asList(new Certificate[] { targetCert, selfSignedCert });
    ...
    private static CertStore generateCertificateStore() throws Exception {
        CertificateFactory cf = CertificateFactory.getInstance("X.509");
        ByteArrayInputStream is = new ByteArrayInputStream(crlStr.getBytes());
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            if (cpve.getReason() != BasicReason.REVOKED) {
                throw new Exception("unexpected exception, should be a REVOKED CPVE", cpve);
            }
        }
    }
}
