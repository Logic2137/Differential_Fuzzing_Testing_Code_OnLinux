...
public class TestShortBuffer {
    ...
    private static final String[] MODES = { "ECB", "CBC", "PCBC", "CFB16", "OFB8" };

    private static final SecretKey KEY = new SecretKeySpec(new byte[16], ALGO);
    ...
    private static void runTest() throws Exception {
        for (int i = 0; i < MODES.length; i++) {
            ...
            Cipher ci = Cipher.getInstance(ALGO + "/" + MODES[i] + "/PKCS5Padding", "SunJCE");
