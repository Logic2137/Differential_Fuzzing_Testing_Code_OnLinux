...
public class DiffHBTest {
    ...
    private static class MyListener implements NotificationListener {
        ...
        public void handleNotification(Notification n, Object o) {
            ...
            if (!(MBeanServerNotification.REGISTRATION_NOTIFICATION.equals(msn.getType())) || !msn.getMBeanName().equals(timerName)) {
                return;
            }
            synchronized (this) {
                received++;
                ...
                } else if (receivedNotif.getSequenceNumber() != msn.getSequenceNumber()) {
