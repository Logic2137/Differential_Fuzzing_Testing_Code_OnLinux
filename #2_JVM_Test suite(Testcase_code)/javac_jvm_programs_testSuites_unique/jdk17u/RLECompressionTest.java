...
public class RLECompressionTest {
    ...
    private static Color[] usedColors = new Color[] { Color.black, Color.white, Color.red, Color.green, Color.blue, Color.yellow };
    ...
    private void checkResult(BufferedImage src, BufferedImage dst) {
        ...
        for (int y = 0; y < h; y++) {
            ...
            if (srcRgb != dstRgb) {
                throw new RuntimeException("Test failed due to color difference: " + Integer.toHexString(dstRgb) + " instead of " + Integer.toHexString(srcRgb) + " at [" + x + ", " + y + "]");
            }
        }
    }
