...
class N1<T1, T2> {
    ...
    public class Inner3<X1, X2, X3> {
        ...
        int shazam(boolean b, short s, int[] ia, Object[] oa, Inner1 i1, Inner1 i1a, InnerInner<String, Inner3<Object, String, Object[]>> ii) {
            return 3;
        }
        ...
        public class InnerInner<T2, X2> {
            ...
            <X3> X3[] bar(X1 x1, X3[] x3, T1 t1) {
                return x3;
            }

            N1<X1, X2> baz(N1<X1, X2> n1) {
                return n1;
            }
            ...
            N1<? extends T1, ?> boom(N1<T1, X2> n1) {
                return n1;
            }
        }
    }
