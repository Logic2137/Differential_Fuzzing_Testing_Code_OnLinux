...
public class ChromaticityValues {
    ...
    public static void main(String[] args) {
        ...
        if (pservice.isAttributeCategorySupported(Chromaticity.class)) {
            Chromaticity[] values = (Chromaticity[]) (pservice.getSupportedAttributeValues(Chromaticity.class, DocFlavor.SERVICE_FORMATTED.PAGEABLE, null));
        ...
        if (psa != null) {
            if (psa.equals(ColorSupported.SUPPORTED)) {
                ...
                if ((cValues.size() != 1) || (!cValues.contains(Chromaticity.MONOCHROME))) {
