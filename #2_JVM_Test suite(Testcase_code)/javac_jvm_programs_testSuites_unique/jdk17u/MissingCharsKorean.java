    ...
    public static void main(String[] args) throws Exception {
        ...
        if (startTest) {
            ...
            if (testPassed) {
                ...
                throw new RuntimeException("Korean text missing characters : " + testResult);
            }
        } else {
    ...
    private static boolean setKeyInput(int iCount) {
        ...
        switch(iCount) {
            case 0:
                ...
                inKeyCodes = new int[][] { { KeyEvent.VK_Q }, { KeyEvent.VK_SLASH } };
                break;
            case 1:
                expectedResults = new int[] { 12610, 47, 54840, 92 };
                inKeyCodes = new int[][] { { KeyEvent.VK_Q }, { KeyEvent.VK_SLASH }, { KeyEvent.VK_G }, { KeyEvent.VK_H }, { KeyEvent.VK_BACK_SLASH } };
                break;
            case 2:
                expectedResults = new int[] { 12610, 47, 54857, 92 };
                inKeyCodes = new int[][] { { KeyEvent.VK_Q }, { KeyEvent.VK_SLASH }, { KeyEvent.VK_G }, { KeyEvent.VK_H }, { KeyEvent.VK_Q }, { KeyEvent.VK_BACK_SLASH } };
                break;
            case 3:
                expectedResults = new int[] { 12610, 47, 54840, 92 };
                inKeyCodes = new int[][] { { KeyEvent.VK_Q }, { KeyEvent.VK_SLASH }, { KeyEvent.VK_G }, { KeyEvent.VK_H }, { KeyEvent.VK_Q }, { KeyEvent.VK_BACK_SPACE }, { KeyEvent.VK_BACK_SLASH } };
                break;
            case 4:
                expectedResults = new int[] { 12610, 47, 12622, 92 };
                inKeyCodes = new int[][] { { KeyEvent.VK_Q }, { KeyEvent.VK_SLASH }, { KeyEvent.VK_G }, { KeyEvent.VK_H }, { KeyEvent.VK_Q }, { KeyEvent.VK_BACK_SPACE }, { KeyEvent.VK_BACK_SPACE }, { KeyEvent.VK_BACK_SLASH } };
                break;
            default:
                inputSet = false;
                break;
            ...
            if (expectedResults.length == strCurr.length()) {
                ...
                for (int i = 0; i < strCurr.length(); i++) {
                    ...
                    if (charActual != expectedResults[i]) {
                        System.err.println("<" + i + "> Actual = " + charActual + " Expected = " + expectedResults[i]);
                        testPassed = false;
                        break;
                    }
                }
    ...
    public static void setTaskStatus(boolean allTasksPerformed, int taskCount) {
        if (testPassed) {
            if (allTasksPerformed) {
                ...
                testResult = "Test " + Integer.toString(taskCount) + " Passed";
            }
        } else {
            testResult = "Test " + Integer.toString(taskCount) + " Failed";
        }
