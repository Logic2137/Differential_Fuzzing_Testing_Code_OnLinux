...
public class LargePacketAfterHandshakeTest {
    ...
    public static void runClient() throws IOException {
        try {
            ...
            StringBuilder echoBuilder = new StringBuilder(4500 + echoPattern.length());
            ...
            w.newLine();
            w.flush();
            System.out.println("Client: Sent " + echostring.length() + " chars of data.");
            String echoresponse = r.readLine();
            clientDone = true;
            System.out.println("Client: Read " + echoresponse.length() + " chars of data.");
            w.close();
            r.close();
            c.close();
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (serverThread.isAlive()) {
            try {
                ...
                System.out.println("Main: Caught InterruptedException " + " waiting for server Thread.");
            }
        }
