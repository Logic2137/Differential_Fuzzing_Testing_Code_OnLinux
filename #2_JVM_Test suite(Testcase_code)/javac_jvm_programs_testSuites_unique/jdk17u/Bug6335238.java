        ...
        public void run() {
            ...
            while (!stopped) {
                ...
                if (!s.equals(TIME_STRING)) {
                    stopped = true;
                    err = true;
                    throw new RuntimeException("Formatting Date Error: counter=" + i + ", Got<" + s + "> != Expected<" + TIME_STRING + ">");
                }
            }
        }
    }
            ...
            while (!stopped) {
                ...
                try {
                    ...
                    if (t != UTC_LONG) {
                        stopped = true;
                        err = true;
                        throw new RuntimeException("Parsing Date Error: counter=" + i + " Got:" + t + "<" + sdf.format(date) + "> != " + UTC_LONG);
                    }
