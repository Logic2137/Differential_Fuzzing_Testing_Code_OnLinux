...
public class ListSelectionModelTest {
    ...
    public static void main(String[] args) throws Exception {
        final LookAndFeelInfo[] lookAndFeelInfoArray = getInstalledLookAndFeels();
    ...
    static void checkSelection(JList list, int[] selectionArray, String lookAndFeel) throws RuntimeException {
