...
public class TestContainTypes {
    ...
    enum ClassType {
        ...
        OBJECT("Object"), NUMBER("Number"), INTEGER("Integer"), STRING("String");
        ...
        boolean subtypeOf(ClassType that) {
            switch(that) {
                ...
                case STRING:
                    return this == STRING;
                default:
                    throw new AssertionError("Bad type kind in subtyping test");
            }
        }
    }
    ...
    enum ParameterType {
        ...
        INVARIANT("List<#1>"), COVARIANT("List<? extends #1>"), CONTRAVARIANT("List<? super #1>"), BIVARIANT("List<?>");
        ...
        static boolean contains(ParameterType pt1, ClassType ct1, ParameterType pt2, ClassType ct2) {
            switch(pt1) {
                case INVARIANT:
                    return (pt2 == INVARIANT && ct1 == ct2) || (pt2 == CONTRAVARIANT && ct1 == ct2 && ct1 == ClassType.OBJECT);
                case COVARIANT:
                    return ((pt2 == INVARIANT || pt2 == COVARIANT) && ct2.subtypeOf(ct1)) || (ct1 == ClassType.OBJECT);
                case CONTRAVARIANT:
                    return (pt2 == INVARIANT || pt2 == CONTRAVARIANT) && ct1.subtypeOf(ct2);
                case BIVARIANT:
                    return true;
                default:
                    throw new AssertionError("Bad type kind in containment test");
            }
        }
    }
    ...
    static class JavaSource extends SimpleJavaFileObject {
        ...
        final static String sourceStub = "import java.util.List;\n" + "@interface ToCheck {}\n" + "class Test {\n" + "   @ToCheck void test(#A a, #B b) {}\n" + "}\n";
    ...
    static void compileAndCheck(ParameterType ptA, ClassType ctA, ParameterType ptB, ClassType ctB) throws Exception {
        ...
        JavacTask ct = (JavacTask) tool.getTask(null, fm, null, null, null, Arrays.asList(source));
    ...
    static class ContainTypesTester extends AbstractProcessor {
        ...
        public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
            ...
            if (d1.getTypeArguments().size() != 1 || d1.getTypeArguments().size() != 1) {
