...
public class Response204 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        server.start();
        URI uri = new URI("http", null, server.getAddress().getHostString(), server.getAddress().getPort(), "/test/foo.html", null, null);
        try {
        ...
        public void handle(HttpExchange t) throws IOException {
            ...
            if ((++counter) % 2 == 0) {
                ...
                if (!t.getRemoteAddress().equals(remote)) {
                    String msg = "Unexpected remote address: " + t.getRemoteAddress() + " - should have been " + remote;
