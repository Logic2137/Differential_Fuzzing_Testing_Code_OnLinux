...
public class bug6608456 {
    ...
    public static void main(String[] args) throws Exception {
        final JComponent component = invokeAndWait(new Callable<JComponent>() {
            ...
            public JComponent call() throws Exception {
                ...
                if (!registerDelegate(button, new TestRepaintManager())) {
                    return null;
                }
                frame.add(button);
                frame.pack();
    ...
    private static boolean registerDelegate(JComponent c, RepaintManager repaintManager) {
        boolean rv = false;
        try {
            Class<?> clazz = Class.forName("com.sun.java.swing.SwingUtilities3");
            Method method = clazz.getMethod("setDelegateRepaintManager", JComponent.class, RepaintManager.class);
