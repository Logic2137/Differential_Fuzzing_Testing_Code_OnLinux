...
public class PaperSizeError {
    ...
    static String[] instructions = { "This test assumes and requires that you have a printer installed", "Two page dialogs will appear. You must press 'OK' on both.", "If the test fails, it will throw an Exception.", "" };
    ...
    public static void main(String[] args) {
        ...
        if (service == null || !service.isAttributeValueSupported(MediaSizeName.ISO_A4, null, null)) {
            return;
        }
