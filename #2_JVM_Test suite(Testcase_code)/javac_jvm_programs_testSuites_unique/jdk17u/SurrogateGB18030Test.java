...
public class SurrogateGB18030Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] expectedBytes = { (byte) 0x90, (byte) 0x30, (byte) 0x81, (byte) 0x30 };
        test.encodeTest(inputString, expectedBytes);
        String expectedStr = "\uDBFF\uDFFF";
        byte[] inputBytes = { (byte) 0xe3, (byte) 0x32, (byte) 0x9a, (byte) 0x35 };
    ...
    private void encodeTest(String inputString, byte[] expectedBytes) throws Exception {
    ...
    private void decodeTest(byte[] inputBytes, String expectedStr) throws Exception {
