public class TestReflectionHierarchy {
    ...
    static class NestedA extends ExternalSuper {
        ...
        static void checkA(NestedA a) throws Throwable {
            verifyEquals((String) NestedA.class.getDeclaredMethod("priv_invoke", new Class<?>[0]).invoke(a, new Object[0]), NestedA.ID);
        }
    }
    ...
    static void checkB(NestedB b) throws Throwable {
        verifyEquals((String) NestedB.class.getDeclaredMethod("priv_invoke", new Class<?>[0]).invoke(b, new Object[0]), NestedB.ID);
    }

    static void checkC(NestedC c) throws Throwable {
        verifyEquals((String) NestedC.class.getDeclaredMethod("priv_invoke", new Class<?>[0]).invoke(c, new Object[0]), NestedC.ID);
    }
