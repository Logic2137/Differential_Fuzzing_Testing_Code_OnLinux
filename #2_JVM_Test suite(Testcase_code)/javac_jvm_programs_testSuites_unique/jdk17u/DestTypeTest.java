...
public class DestTypeTest implements IIOWriteWarningListener, IIOReadWarningListener {
    ...
    public DestTypeTest() {
        w = (ImageWriter) ImageIO.getImageWritersByFormatName("jpeg").next();
        w.addIIOWriteWarningListener(this);
        r = (ImageReader) ImageIO.getImageReadersByFormatName("jpeg").next();
    ...
    public byte[] writeTest(BufferedImage bi, ImageWriteParam p) throws IOException {
