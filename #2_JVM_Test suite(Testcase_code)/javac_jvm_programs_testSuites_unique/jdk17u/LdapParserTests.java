...
public class LdapParserTests {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Escape leading space:" + new Rdn("cn=\\  Juicy Fruit"));
        System.out.println("Escaped leading #:" + new Rdn("cn=\\#Juicy Fruit"));
        System.out.println("Escaped trailing space:" + new Rdn("cn=Juicy Fruit\\  "));
        System.out.println();
        System.out.println("******Other unescaped special character tests ******");
        rdn = new Rdn("cn=  Juicy Fruit");
        System.out.println("Accepted Rdn with value containing leading spaces:" + rdn.toString());
        rdn = new Rdn("cn=Juicy Fruit  ");
        System.out.println("Accepted Rdn with value containing trailing spaces:" + rdn.toString());
        String[] invalids = new String[] { "cn=#xabc", "cn=#axcd", "cn=#abcx", "cn=#abcdex" };
        for (int i = 0; i < invalids.length; i++) {
            testInvalids(invalids[i]);
        }
        System.out.println();
        System.out.println("***************Other special cases****************");
        ...
        name = new LdapName("1.3.6.1.4.1.466.0=#04024869,O=Test,C=GB");
