...
public class KeyManagerTrustManager implements X509KeyManager {
    ...
    public void doit(KeyManagerFactory kmf, TrustManagerFactory tmf, ManagerFactoryParameters mfp) throws Exception {
        kmf.init(mfp);
        tmf.init(mfp);
    }
    ...
    public static void main(String[] args) throws Exception {
        String kmfAlg = null;
        String tmfAlg = null;
        String reservedKMFacAlg = Security.getProperty("ssl.KeyManagerFactory.algorithm");
        String reservedTMFacAlg = Security.getProperty("ssl.TrustManagerFactory.algorithm");
        try {
            ...
            Security.setProperty("ssl.KeyManagerFactory.algorithm", reservedKMFacAlg);
            Security.setProperty("ssl.TrustManagerFactory.algorithm", reservedTMFacAlg);
        }
    }
}
