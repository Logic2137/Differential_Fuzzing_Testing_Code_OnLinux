...
public class TransparencyTest {
    ...
    protected void doTest() throws IOException {
        ...
        BufferedImage tmp = new BufferedImage(w, 2 * h, BufferedImage.TYPE_INT_ARGB);
        ...
        for (int y = 0; y < h; y++) {
            ...
            if (Color.pink.getRGB() != argb) {
                throw new RuntimeException("Bad color at " + x + "," + y + " - " + Integer.toHexString(argb));
            }
        }
    }
    ...
    protected static IndexColorModel createIndexedBitmaskColorModel() {
        ...
        blue[7] = (byte) 0xff;
        int numBits = 3;
        IndexColorModel icm = new IndexColorModel(numBits, paletteSize, red, green, blue, 5);
        return icm;
    }
}
