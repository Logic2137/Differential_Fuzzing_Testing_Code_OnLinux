...
public class MetafactoryArgValidationTest {
    ...
    public static class C implements Runnable {
        ...
        public static MethodHandle invokeVirtualMH() {
            try {
                return lookup.findVirtual(C.class, "im", mt(void.class));
            } catch (ReflectiveOperationException e) {
                throw new RuntimeException(e);
            }
        }
        ...
        public static MethodHandle invokeStaticMH() {
            try {
                return lookup.findStatic(C.class, "sm", mt(void.class));
            } catch (ReflectiveOperationException e) {
                throw new RuntimeException(e);
            }
        }
        ...
        public static MethodHandle invokeSpecialMH() {
            try {
                return lookup.findSpecial(Object.class, "toString", mt(String.class), C.class);
            } catch (ReflectiveOperationException e) {
                throw new RuntimeException(e);
            }
        }
        ...
        public static MethodHandle newInvokeSpecialMH() {
            try {
                return lookup.findConstructor(C.class, mt(void.class));
            } catch (ReflectiveOperationException e) {
                throw new RuntimeException(e);
            }
        }
        ...
        public static MethodHandle invokeInterfaceMH() {
            try {
                return lookup.findVirtual(Runnable.class, "run", mt(void.class));
            } catch (ReflectiveOperationException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    static CallSite mfSucceed(MethodHandles.Lookup lookup, String name, MethodType capType, MethodType desc, MethodHandle impl, MethodType checked) {
        try {
    ...
    static void mfFail(Class<?> exceptionType, MethodHandles.Lookup lookup, String name, MethodType capType, MethodType desc, MethodHandle impl, MethodType checked) {
        try {
    ...
    static CallSite amfSucceed(MethodHandles.Lookup lookup, String name, MethodType capType, Object[] args) {
        try {
    ...
    static void amfFail(Class<?> exceptionType, MethodHandles.Lookup lookup, String name, MethodType capType, Object[] args) {
        try {
