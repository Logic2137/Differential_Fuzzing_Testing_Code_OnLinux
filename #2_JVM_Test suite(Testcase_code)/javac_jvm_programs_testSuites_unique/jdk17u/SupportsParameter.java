...
public class SupportsParameter {
    ...
    private static class MyProvider extends Provider {
        ...
        MyProvider() {
            ...
            put("Signature.DSA SupportedKeyClasses", "java.security.interfaces.DSAPublicKey" + "|java.security.interfaces.DSAPrivateKey");
            put("Signature.DSA2", "foo.DSA2");
            put("Signature.DSA2 SupportedKeyFormats", "X.509|PKCS#8");
            put("Signature.DSA3", "foo.DSA3");
            put("Signature.DSA3 SupportedKeyClasses", "SupportsParameter$MyPrivateKey" + "|SupportsParameter$MyPublicKey" + "|java.security.interfaces.DSAPublicKey");
