...
public class TestSHAClone {
    ...
    private static final String[] ALGOS = { "SHA", "SHA-224", "SHA-256", "SHA-384", "SHA-512" };

    private static byte[] input1 = { (byte) 0x1, (byte) 0x2, (byte) 0x3 };

    private static byte[] input2 = { (byte) 0x4, (byte) 0x5, (byte) 0x6 };
