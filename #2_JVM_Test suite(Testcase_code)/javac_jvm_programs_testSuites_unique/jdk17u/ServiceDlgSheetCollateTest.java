...
public class ServiceDlgSheetCollateTest {
    ...
    public static void main(java.lang.String[] args) throws Exception {
        ...
        try {
            ...
            if (!testPassed && testGeneratedInterrupt) {
                throw new RuntimeException("SheetCollate option is not disabled " + "for flavors that do not support sheetCollate");
            }
        }
    ...
    private static void printTest() {
        ...
        if (defService != null) {
            ...
            System.out.println("is flavor: " + flavor + " supported? " + defService.isDocFlavorSupported(flavor));
            System.out.println("is SheetCollate category supported? " + defService.isAttributeCategorySupported(SheetCollate.class));
            System.out.println("is SheetCollate.COLLATED value supported ? " + defService.isAttributeValueSupported(SheetCollate.COLLATED, flavor, null));
        }
