...
public class X509BadCertificate {
    ...
    static void test(String filename) throws Exception {
        try {
            ...
            throw new Exception("Test failed: " + "expected CertificateParsingException was not thrown");
        } catch (CertificateException e) {
            System.out.println("Test passed: expected exception was thrown: " + e.toString());
        }
    }
}
