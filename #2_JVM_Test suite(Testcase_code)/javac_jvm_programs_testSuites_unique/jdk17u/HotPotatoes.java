...
public class HotPotatoes {
    ...
    private static void testPotato(Class<? extends Collection> implClazz, Class<? extends List> argClazz) throws Throwable {
        try {
            System.out.printf("implClazz=%s, argClazz=%s\n", implClazz.getName(), argClazz.getName());
            final int iterations = 100000;
            final List<Integer> list = (List<Integer>) argClazz.getDeclaredConstructor().newInstance();
