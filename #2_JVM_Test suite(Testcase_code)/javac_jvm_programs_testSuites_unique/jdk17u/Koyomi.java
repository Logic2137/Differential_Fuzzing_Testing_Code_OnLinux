...
public class Koyomi extends GregorianCalendar {
    ...
    static final String[] FIELD_NAMES = { "ERA", "YEAR", "MONTH", "WEEK_OF_YEAR", "WEEK_OF_MONTH", "DAY_OF_MONTH", "DAY_OF_YEAR", "DAY_OF_WEEK", "DAY_OF_WEEK_IN_MONTH", "AM_PM", "HOUR", "HOUR_OF_DAY", "MINUTE", "SECOND", "MILLISECOND", "ZONE_OFFSET", "DST_OFFSET" };
    ...
    boolean checkActualMaximum(int field, int expectedValue) {
        ...
        if ((val = getActualMaximum(field)) != expectedValue) {
            appendMessage("getActualMaximum(" + FIELD_NAMES[field] + "): got " + val + " expected " + expectedValue);
        }
        return getStatus();
    }
    ...
    boolean checkLeastMaximum(int field, int expectedValue) {
        ...
        if ((val = getLeastMaximum(field)) != expectedValue) {
            appendMessage("getLeastMaximum(" + FIELD_NAMES[field] + "): got " + val + " expected " + expectedValue);
        }
        return getStatus();
    }
    ...
    boolean checkActualMinimum(int field, int expectedValue) {
        ...
        if ((val = getActualMinimum(field)) != expectedValue) {
            appendMessage("getActualMinimum(" + FIELD_NAMES[field] + "): got " + val + " expected " + expectedValue);
        }
        return getStatus();
    }
    ...
    boolean checkGreatestMinimum(int field, int expectedValue) {
        ...
        if ((val = getGreatestMinimum(field)) != expectedValue) {
            appendMessage("getGreatestMinimum(" + FIELD_NAMES[field] + "): got " + val + " expected " + expectedValue);
        }
        return getStatus();
    }
    ...
    boolean checkDateTime(int year, int month, int dayOfMonth, int hourOfDay, int minute, int second, int ms) {
        initTest();
        checkFieldValue(YEAR, year);
        checkFieldValue(MONTH, month);
        checkFieldValue(DAY_OF_MONTH, dayOfMonth);
    ...
    boolean checkFieldValue(int field, int expectedValue) {
        ...
        if ((val = get(field)) != expectedValue) {
            appendMessage("get(" + FIELD_NAMES[field] + "): got " + val + ", expected " + expectedValue + "; ");
            return false;
        }
        return true;
    }
    ...
    boolean checkInternalFieldValue(int field, int expectedValue) {
        ...
        if ((val = internalGet(field)) != expectedValue) {
            appendMessage("internalGet(" + FIELD_NAMES[field] + "): got " + val + ", expected " + expectedValue + "; ");
            return false;
        }
        return true;
    }
