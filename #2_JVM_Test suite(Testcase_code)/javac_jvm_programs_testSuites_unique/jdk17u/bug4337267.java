...
public class bug4337267 {
    ...
    String shaped = "000 (E) 111 (A) \u0641\u0642\u0643 \u0662\u0662\u0662 (E) 333";
    ...
    void setShaping(JComponent c) {
        c.putClientProperty(TextAttribute.NUMERIC_SHAPING, NumericShaper.getContextualShaper(NumericShaper.ARABIC));
    }
    ...
    static class TestJPanel extends JPanel {
        ...
        TestBufferedImage createImage(Dimension d) {
            return new TestBufferedImage(d.width, d.height, BufferedImage.TYPE_INT_ARGB);
        }
