...
class TestPrintService implements PrintService {
    ...
    private static final DocFlavor[] supportedDocFlavors = (new DocFlavor[] { javax.print.DocFlavor.INPUT_STREAM.JPEG });

    private static final Class[] serviceAttrCats = (new Class[] { javax.print.attribute.standard.PrinterName.class });

    private static final Class[] otherAttrCats = (new Class[] { javax.print.attribute.standard.Copies.class, javax.print.attribute.standard.OrientationRequested.class, javax.print.attribute.standard.Destination.class });
