...
public class EnableTest {
    ...
    private static void checkThreadContentionMonitoring(boolean expectedValue) throws Exception {
    ...
    private static void testThreadContentionMonitoring() throws Exception {
    ...
    private static void checkThreadCpuTime(boolean expectedValue) throws Exception {
    ...
    private static void testThreadCpuTime() throws Exception {
