...
public class KeyStoreCompatibilityMode {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(KEYSTORE_COMPATIBILITY_MODE_PROP + " = " + System.getProperty(KEYSTORE_COMPATIBILITY_MODE_PROP));
    ...
    private static void testLoadStore(KeyStore keyStore, Object stream, char[] password, boolean doLoad) throws Exception {
