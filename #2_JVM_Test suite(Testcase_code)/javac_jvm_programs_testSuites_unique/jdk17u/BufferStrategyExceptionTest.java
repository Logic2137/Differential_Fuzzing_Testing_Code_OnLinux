...
public class BufferStrategyExceptionTest {
    ...
    private static final BufferedImage bi = new BufferedImage(200, 200, BufferedImage.TYPE_INT_RGB);
    ...
    static class TestFrame extends Frame {
        ...
        public void render() {
            ...
            BufferCapabilities bufCap = new BufferCapabilities(imgFrontBufCap, imgBackBufCap, BufferCapabilities.FlipContents.COPIED);
            try {
