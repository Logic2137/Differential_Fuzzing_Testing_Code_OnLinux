...
public class GetEncoded {
    ...
    public static void main(String[] argv) throws Exception {
        AlgorithmParameters params = AlgorithmParameters.getInstance("EC", new MyProvider());
        EncryptedPrivateKeyInfo epki = new EncryptedPrivateKeyInfo(params, new byte[] { 1, 2, 3, 4 });
        try {
            epki.getEncoded();
        ...
        EncryptedPrivateKeyInfo epki1 = new EncryptedPrivateKeyInfo(ap1, new byte[] { 1, 2, 3, 4 });
        ap1.init(new ECGenParameterSpec("secp256r1"));
        EncryptedPrivateKeyInfo epki2 = new EncryptedPrivateKeyInfo(epki1.getEncoded());
