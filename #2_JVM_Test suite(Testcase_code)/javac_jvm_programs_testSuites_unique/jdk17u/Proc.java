...
public class Proc {
    ...
    public Proc grant(Principal p) {
        grant.append("principal ").append(p.getClass().getName()).append(" \"").append(p.getName()).append("\", ");
        return this;
    }
    ...
    public Proc start() throws IOException {
        ...
        if (cp == null) {
            cmd.add("-cp");
            cmd.add(System.getProperty("test.class.path") + File.pathSeparator + System.getProperty("test.src.path"));
        } else if (!cp.isEmpty()) {
            cmd.add("-cp");
        ...
        if (inheritIO) {
            ...
            pb.redirectError(ProcessBuilder.Redirect.appendTo(new File(getId("stderr"))));
        }
        p = pb.start();
    ...
    public String readLine() throws IOException {
        ...
        if (debug != null) {
            System.out.println("PROC: " + debug + " readline: " + (s == null ? "<EOF>" : s));
        }
        return s;
    }
