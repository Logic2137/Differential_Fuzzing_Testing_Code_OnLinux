...
public class T7086601b {
    ...
    enum TypeKind {
        ...
        boolean isSubtypeof(TypeKind other) {
            return (this == INTEGER && other == NUMBER || this == Z && other == Y || this == other);
        }
    }

    enum MethodCallKind {

        ARITY_ONE("m(a1);", 1), ARITY_TWO("m(a1, a2);", 2), ARITY_THREE("m(a1, a2, a3);", 3);
    ...
    class JavaSource extends SimpleJavaFileObject {
        ...
        public JavaSource() {
            ...
            source = bodyTemplate.replace("#A1", a1.typeStr).replace("#A2", a2.typeStr).replace("#A3", a3.typeStr).replace("#MC", mck.invokeString);
        }
