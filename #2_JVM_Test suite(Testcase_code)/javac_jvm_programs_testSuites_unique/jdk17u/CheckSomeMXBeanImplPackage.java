...
public class CheckSomeMXBeanImplPackage {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (present) {
            Class<? extends PlatformManagedObject> klazz = java.lang.management.GarbageCollectorMXBean.class;
            for (Object obj : ManagementFactory.getPlatformMXBeans(klazz)) {
            ...
            check(klazz.getName(), ManagementFactory.getPlatformMXBean(klazz));
