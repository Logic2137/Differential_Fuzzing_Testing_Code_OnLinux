...
public class bug8132119 {
    ...
    private static final NumericShaper NUMERIC_SHAPER = NumericShaper.getShaper(NumericShaper.ARABIC);
    ...
    private static void testStringClip() {
        ...
        checkClippedString(str, clip, "...");
        clip = BasicGraphicsUtils.getClippedString(comp, fontMetrics, str, width - width / str.length());
    ...
    private static void testDrawString(boolean underlined) {
        ...
        float xx = 0;
        if (underlined) {
            xx = BasicGraphicsUtils.getStringWidth(comp, fontMetrices, "A") + BasicGraphicsUtils.getStringWidth(comp, fontMetrices, "O") / 2 - 5;
        } else {
            xx = BasicGraphicsUtils.getStringWidth(comp, fontMetrices, "A") + BasicGraphicsUtils.getStringWidth(comp, fontMetrices, "O") / 2;
        }
    ...
    private static void checkNullArguments(JComponent comp, Graphics2D g, String text) {
    ...
    private static void checkNullArgumentsDrawString(JComponent comp, Graphics2D g, String text) {
        float x = 50;
        float y = 50;
    ...
    private static void checkNullArgumentsDrawStringUnderlineCharAt(JComponent comp, Graphics2D g, String text) {
        int x = 50;
        int y = 50;
    ...
    private static void checkNullArgumentsGetClippedString(JComponent comp, String text) {
        FontMetrics fontMetrics = comp.getFontMetrics(comp.getFont());
    ...
    private static void checkNullArgumentsGetStringWidth(JComponent comp, String text) {
        FontMetrics fontMetrics = comp.getFontMetrics(comp.getFont());
    ...
    private static void checkImageContainsSymbol(BufferedImage buffImage, int x, int intersections) {
        int background = BACKGROUND_COLOR.getRGB();
    ...
    private static BufferedImage createBufferedImage(int width, int height) {
        BufferedImage bufffImage = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
