    ...
    public static void main(String[] args) throws Exception {
        SwingUtilities.invokeAndWait(new Runnable() {
            ...
            public void run() {
                ...
                jTextPane.setText("<html><body><b id='test'>Test</b></body></html>");
                SimpleAttributeSet right = new SimpleAttributeSet();
                StyleConstants.setAlignment(right, StyleConstants.ALIGN_RIGHT);
                jTextPane.getStyledDocument().setParagraphAttributes(0, 10, right, true);
        ...
        SwingUtilities.invokeAndWait(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    jTextPane.getStyledDocument().setParagraphAttributes(0, 10, center, true);
