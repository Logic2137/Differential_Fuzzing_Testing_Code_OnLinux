    ...
    private void run() {
        try {
            ...
            if (selectedIndex == theChoice.getSelectedIndex())
                throw new RuntimeException("Test case failed - expected to select" + " a different item than " + selectedIndex);
            ...
            robot.waitForIdle();
            if (selectedIndex != theChoice.getSelectedIndex())
                throw new RuntimeException("Test failed. Expected to select the same item " + "located at: " + selectedIndex + " but got an item selected at: " + theChoice.getSelectedIndex());
        } catch (InterruptedException e) {
