...
public class DigestCloneabilityTest {
    ...
    public static class SampleProvider extends Provider {
        ...
        public SampleProvider() {
            ...
            putService(new Provider.Service(this, "MessageDigest", "SHA-512", "DigestCloneabilityTest$SampleProvider$CloneableDigest", null, null));
        }

        public static class CloneableDigest extends MessageDigestSpi implements Cloneable {
