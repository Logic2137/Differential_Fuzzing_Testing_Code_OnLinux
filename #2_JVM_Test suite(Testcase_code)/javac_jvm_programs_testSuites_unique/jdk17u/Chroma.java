...
public class Chroma {
    ...
    public static void main(String[] args) {
        StreamPrintServiceFactory[] fact = StreamPrintServiceFactory.lookupStreamPrintServiceFactories(DocFlavor.SERVICE_FORMATTED.PRINTABLE, DocFlavor.BYTE_ARRAY.POSTSCRIPT.getMimeType());
        if (fact.length != 0) {
