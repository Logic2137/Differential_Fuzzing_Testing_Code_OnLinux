...
public class bug6236162 {
    ...
    private static void test() throws AWTException {
        ...
        if (list.getSelectedIndex() != 1) {
            throw new RuntimeException("There is an inconsistence in combo box " + "behavior when user points an item in combo popup " + "by mouse and then uses UP/DOWN keys.");
        }
    }
