...
public class SocketPermissionCollection {
    ...
    public static void main(String[] args) throws Exception {
        int testFail = 0;
        SocketPermission perm = new SocketPermission("www.example.com", "connect");
        ...
        if (!perms.implies(new SocketPermission("www.example.us", "connect,accept"))) {
            System.err.println("Expected true, returned false");
            testFail++;
        }
        ...
        System.out.println("test 9: implies returns true for matching " + "port range and action");
