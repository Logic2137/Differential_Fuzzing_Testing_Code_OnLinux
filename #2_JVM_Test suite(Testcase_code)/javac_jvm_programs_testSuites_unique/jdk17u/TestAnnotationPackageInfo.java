...
public class TestAnnotationPackageInfo {
    ...
    public void run() throws Exception {
        ...
        assert tool != null;
        JavaFileObject test_java = new MyFileObject("test/Test.java", "package test; public @interface Test {\n" + "    public int mandatory();\n" + "}\n");
        JavaFileObject package_info_java = new MyFileObject("test/package-info.java", "@Test package test;");
