...
class AliasingTest implements Runnable {
    ...
    private static String getHtml() {
        return "<html><body>" + "<ul>" + "<li>Text</li>" + "<li>Document</li>" + "</ul>" + "</body></html>";
    }

    private static Component createSplitPane() {
        JSplitPane splitPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT, createHtmlViewer(false), createHtmlViewer(true));
