...
public class UnicodeSpec {
    ...
    public static String parseNumericValue(String s) throws Exception {
        if (s == null)
            throw new Exception("Cannot parse numeric value.");
        return s;
    }
    ...
    static final byte FIELD_VALUE = 0, FIELD_NAME = 1, FIELD_CATEGORY = 2, FIELD_CLASS = 3, FIELD_BIDI = 4, FIELD_DECOMPOSITION = 5, FIELD_DECIMAL = 6, FIELD_DIGIT = 7, FIELD_NUMERIC = 8, FIELD_MIRRORED = 9, FIELD_OLDNAME = 10, FIELD_COMMENT = 11, FIELD_UPPERCASE = 12, FIELD_LOWERCASE = 13, FIELD_TITLECASE = 14;
