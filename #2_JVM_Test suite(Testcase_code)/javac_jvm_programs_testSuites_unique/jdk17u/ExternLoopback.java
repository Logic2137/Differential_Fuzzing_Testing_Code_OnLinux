...
class LoopbackOutputStream extends ObjectOutputStream {
    ...
    LoopbackOutputStream(OutputStream out, LinkedList<ObjectStreamClass> descs) throws IOException {
        super(out);
        this.descs = descs;
    }
...
public class ExternLoopback implements Externalizable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        lout.writeObject(lb);
        lout.close();
        LoopbackInputStream lin = new LoopbackInputStream(new ByteArrayInputStream(bout.toByteArray()), descs);
