...
public class Restart {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AsynchronousChannelGroup group = AsynchronousChannelGroup.withFixedThreadPool(nThreads, factory);
        try {
        ...
        group = AsynchronousChannelGroup.withThreadPool(Executors.newFixedThreadPool(1 + rand.nextInt(5), factory));
        try {
            testRestart(group, 100);
        } finally {
            group.shutdown();
    ...
    static void testRestart(AsynchronousChannelGroup group, int count) throws Exception {
