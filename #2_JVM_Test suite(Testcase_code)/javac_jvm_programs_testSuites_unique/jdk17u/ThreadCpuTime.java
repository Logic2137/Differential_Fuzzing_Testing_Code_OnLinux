...
public class ThreadCpuTime {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        if (t != -1) {
            throw new RuntimeException("Invalid CurrenThreadCpuTime returned = " + t + " expected = -1");
        }
        ...
        if (time1 < time) {
            throw new RuntimeException("CPU time " + time1 + " expected >= " + time);
        }
        System.out.println(curThread.getName() + " Current Thread Cpu Time = " + time + " CPU time = " + time1);
    ...
    static class MyThread extends Thread {
        ...
        public void run() {
            ...
            System.out.println(getName() + ": " + "CurrentThreadUserTime = " + utime1 + " ThreadUserTime = " + utime2);
            System.out.println(getName() + ": " + "CurrentThreadCpuTime  = " + time1 + " ThreadCpuTime  = " + time2);
            if (time1 > time2) {
