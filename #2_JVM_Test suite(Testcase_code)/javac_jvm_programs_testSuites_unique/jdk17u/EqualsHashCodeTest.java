...
public class EqualsHashCodeTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Descriptor sq1 = new ImmutableDescriptor(new String[] { "name", "rank", "squares", "null", "numbers" }, new Object[] { "Foo McBar", "lowly", squares.clone(), null, numbers });
        Descriptor sq2 = new DescriptorSupport(new String[] { "Name", "Rank", "SquareS", "NULL", "NuMbErS" }, new Object[] { "Foo McBar", "lowly", squares.clone(), null, numbers });
        ...
        if (!Arrays.deepEquals(values, values2)) {
            throw new Exception("Arrays not equal: " + Arrays.deepToString(values) + Arrays.deepToString(values2));
        }
        ...
        for (Descriptor d : new Descriptor[] { sq1, sq2, sq3, sq4 }) {
            System.out.println("Testing hashCode for " + d.getClass().getName() + ": " + d);
            if (d.hashCode() != expectedHashCode) {
                throw new Exception("Bad hashCode: expected " + expectedHashCode + ", got " + d.hashCode() + ", for " + d);
            }
        }
        int i;
        ...
        Object[][] equivalenceClasses = { { sq1, sq2, sq3, sq4 }, { qs1, qs2 } };
        for (Object[] equivClass : equivalenceClasses) {
            for (Object a : equivClass) {
                for (Object b : equivClass) {
                    if (!a.equals(b)) {
                        throw new Exception("Should be equal but not: " + a + " :: " + b);
                    }
                }
                for (Object[] equivClass2 : equivalenceClasses) {
                    ...
                    for (Object b : equivClass2) {
                        if (a.equals(b)) {
                            throw new Exception("Should not be equal: " + a + " :: " + b);
                        }
                    }
                }
            }
