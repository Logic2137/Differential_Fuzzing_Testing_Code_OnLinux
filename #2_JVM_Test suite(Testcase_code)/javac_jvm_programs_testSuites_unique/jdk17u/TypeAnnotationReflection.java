...
public class TypeAnnotationReflection {
    ...
    private static void testWildcardType() throws Exception {
        ...
        AnnotatedWildcardType w = (AnnotatedWildcardType) ((AnnotatedParameterizedType) f.getAnnotatedType()).getAnnotatedActualTypeArguments()[0];
...
abstract class TestParameterizedType implements @TypeAnno("M") Map<@TypeAnno("S") String, @TypeAnno("I") @TypeAnno2("I2") Integer> {
    ...
    @TypeAnno("O")
    public ParameterizedOuter<@TypeAnno("S1") @TypeAnno2("S2") String>.@TypeAnno("I") ParameterizedInner<@TypeAnno("I1") @TypeAnno2("I2") Integer> foo2() {
        return null;
    }

    @TypeAnno("FieldOuter")
    public ParameterizedOuter<@TypeAnno2("String Arg") String>.@TypeAnno("FieldInner") ParameterizedInner<@TypeAnno2("Map Arg") Map> theField;
}
...
abstract class TestClassArray extends @TypeAnno("extends") @TypeAnno2("extends2") Object implements @TypeAnno("implements serializable") @TypeAnno2("implements2 serializable") Serializable, Readable, @TypeAnno("implements cloneable") @TypeAnno2("implements2 cloneable") Cloneable {

    @TypeAnno("return4")
    public Object @TypeAnno("return1") [][] @TypeAnno("return3") [] foo() {
        return null;
    }
}
...
abstract class TestClassNested {
    ...
    @TypeAnno("Outer")
    public Outer.@TypeAnno("Inner") Inner @TypeAnno("array") [] foo() {
        return null;
    }
}
...
abstract class TestClassException {
    ...
    public Object foo() throws @TypeAnno("RE") @TypeAnno2("RE2") RuntimeException, NullPointerException, @TypeAnno("AIOOBE") ArrayIndexOutOfBoundsException {
        return null;
    }
}

abstract class TestClassTypeVarAndField<T extends @TypeAnno("Object1") Object & @TypeAnno("Runnable1") @TypeAnno2("Runnable2") Runnable, @TypeAnno("EE") EE extends @TypeAnno2("EEBound") Runnable, V> {
    ...
    public <M extends @TypeAnno("M Runnable") Runnable> M foo2() {
        return null;
    }

    public <@TypeAnno("K") K extends Cloneable, L> K foo3() {
        return null;
    }
