...
public class TargetMBeanTest {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("Test that target MBean class loader is used " + "before JMX Remote API class loader");
        ClassLoader jmxRemoteClassLoader = JMXServiceURL.class.getClassLoader();
        if (jmxRemoteClassLoader == null) {
            System.out.println("JMX Remote API loaded by bootstrap " + "class loader, this test is irrelevant");
            return;
        }
    ...
    private static boolean test(String proto, MBeanServer mbs) throws Exception {
        ...
        mbsc.createMBean(RMIConnectorServer.class.getName(), on, mletName, new Object[] { rmiurl, null }, new String[] { JMXServiceURL.class.getName(), Map.class.getName() });
