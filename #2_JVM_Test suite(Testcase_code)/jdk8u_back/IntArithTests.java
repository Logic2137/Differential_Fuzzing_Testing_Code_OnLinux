public class IntArithTests {
    ...
    private static final int IIMM12_0 = 0x1;

    private static final int IIMM12_1 = 0xfff;

    private static final int IIMM12_2 = 0x1001;

    private static final int IIMM24_3 = 0x1000;

    private static final int IIMM24_4 = 0xfff000;

    private static final int IIMM24_5 = 0x1001000;
