class Case {
    ...
    public Case(String caseName, String file, boolean testable, String location, String description, String message) {
        ...
        for (Case c : VerifyErrorCases.cases) {
            ...
            if (c.isTestable()) {
                try {
                    ...
                    throw new RuntimeException("++ FAIL: No verify error encountered");
                } catch (VerifyError ve) {
                    String message = c.getMessage();
                    String veMessage = ve.getMessage();
                    System.out.print(veMessage);
                    if (!veMessage.startsWith(message)) {
                        System.out.println("++ FAIL? " + "Message does not match what was expected: " + message);
                        continue;
                    }
                    if (!veMessage.contains("Exception Details:") && !veMessage.contains("Reason:")) {
